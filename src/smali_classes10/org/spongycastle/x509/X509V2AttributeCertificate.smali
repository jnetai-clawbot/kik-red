...
.method public constructor <init>([B)V
    ...
    instance-of v0, p1, Lorg/spongycastle/asn1/x509/AttributeCertificate;

    if-eqz v0, :cond_0

    check-cast p1, Lorg/spongycastle/asn1/x509/AttributeCertificate;
    ...
    invoke-direct {v0, p1}, Lorg/spongycastle/asn1/x509/AttributeCertificate;-><init>(Lorg/spongycastle/asn1/ASN1Sequence;)V
    :try_end_0
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/AttributeCertificateInfo;->c()Lorg/spongycastle/asn1/x509/AttCertValidityPeriod;

    move-result-object v0

    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/AttCertValidityPeriod;->e()Lorg/spongycastle/asn1/DERGeneralizedTime;
    ...
    invoke-virtual {p1}, Lorg/spongycastle/asn1/x509/AttributeCertificateInfo;->c()Lorg/spongycastle/asn1/x509/AttCertValidityPeriod;

    move-result-object p1

    invoke-virtual {p1}, Lorg/spongycastle/asn1/x509/AttCertValidityPeriod;->h()Lorg/spongycastle/asn1/DERGeneralizedTime;

    move-result-object p1

    invoke-virtual {p1}, Lorg/spongycastle/asn1/DERGeneralizedTime;->n()Ljava/util/Date;
...
# virtual methods
.method public final a()Lorg/spongycastle/x509/AttributeCertificateHolder;
    .locals 2
    ...
    invoke-virtual {v1}, Lorg/spongycastle/asn1/x509/AttributeCertificateInfo;->i()Lorg/spongycastle/asn1/x509/Holder;
...
.method public final b(Ljava/lang/String;)[Lorg/spongycastle/x509/X509Attribute;
    .locals 5
...
.method public final d()Lorg/spongycastle/x509/AttributeCertificateIssuer;
    ...
    invoke-virtual {v1}, Lorg/spongycastle/asn1/x509/AttributeCertificateInfo;->k()Lorg/spongycastle/asn1/x509/AttCertIssuer;
...
.method public final getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    invoke-direct {p0, v0}, Lorg/spongycastle/x509/X509V2AttributeCertificate;->c(Z)Ljava/util/Set;
...
.method public final getSerialNumber()Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/AttributeCertificateInfo;->l()Lorg/spongycastle/asn1/ASN1Integer;
