...
.method public final E()Lorg/bouncycastle/math/ec/ECPoint;
    ...
    :cond_0
    invoke-virtual {p0}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Point;->G()Lorg/bouncycastle/math/ec/ECPoint;
...
.method public final G()Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-static {v8, v9}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->i([I[I)V

    invoke-virtual {v3}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->h()Z

    move-result v10

    iget-object v11, v3, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->g:[I

    if-nez v10, :cond_2

    invoke-static {v11, v7}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->i([I[I)V

    move-object v11, v7

    :cond_2
    iget-object v12, v2, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->g:[I

    invoke-static {v12, v11, v6}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->k([I[I[I)V

    iget-object v12, v2, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->g:[I

    invoke-static {v12, v11, v7}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->a([I[I[I)V

    invoke-static {v7, v6, v7}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->c([I[I[I)V

    invoke-static {v7, v7, v7}, Lorg/bouncycastle/math/raw/Nat160;->b([I[I[I)I

    move-result v11

    invoke-static {v11, v7}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->h(I[I)V

    iget-object v2, v2, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->g:[I

    invoke-static {v8, v2, v8}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->c([I[I[I)V

    invoke-static {v5, v8}, Lorg/bouncycastle/math/raw/Nat;->w(I[I)I

    move-result v2

    invoke-static {v2, v8}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->h(I[I)V
    ...
    invoke-static {v7, v5}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->i([I[I)V

    iget-object v5, v2, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->g:[I

    invoke-static {v5, v8, v5}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->k([I[I[I)V
    ...
    iget-object v11, v5, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->g:[I

    invoke-static {v8, v9, v11}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->k([I[I[I)V

    iget-object v8, v5, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->g:[I

    invoke-static {v8, v7, v8}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->c([I[I[I)V

    iget-object v8, v5, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->g:[I

    invoke-static {v8, v6, v8}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->k([I[I[I)V

    new-instance v6, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;

    invoke-direct {v6, v7}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;-><init>([I)V

    iget-object v1, v1, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->g:[I

    iget-object v7, v6, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->g:[I

    invoke-static {v1, v7}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Field;->l([I[I)V

    if-nez v10, :cond_3

    iget-object v1, v6, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2FieldElement;->g:[I
    ...
    invoke-direct {v1, v0, v2, v5, v3}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Point;-><init>(Lorg/bouncycastle/math/ec/ECCurve;Lorg/bouncycastle/math/ec/ECFieldElement;Lorg/bouncycastle/math/ec/ECFieldElement;[Lorg/bouncycastle/math/ec/ECFieldElement;)V
...
.method public final H(Lorg/bouncycastle/math/ec/ECPoint;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Point;->E()Lorg/bouncycastle/math/ec/ECPoint;
...
.method public final a(Lorg/bouncycastle/math/ec/ECPoint;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-virtual/range {p0 .. p0}, Lorg/bouncycastle/math/ec/custom/sec/SecP160R2Point;->G()Lorg/bouncycastle/math/ec/ECPoint;
