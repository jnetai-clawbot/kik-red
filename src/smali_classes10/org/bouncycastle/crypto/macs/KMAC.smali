...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/crypto/macs/KMAC;->g:[B
...
.method public constructor <init>(I[B)V
    ...
    invoke-static {v1}, Lorg/bouncycastle/util/Strings;->d(Ljava/lang/String;)[B

    move-result-object v1

    invoke-direct {v0, p1, v1, p2}, Lorg/bouncycastle/crypto/digests/CSHAKEDigest;-><init>(I[B[B)V

    iput-object v0, p0, Lorg/bouncycastle/crypto/macs/KMAC;->a:Lorg/bouncycastle/crypto/digests/CSHAKEDigest;

    iput p1, p0, Lorg/bouncycastle/crypto/macs/KMAC;->b:I

    mul-int/lit8 p1, p1, 0x2

    div-int/lit8 p1, p1, 0x8

    iput p1, p0, Lorg/bouncycastle/crypto/macs/KMAC;->c:I
...
.method private bytePad([BI)V
    ...
    :goto_0
    sget-object p2, Lorg/bouncycastle/crypto/macs/KMAC;->g:[B
...
.method private static encode([B)[B
    ...
    invoke-static {v0, p0}, Lorg/bouncycastle/util/Arrays;->h([B[B)[B
...
.method public doFinal([BI)I
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/macs/KMAC;->f:Z

    if-eqz v0, :cond_1

    iget-boolean v0, p0, Lorg/bouncycastle/crypto/macs/KMAC;->e:Z
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/macs/KMAC;->a:Lorg/bouncycastle/crypto/digests/CSHAKEDigest;
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lorg/bouncycastle/crypto/macs/KMAC;->a:Lorg/bouncycastle/crypto/digests/CSHAKEDigest;
...
.method public doOutput([BII)I
    ...
    iput-boolean v3, p0, Lorg/bouncycastle/crypto/macs/KMAC;->f:Z
...
.method public getDigestSize()I
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/macs/KMAC;->c:I
...
.method public init(Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/macs/KMAC;->d:[B

    const/4 p1, 0x1

    iput-boolean p1, p0, Lorg/bouncycastle/crypto/macs/KMAC;->e:Z
...
.method public reset()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/macs/KMAC;->d:[B

    if-eqz v0, :cond_1

    iget v1, p0, Lorg/bouncycastle/crypto/macs/KMAC;->b:I
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/crypto/macs/KMAC;->f:Z
