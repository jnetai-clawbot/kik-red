.class public final Lio/wondrous/sns/levels/progress/streamer/LevelStreamerProgressSource;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/wondrous/sns/levels/progress/streamer/LevelStreamerProgressSource$WhenMappings;
    }
.end annotation
...
.method public constructor <init>(Lio/wondrous/sns/data/LevelRepository;)V
    ...
    iput-object p1, p0, Lio/wondrous/sns/levels/progress/streamer/LevelStreamerProgressSource;->a:Lio/wondrous/sns/data/LevelRepository;

    return-void
.end method

.method public static c(Lio/wondrous/sns/levels/progress/streamer/LevelStreamerProgressSource;Ljava/lang/String;Lio/wondrous/sns/data/realtime/RealtimeMessage;)Lio/reactivex/y;
    .locals 1
    ...
    sget-object v0, Lio/wondrous/sns/levels/progress/streamer/LevelStreamerProgressSource$WhenMappings;->a:[I
    ...
    invoke-direct {p0, p1}, Lio/wondrous/sns/levels/progress/streamer/LevelStreamerProgressSource;->d(Ljava/lang/String;)Lio/reactivex/t;
...
.method private final d(Ljava/lang/String;)Lio/reactivex/t;
    ...
    iget-object v0, p0, Lio/wondrous/sns/levels/progress/streamer/LevelStreamerProgressSource;->a:Lio/wondrous/sns/data/LevelRepository;

    invoke-interface {v0, p1}, Lio/wondrous/sns/data/LevelRepository;->getUserLevel(Ljava/lang/String;)Lio/reactivex/t;

    move-result-object p1

    sget-object v0, Lio/wondrous/sns/levels/progress/streamer/f;->a:Lio/wondrous/sns/levels/progress/streamer/f;

    invoke-virtual {p1, v0}, Lio/reactivex/t;->filter(Lio/reactivex/functions/q;)Lio/reactivex/t;

    move-result-object p1

    sget-object v0, Lio/wondrous/sns/levels/progress/streamer/d;->a:Lio/wondrous/sns/levels/progress/streamer/d;
...
.method public final a(Ljava/lang/String;)Lio/reactivex/t;
    ...
    iget-object v1, p0, Lio/wondrous/sns/levels/progress/streamer/LevelStreamerProgressSource;->a:Lio/wondrous/sns/data/LevelRepository;
    ...
    sget-object v0, Lio/wondrous/sns/levels/progress/streamer/e;->a:Lio/wondrous/sns/levels/progress/streamer/e;
...
.method public final b()Lio/reactivex/t;
    ...
    sget-object v1, Lio/wondrous/sns/levels/progress/streamer/c;->a:Lio/wondrous/sns/levels/progress/streamer/c;
