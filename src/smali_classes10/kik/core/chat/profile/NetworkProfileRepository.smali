...
.method public constructor <init>(Lkik/core/xiphias/m;)V
    ...
    iput-object v0, p0, Lkik/core/chat/profile/NetworkProfileRepository;->a:Lwq/b;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lkik/core/chat/profile/NetworkProfileRepository;->b:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lkik/core/chat/profile/NetworkProfileRepository;->c:Ljava/util/ArrayList;
...
.method public static a(Lkik/core/chat/profile/NetworkProfileRepository;Lgc/a$r;)V
    .locals 7
    ...
    iget-object v6, p0, Lkik/core/chat/profile/NetworkProfileRepository;->b:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v6, p0, Lkik/core/chat/profile/NetworkProfileRepository;->a:Lwq/b;
    ...
    :cond_2
    :goto_2
    invoke-virtual {p1}, Lgc/a$r;->z()I

    move-result v1

    if-lez v1, :cond_4

    invoke-virtual {p1}, Lgc/a$r;->A()Ljava/util/List;
    ...
    :cond_3
    invoke-direct {p0, v2}, Lkik/core/chat/profile/NetworkProfileRepository;->c(Ljava/util/List;)V

    invoke-virtual {v0, v2}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    :cond_4
    invoke-virtual {p1}, Lgc/a$r;->B()I

    move-result v1

    if-lez v1, :cond_6

    invoke-virtual {p1}, Lgc/a$r;->C()Ljava/util/List;
    ...
    :try_start_2
    iget-object v1, p0, Lkik/core/chat/profile/NetworkProfileRepository;->c:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lkik/core/chat/profile/NetworkProfileRepository;->b:Ljava/util/HashMap;
    ...
    invoke-direct {p0}, Lkik/core/chat/profile/NetworkProfileRepository;->f()V
...
.method public static synthetic b(Lkik/core/chat/profile/NetworkProfileRepository;Ljava/util/List;Ljava/lang/Throwable;)V
    .locals 2
    ...
    :cond_0
    invoke-direct {p0, p1}, Lkik/core/chat/profile/NetworkProfileRepository;->c(Ljava/util/List;)V
    ...
    :try_start_0
    iget-object v0, p0, Lkik/core/chat/profile/NetworkProfileRepository;->c:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lkik/core/chat/profile/NetworkProfileRepository;->b:Ljava/util/HashMap;
...
.method private c(Ljava/util/List;)V
    ...
    invoke-direct {v3, v1}, Lkik/core/chat/profile/NetworkProfileRepository$ProfileRequestFailedException;-><init>(Ldc/a;)V
    ...
    :cond_0
    iget-object v2, p0, Lkik/core/chat/profile/NetworkProfileRepository;->a:Lwq/b;
...
.method private f()V
    ...
    iget-object v0, p0, Lkik/core/chat/profile/NetworkProfileRepository;->f:Lkik/core/xiphias/m;

    invoke-interface {v1}, Ljava/util/List;->size()I

    move-result v2

    new-array v2, v2, [Ldc/a;
    ...
    invoke-virtual {v0, v2}, Lkik/core/xiphias/t;->F([Ldc/a;)Lrx/s;
    ...
    invoke-direct {v2, p0, v4}, Lcom/google/firebase/inappmessaging/internal/g;-><init>(Ljava/lang/Object;I)V

    new-instance v4, Lcom/applovin/exoplayer2/a/p0;

    invoke-direct {v4, p0, v1, v3}, Lcom/applovin/exoplayer2/a/p0;-><init>(Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-virtual {v0, v2, v4}, Lrx/s;->n(Lnq/b;Lnq/b;)Lrx/z;
...
.method public final A()Lrx/o;
    ...
    iget-object v0, p0, Lkik/core/chat/profile/NetworkProfileRepository;->a:Lwq/b;
...
.method public final B(Ljava/util/List;)V
    ...
    invoke-direct {p0, v1}, Lkik/core/chat/profile/NetworkProfileRepository;->d(Ldc/a;)V
...
.method public final get(Ljava/lang/Object;)Lrx/s;
    ...
    invoke-direct {p0, p1}, Lkik/core/chat/profile/NetworkProfileRepository;->d(Ldc/a;)V
