...
.method static constructor <clinit>()V
    ...
    invoke-static/range {v9 .. v14}, Lkotlin/collections/CollectionsKt;->R(Ljava/lang/Iterable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lkotlin/jvm/functions/Function1;I)Ljava/lang/String;
    ...
    invoke-static {v1, v9}, Lkotlin/jvm/internal/g;->q(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    sput-object v0, Lgo/f;->d:Ljava/util/List;
...
.method public constructor <init>(Lfo/a$d;[Ljava/lang/String;)V
    .locals 3
    ...
    iput-object p2, p0, Lgo/f;->a:[Ljava/lang/String;

    invoke-virtual {p1}, Lfo/a$d;->s()Ljava/util/List;
    ...
    :goto_0
    iput-object p2, p0, Lgo/f;->b:Ljava/util/Set;

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    invoke-virtual {p1}, Lfo/a$d;->v()Ljava/util/List;
    ...
    check-cast v0, Lfo/a$d$c;

    invoke-virtual {v0}, Lfo/a$d$c;->D()I
    ...
    iput-object p2, p0, Lgo/f;->c:Ljava/util/ArrayList;
...
.method public final a(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lgo/f;->getString(I)Ljava/lang/String;
...
.method public final b(I)Z
    ...
    iget-object v0, p0, Lgo/f;->b:Ljava/util/Set;
...
.method public final getString(I)Ljava/lang/String;
    ...
    iget-object v0, p0, Lgo/f;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lfo/a$d$c;->M()Z
    ...
    invoke-virtual {v0}, Lfo/a$d$c;->G()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {v0}, Lfo/a$d$c;->K()Z

    move-result v1

    if-eqz v1, :cond_2

    sget-object v1, Lgo/f;->d:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lfo/a$d$c;->C()I
    ...
    :cond_2
    iget-object v1, p0, Lgo/f;->a:[Ljava/lang/String;

    aget-object p1, v1, p1

    :goto_1
    invoke-virtual {v0}, Lfo/a$d$c;->H()I
    ...
    invoke-virtual {v0}, Lfo/a$d$c;->I()Ljava/util/List;
    ...
    :cond_3
    invoke-virtual {v0}, Lfo/a$d$c;->E()I
    ...
    invoke-virtual {v0}, Lfo/a$d$c;->F()Ljava/util/List;
    ...
    invoke-static {p1, v3, v1}, Lkotlin/text/StringsKt;->R(Ljava/lang/String;CC)Ljava/lang/String;

    move-result-object p1

    :cond_4
    invoke-virtual {v0}, Lfo/a$d$c;->B()Lfo/a$d$c$c;
