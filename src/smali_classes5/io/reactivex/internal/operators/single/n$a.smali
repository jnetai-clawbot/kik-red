...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/reactivex/internal/operators/single/n$a$a;
    }
.end annotation
...
# direct methods
.method constructor <init>(Lio/reactivex/e0;Lio/reactivex/functions/o;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/single/n$a;->a:Lio/reactivex/e0;

    iput-object p2, p0, Lio/reactivex/internal/operators/single/n$a;->b:Lio/reactivex/functions/o;
...
.method public final onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/single/n$a;->a:Lio/reactivex/e0;
...
.method public final onSubscribe(Lio/reactivex/disposables/c;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/single/n$a;->a:Lio/reactivex/e0;
...
.method public final onSuccess(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/single/n$a;->b:Lio/reactivex/functions/o;
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/single/n$a;->isDisposed()Z

    move-result v0

    if-nez v0, :cond_0

    new-instance v0, Lio/reactivex/internal/operators/single/n$a$a;

    iget-object v1, p0, Lio/reactivex/internal/operators/single/n$a;->a:Lio/reactivex/e0;

    invoke-direct {v0, p0, v1}, Lio/reactivex/internal/operators/single/n$a$a;-><init>(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/e0;)V
