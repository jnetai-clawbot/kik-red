.class public Lio/wondrous/sns/economy/GuestGiftMenuDialogFragment;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lio/wondrous/sns/economy/GuestGiftMenuDialogFragment;
...
.method public static M4(ZLio/wondrous/sns/broadcast/BroadcastMode;)Lio/wondrous/sns/economy/GuestGiftMenuDialogFragment;
    .locals 2
    .param p1    # Lio/wondrous/sns/broadcast/BroadcastMode;
    ...
    new-instance v0, Lio/wondrous/sns/economy/GuestGiftMenuDialogFragment;

    invoke-direct {v0}, Lio/wondrous/sns/economy/GuestGiftMenuDialogFragment;-><init>()V

    const/4 v1, 0x0

    invoke-static {v1, p0, v1, v1}, Lio/wondrous/sns/economy/AbsGiftMenuDialogFragment;->J4(ZZZZ)Landroid/os/Bundle;
    ...
    sget-object p1, Lio/wondrous/sns/economy/RechargeMenuSource;->GUEST_GIFTING:Lio/wondrous/sns/economy/RechargeMenuSource;

    goto :goto_0

    :cond_0
    instance-of v1, p1, Lio/wondrous/sns/broadcast/BroadcastMode$MultiGuest;

    if-eqz v1, :cond_1

    sget-object p1, Lio/wondrous/sns/economy/RechargeMenuSource;->MULTI_GUEST_GIFTING:Lio/wondrous/sns/economy/RechargeMenuSource;
    ...
    :cond_2
    instance-of v1, p1, Lio/wondrous/sns/broadcast/BroadcastMode$NextDate;

    if-eqz v1, :cond_3

    sget-object p1, Lio/wondrous/sns/economy/RechargeMenuSource;->NEXT_DATE_GUEST_GIFTING:Lio/wondrous/sns/economy/RechargeMenuSource;

    goto :goto_0

    :cond_3
    instance-of p1, p1, Lio/wondrous/sns/broadcast/BroadcastMode$NextGuest;

    if-eqz p1, :cond_4

    sget-object p1, Lio/wondrous/sns/economy/RechargeMenuSource;->NEXT_GUEST_GUEST_GIFTING:Lio/wondrous/sns/economy/RechargeMenuSource;
...
.method protected final n4()Ljava/lang/Class;
    ...
    const-class v0, Lio/wondrous/sns/economy/GuestVideoGiftsMenuViewModel;
