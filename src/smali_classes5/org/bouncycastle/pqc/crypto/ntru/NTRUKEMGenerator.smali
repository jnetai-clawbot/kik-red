...
.method public constructor <init>(Ljava/security/SecureRandom;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/pqc/crypto/ntru/NTRUKEMGenerator;->a:Ljava/security/SecureRandom;
...
.method public final generateEncapsulated(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)Lorg/bouncycastle/crypto/SecretWithEncapsulation;
    ...
    new-instance v1, Lorg/bouncycastle/pqc/crypto/ntru/b;

    invoke-direct {v1, v0}, Lorg/bouncycastle/pqc/crypto/ntru/b;-><init>(Lorg/bouncycastle/pqc/math/ntru/parameters/NTRUParameterSet;)V
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/pqc/math/ntru/parameters/NTRUParameterSet;->p()I

    move-result v5

    new-array v5, v5, [B

    iget-object v6, p0, Lorg/bouncycastle/pqc/crypto/ntru/NTRUKEMGenerator;->a:Ljava/security/SecureRandom;

    invoke-virtual {v6, v5}, Ljava/security/SecureRandom;->nextBytes([B)V

    invoke-virtual {v1, v5}, Lorg/bouncycastle/pqc/crypto/ntru/b;->e([B)Lorg/bouncycastle/pqc/crypto/ntru/e;

    move-result-object v1

    invoke-virtual {v1}, Lorg/bouncycastle/pqc/crypto/ntru/e;->d()Lorg/bouncycastle/pqc/math/ntru/Polynomial;

    move-result-object v5

    invoke-virtual {v1}, Lorg/bouncycastle/pqc/crypto/ntru/e;->c()Lorg/bouncycastle/pqc/math/ntru/Polynomial;
    ...
    invoke-virtual {v5, v6}, Lorg/bouncycastle/pqc/math/ntru/Polynomial;->m(I)[B
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/pqc/math/ntru/parameters/NTRUParameterSet;->j()I

    move-result v6

    sub-int v6, v3, v6

    invoke-virtual {v1, v6}, Lorg/bouncycastle/pqc/math/ntru/Polynomial;->m(I)[B
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/pqc/math/ntru/Polynomial;->r()V

    iget-object p1, p1, Lorg/bouncycastle/pqc/crypto/ntru/NTRUPublicKeyParameters;->c:[B

    invoke-virtual {v2, v5, v1, p1}, Lorg/bouncycastle/pqc/crypto/ntru/a;->b(Lorg/bouncycastle/pqc/math/ntru/Polynomial;Lorg/bouncycastle/pqc/math/ntru/Polynomial;[B)[B
    ...
    invoke-static {v3, v8, v0}, Lorg/bouncycastle/util/Arrays;->r([BII)[B

    move-result-object v0

    invoke-static {v3}, Lorg/bouncycastle/util/Arrays;->a([B)V
