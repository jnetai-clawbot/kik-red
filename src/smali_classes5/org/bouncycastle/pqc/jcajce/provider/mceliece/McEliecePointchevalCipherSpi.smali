...
.field private c:Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePointchevalCipher;
...
.method protected constructor <init>(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePointchevalCipher;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->d:Ljava/io/ByteArrayOutputStream;

    iput-object p1, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->b:Lorg/bouncycastle/crypto/Digest;

    iput-object p2, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->c:Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePointchevalCipher;

    new-instance p1, Ljava/io/ByteArrayOutputStream;

    invoke-direct {p1}, Ljava/io/ByteArrayOutputStream;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->d:Ljava/io/ByteArrayOutputStream;
...
.method public final b([BII)[B
    ...
    iget-object p1, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->d:Ljava/io/ByteArrayOutputStream;

    invoke-virtual {p1}, Ljava/io/ByteArrayOutputStream;->toByteArray()[B

    move-result-object p1

    iget-object p2, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->d:Ljava/io/ByteArrayOutputStream;
    ...
    iget-object p2, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->c:Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePointchevalCipher;

    invoke-virtual {p2, p1}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePointchevalCipher;->d([B)[B
    ...
    invoke-virtual {p2, p1}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePointchevalCipher;->c([B)[B
...
.method public final e(Ljava/security/Key;)I
    ...
    iget-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->c:Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePointchevalCipher;
...
.method public final l([BII)[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->d:Ljava/io/ByteArrayOutputStream;
...
.method protected final o(Ljava/security/Key;)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->b:Lorg/bouncycastle/crypto/Digest;
    ...
    invoke-virtual {v0, v1, p1}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePointchevalCipher;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
...
.method protected final p(Ljava/security/Key;Ljava/security/SecureRandom;)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->b:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {p1}, Lorg/bouncycastle/crypto/Digest;->reset()V

    iget-object p1, p0, Lorg/bouncycastle/pqc/jcajce/provider/mceliece/McEliecePointchevalCipherSpi;->c:Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePointchevalCipher;

    const/4 p2, 0x1

    invoke-virtual {p1, p2, v0}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePointchevalCipher;->a(ZLorg/bouncycastle/crypto/CipherParameters;)V
