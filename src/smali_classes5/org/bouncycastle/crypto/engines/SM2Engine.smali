...
.field private final b:Lorg/bouncycastle/crypto/engines/SM2Engine$Mode;

.field private c:Z

.field private d:Lorg/bouncycastle/crypto/params/ECKeyParameters;
...
.method private decrypt([BII)[B
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->e:Lorg/bouncycastle/crypto/params/ECDomainParameters;

    invoke-virtual {v3}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getCurve()Lorg/bouncycastle/math/ec/ECCurve;

    move-result-object v3

    invoke-virtual {v3, v1}, Lorg/bouncycastle/math/ec/ECCurve;->h([B)Lorg/bouncycastle/math/ec/ECPoint;

    move-result-object v3

    iget-object v4, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->e:Lorg/bouncycastle/crypto/params/ECDomainParameters;

    invoke-virtual {v4}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getH()Ljava/math/BigInteger;

    move-result-object v4

    invoke-virtual {v3, v4}, Lorg/bouncycastle/math/ec/ECPoint;->t(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;

    move-result-object v4

    invoke-virtual {v4}, Lorg/bouncycastle/math/ec/ECPoint;->q()Z

    move-result v4

    if-nez v4, :cond_4

    iget-object v4, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->d:Lorg/bouncycastle/crypto/params/ECKeyParameters;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/math/ec/ECPoint;->v()Lorg/bouncycastle/math/ec/ECPoint;
    ...
    iget-object v8, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->a:Lorg/bouncycastle/crypto/Digest;

    invoke-virtual {v3}, Lorg/bouncycastle/math/ec/ECPoint;->d()Lorg/bouncycastle/math/ec/ECFieldElement;
    ...
    invoke-static {p2, v0, p3, v7}, Lai/medialab/medialabauth/n;->b(IIII)I
...
.method private encrypt([BII)[B
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/math/ec/ECPoint;->v()Lorg/bouncycastle/math/ec/ECPoint;

    move-result-object v4

    invoke-virtual {v4, v1}, Lorg/bouncycastle/math/ec/ECPoint;->j(Z)[B

    move-result-object v4

    iget-object v5, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->d:Lorg/bouncycastle/crypto/params/ECKeyParameters;
    ...
    invoke-virtual {v5, v3}, Lorg/bouncycastle/math/ec/ECPoint;->t(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-static {v4, v0, v2}, Lorg/bouncycastle/util/Arrays;->i([B[B[B)[B
    ...
    :cond_1
    invoke-static {v4, v2, v0}, Lorg/bouncycastle/util/Arrays;->i([B[B[B)[B
...
.method private kdf(Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/math/ec/ECPoint;[B)V
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/math/ec/ECPoint;->d()Lorg/bouncycastle/math/ec/ECFieldElement;
    ...
    invoke-static {v7, v2, v5}, Lorg/bouncycastle/util/Pack;->d(I[BI)V
...
.method private nextK()Ljava/math/BigInteger;
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->e:Lorg/bouncycastle/crypto/params/ECDomainParameters;
    ...
    sget-object v2, Lorg/bouncycastle/util/BigIntegers;->a:Ljava/math/BigInteger;
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->e:Lorg/bouncycastle/crypto/params/ECDomainParameters;
...
.method public getOutputSize(I)I
    ...
    invoke-static {v0, v1, v2, p1}, Landroidx/compose/animation/e;->a(IIII)I

    move-result p1

    iget-object v0, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->a:Lorg/bouncycastle/crypto/Digest;
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->d:Lorg/bouncycastle/crypto/params/ECKeyParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->d:Lorg/bouncycastle/crypto/params/ECKeyParameters;
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->e:Lorg/bouncycastle/crypto/params/ECDomainParameters;

    invoke-virtual {v1}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getH()Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {v0, v1}, Lorg/bouncycastle/math/ec/ECPoint;->t(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->g:Ljava/security/SecureRandom;
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->e:Lorg/bouncycastle/crypto/params/ECDomainParameters;

    :goto_0
    iget-object p2, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->e:Lorg/bouncycastle/crypto/params/ECDomainParameters;

    invoke-virtual {p2}, Lorg/bouncycastle/crypto/params/ECDomainParameters;->getCurve()Lorg/bouncycastle/math/ec/ECCurve;

    move-result-object p2

    invoke-virtual {p2}, Lorg/bouncycastle/math/ec/ECCurve;->q()I
    ...
    iput p2, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->f:I
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/engines/SM2Engine;->d:Lorg/bouncycastle/crypto/params/ECKeyParameters;
