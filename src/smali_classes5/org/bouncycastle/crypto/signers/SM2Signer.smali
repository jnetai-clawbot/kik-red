...
# instance fields
.field private final g:Lorg/bouncycastle/crypto/signers/RandomDSAKCalculator;

.field private final h:Lorg/bouncycastle/crypto/Digest;

.field private final i:Lorg/bouncycastle/crypto/signers/DSAEncoding;

.field private j:Lorg/bouncycastle/crypto/params/ECDomainParameters;

.field private k:Lorg/bouncycastle/math/ec/ECPoint;

.field private l:Lorg/bouncycastle/crypto/params/ECKeyParameters;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/signers/DSAEncoding;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->h:Lorg/bouncycastle/crypto/Digest;
...
.method private getZ([B)[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->k:Lorg/bouncycastle/math/ec/ECPoint;
...
.method private verifySignature(Ljava/math/BigInteger;Ljava/math/BigInteger;)Z
    ...
    invoke-static {v5, p2, v4, v2}, Lorg/bouncycastle/math/ec/ECAlgorithms;->l(Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;

    move-result-object p2

    invoke-virtual {p2}, Lorg/bouncycastle/math/ec/ECPoint;->v()Lorg/bouncycastle/math/ec/ECPoint;

    move-result-object p2

    invoke-virtual {p2}, Lorg/bouncycastle/math/ec/ECPoint;->q()Z
...
.method public generateSignature()[B
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->l:Lorg/bouncycastle/crypto/params/ECKeyParameters;
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/math/ec/ECPoint;->v()Lorg/bouncycastle/math/ec/ECPoint;

    move-result-object v5

    invoke-virtual {v5}, Lorg/bouncycastle/math/ec/ECPoint;->d()Lorg/bouncycastle/math/ec/ECFieldElement;
    ...
    invoke-static {v1, v7}, Lorg/bouncycastle/util/BigIntegers;->k(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->l:Lorg/bouncycastle/crypto/params/ECKeyParameters;
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->j:Lorg/bouncycastle/crypto/params/ECDomainParameters;

    iget-object v2, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->g:Lorg/bouncycastle/crypto/signers/RandomDSAKCalculator;
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->j:Lorg/bouncycastle/crypto/params/ECDomainParameters;
    ...
    invoke-interface {p2, v1, v2}, Lorg/bouncycastle/math/ec/ECMultiplier;->a(Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->l:Lorg/bouncycastle/crypto/params/ECKeyParameters;
    ...
    :goto_2
    iput-object p2, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->k:Lorg/bouncycastle/math/ec/ECPoint;

    iget-object p2, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->l:Lorg/bouncycastle/crypto/params/ECKeyParameters;

    const-string v1, "ECNR"

    invoke-static {v1, p2, p1}, Lorg/bouncycastle/crypto/signers/a;->getDefaultProperties(Ljava/lang/String;Lorg/bouncycastle/crypto/params/ECKeyParameters;Z)Lorg/bouncycastle/crypto/CryptoServiceProperties;
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->m:[B

    iget-object p2, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->h:Lorg/bouncycastle/crypto/Digest;
...
.method public reset()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/signers/SM2Signer;->m:[B
