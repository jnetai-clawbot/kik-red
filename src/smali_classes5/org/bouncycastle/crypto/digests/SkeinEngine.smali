...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/bouncycastle/crypto/digests/SkeinEngine$a;,
        Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;,
        Lorg/bouncycastle/crypto/digests/SkeinEngine$b;,
        Lorg/bouncycastle/crypto/digests/SkeinEngine$c;
    }
.end annotation
...
.field private final h:Lorg/bouncycastle/crypto/digests/SkeinEngine$b;
...
.method public constructor <init>(II)V
    ...
    new-instance p1, Lorg/bouncycastle/crypto/digests/SkeinEngine$b;

    invoke-virtual {p2}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->getBlockSize()I

    move-result p2

    invoke-direct {p1, p0, p2}, Lorg/bouncycastle/crypto/digests/SkeinEngine$b;-><init>(Lorg/bouncycastle/crypto/digests/SkeinEngine;I)V

    iput-object p1, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$b;
...
.method private checkInitialised()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$b;
...
.method private copyIn(Lorg/bouncycastle/crypto/digests/SkeinEngine;)V
    ...
    iget-object v1, p1, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$b;

    invoke-virtual {v0, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$b;->reset(Lorg/bouncycastle/crypto/digests/SkeinEngine$b;)V
...
.method private createInitialState()V
    ...
    sget-object v0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->j:Ljava/util/Hashtable;
    ...
    new-instance v1, Lorg/bouncycastle/crypto/digests/SkeinEngine$a;
    ...
    invoke-direct {v1, v3, v4}, Lorg/bouncycastle/crypto/digests/SkeinEngine$a;-><init>(J)V

    invoke-virtual {v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$a;->getBytes()[B
...
.method private output(J[BII)V
    ...
    invoke-static {p1, p2, v1, v2}, Lorg/bouncycastle/util/Pack;->t(J[BI)V
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$b;

    invoke-virtual {p2, v1, v2, v0, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$b;->update([BII[J)V

    iget-object p2, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$b;

    invoke-virtual {p2, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$b;->doFinal([J)V
    ...
    invoke-static {v5, v6, p3, v4}, Lorg/bouncycastle/util/Pack;->t(J[BI)V
    ...
    invoke-static {v6, v7, v1, v2}, Lorg/bouncycastle/util/Pack;->t(J[BI)V
...
.method private ubiComplete(I[B)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->h:Lorg/bouncycastle/crypto/digests/SkeinEngine$b;
    ...
    invoke-virtual {p1, p2, v2, v0, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$b;->update([BII[J)V
...
.method private ubiFinal()V
    ...
    invoke-virtual {v0, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$b;->doFinal([J)V
...
.method private ubiInit(I)V
    ...
    invoke-virtual {v0, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$b;->reset(I)V
...
.method public doFinal([BI)I
    ...
    iget p1, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->b:I
...
.method public update([BII)V
    ...
    invoke-virtual {v0, p1, p2, p3, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$b;->update([BII[J)V
