...
.method public final engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-virtual/range {v2 .. v7}, Lorg/spongycastle/jce/provider/JDKKeyStore;->h(Ljava/lang/String;I[C[BI)Ljavax/crypto/Cipher;
    ...
    invoke-virtual {p1, v0, v1}, Lorg/spongycastle/crypto/digests/SHA1Digest;->doFinal([BI)I

    new-array p1, v8, [B

    invoke-static {p2, p1}, Lorg/spongycastle/util/io/Streams;->a(Ljava/io/InputStream;[B)I

    invoke-static {v0, p1}, Lorg/spongycastle/util/Arrays;->d([B[B)Z
...
.method public final engineStore(Ljava/io/OutputStream;[C)V
    ...
    iget-object v1, p0, Lorg/spongycastle/jce/provider/JDKKeyStore;->b:Ljava/security/SecureRandom;
    ...
    invoke-virtual/range {v1 .. v6}, Lorg/spongycastle/jce/provider/JDKKeyStore;->h(Ljava/lang/String;I[C[BI)Ljavax/crypto/Cipher;
    ...
    invoke-virtual {p0, v0}, Lorg/spongycastle/jce/provider/JDKKeyStore;->i(Ljava/io/OutputStream;)V
