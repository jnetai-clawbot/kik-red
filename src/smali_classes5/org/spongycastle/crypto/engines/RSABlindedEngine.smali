...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->d:Ljava/math/BigInteger;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->a:Lorg/spongycastle/crypto/engines/a;
...
.method public final a(ZLorg/spongycastle/crypto/CipherParameters;)V
    ...
    iget-object v0, p0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->a:Lorg/spongycastle/crypto/engines/a;
    ...
    iput-object p1, p0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->b:Lorg/spongycastle/crypto/params/RSAKeyParameters;

    invoke-virtual {p2}, Lorg/spongycastle/crypto/params/ParametersWithRandom;->b()Ljava/security/SecureRandom;

    move-result-object p1

    iput-object p1, p0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->c:Ljava/security/SecureRandom;
    ...
    iput-object p2, p0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->b:Lorg/spongycastle/crypto/params/RSAKeyParameters;
...
.method public final processBlock([BII)[B
    ...
    iget-object v0, p0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->b:Lorg/spongycastle/crypto/params/RSAKeyParameters;
    ...
    iget-object p2, p0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->b:Lorg/spongycastle/crypto/params/RSAKeyParameters;
    ...
    invoke-virtual {p2}, Lorg/spongycastle/crypto/params/RSAPrivateCrtKeyParameters;->g()Ljava/math/BigInteger;
    ...
    sget-object v0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->d:Ljava/math/BigInteger;

    invoke-virtual {p2, v0}, Ljava/math/BigInteger;->subtract(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v1

    iget-object v2, p0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->c:Ljava/security/SecureRandom;

    invoke-static {v0, v1, v2}, Lorg/spongycastle/util/BigIntegers;->b(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    iget-object p3, p0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->a:Lorg/spongycastle/crypto/engines/a;

    invoke-virtual {p3, p1}, Lorg/spongycastle/crypto/engines/a;->f(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    :cond_0
    iget-object p2, p0, Lorg/spongycastle/crypto/engines/RSABlindedEngine;->a:Lorg/spongycastle/crypto/engines/a;

    invoke-virtual {p2, p1}, Lorg/spongycastle/crypto/engines/a;->f(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {p2, p1}, Lorg/spongycastle/crypto/engines/a;->b(Ljava/math/BigInteger;)[B
