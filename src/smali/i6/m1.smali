...
.method protected final S(ILandroid/os/Parcel;)Z
    ...
    instance-of v0, p2, Li6/o1;

    if-eqz v0, :cond_2

    move-object v1, p2

    check-cast v1, Li6/o1;

    goto :goto_0

    :cond_2
    new-instance v1, Li6/o1;

    invoke-direct {v1, p1}, Li6/o1;-><init>(Landroid/os/IBinder;)V

    :goto_0
    invoke-interface {p0, v1}, Li6/n1;->M(Li6/o1;)V
    ...
    invoke-direct {v1, p2}, Li6/o1;-><init>(Landroid/os/IBinder;)V

    :goto_1
    invoke-interface {p0, p1, v1}, Li6/n1;->i(Landroid/os/Bundle;Li6/o1;)V
