...
# instance fields
.field private final a:Lrd/m0$b;
...
.method public constructor <init>(Lrm/e0;Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lrd/m0;->b:Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock;->writeLock()Ljava/util/concurrent/locks/ReentrantReadWriteLock$WriteLock;

    move-result-object v0

    iput-object v0, p0, Lrd/m0;->c:Ljava/util/concurrent/locks/ReentrantReadWriteLock$WriteLock;

    new-instance v0, Lrd/m0$b;

    invoke-interface {p1}, Lrm/e0;->X()Ljava/lang/String;

    move-result-object p1

    invoke-direct {v0, p2, p1}, Lrd/m0$b;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lrd/m0;->a:Lrd/m0$b;
...
# virtual methods
.method public final a(Ldc/a;)Lhc/b$f;
    .locals 12
    .param p1    # Ldc/a;
    ...
    iget-object p1, p0, Lrd/m0;->b:Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;

    invoke-interface {p1}, Ljava/util/concurrent/locks/Lock;->lock()V

    iget-object p1, p0, Lrd/m0;->a:Lrd/m0$b;
    ...
    const-class v7, Lrd/m0$a;

    const-string v8, "UserRosterEntries"
    ...
    invoke-static {v8}, Lhc/b$f;->H([B)Lhc/b$f;
    ...
    iget-object v0, p0, Lrd/m0;->b:Ljava/util/concurrent/locks/ReentrantReadWriteLock$ReadLock;
    ...
    invoke-virtual {p0, v4}, Lrd/m0;->b(Ljava/util/List;)I
...
.method public final b(Ljava/util/List;)I
    ...
    :cond_0
    iget-object v0, p0, Lrd/m0;->c:Ljava/util/concurrent/locks/ReentrantReadWriteLock$WriteLock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/Lock;->lock()V

    iget-object v0, p0, Lrd/m0;->a:Lrd/m0$b;
    ...
    iget-object p1, p0, Lrd/m0;->c:Ljava/util/concurrent/locks/ReentrantReadWriteLock$WriteLock;
...
.method public final c(Ljava/util/List;)Z
    ...
    const-string v0, "UserRosterEntries"
    ...
    :cond_0
    iget-object v1, p0, Lrd/m0;->c:Ljava/util/concurrent/locks/ReentrantReadWriteLock$WriteLock;

    invoke-interface {v1}, Ljava/util/concurrent/locks/Lock;->lock()V

    iget-object v1, p0, Lrd/m0;->a:Lrd/m0$b;
...
.method public final d(Ldc/a;)Z
    ...
    invoke-virtual {p0, p1}, Lrd/m0;->b(Ljava/util/List;)I
