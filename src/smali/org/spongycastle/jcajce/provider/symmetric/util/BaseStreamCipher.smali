...
.field private g:Lorg/spongycastle/crypto/StreamCipher;

.field private h:Lorg/spongycastle/crypto/params/ParametersWithIV;

.field private i:I

.field private j:Ljavax/crypto/spec/PBEParameterSpec;
...
.method protected constructor <init>(Lorg/spongycastle/crypto/StreamCipher;I)V
    ...
    iput-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->f:[Ljava/lang/Class;

    const/4 v0, 0x0

    iput-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->j:Ljavax/crypto/spec/PBEParameterSpec;

    iput-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->k:Ljava/lang/String;

    iput-object p1, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->g:Lorg/spongycastle/crypto/StreamCipher;

    iput p2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->i:I
...
.method protected final engineDoFinal([BII[BI)I
    ...
    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->g:Lorg/spongycastle/crypto/StreamCipher;
    ...
    :cond_0
    iget-object p1, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->g:Lorg/spongycastle/crypto/StreamCipher;
...
.method protected final engineDoFinal([BII)[B
    ...
    iget-object p2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->g:Lorg/spongycastle/crypto/StreamCipher;
...
.method protected final engineGetIV()[B
    ...
    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->h:Lorg/spongycastle/crypto/params/ParametersWithIV;
...
.method protected final engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v1, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->j:Ljavax/crypto/spec/PBEParameterSpec;

    if-eqz v1, :cond_0

    :try_start_0
    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->k:Ljava/lang/String;
...
.method protected final engineInit(ILjava/security/Key;Ljava/security/AlgorithmParameters;Ljava/security/SecureRandom;)V
    ...
    :goto_0
    iget-object v2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->f:[Ljava/lang/Class;
...
.method protected final engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iput-object p3, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->j:Ljavax/crypto/spec/PBEParameterSpec;
    ...
    :goto_1
    iget p2, p2, Lorg/spongycastle/jcajce/provider/symmetric/util/BCPBEKey;->f:I
    ...
    iput-object p2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->h:Lorg/spongycastle/crypto/params/ParametersWithIV;
    ...
    iput-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->h:Lorg/spongycastle/crypto/params/ParametersWithIV;

    :cond_5
    :goto_2
    iget p2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->i:I
    ...
    invoke-direct {p4, v0, v3, p3, p2}, Lorg/spongycastle/crypto/params/ParametersWithIV;-><init>(Lorg/spongycastle/crypto/CipherParameters;[BII)V

    iput-object p4, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->h:Lorg/spongycastle/crypto/params/ParametersWithIV;
    ...
    invoke-interface {p1, p3, v0}, Lorg/spongycastle/crypto/StreamCipher;->a(ZLorg/spongycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {p1, v2, v0}, Lorg/spongycastle/crypto/StreamCipher;->a(ZLorg/spongycastle/crypto/CipherParameters;)V
