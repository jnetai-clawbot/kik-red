...
# static fields
.field private static final l:[Lorg/bouncycastle/crypto/prng/drbg/DualECPoints;
...
.field private k:Lorg/bouncycastle/math/ec/FixedPointCombMultiplier;
...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->l:[Lorg/bouncycastle/crypto/prng/drbg/DualECPoints;

    const-string v13, "P-256"

    invoke-static {v13}, Lorg/bouncycastle/asn1/nist/NISTNamedCurves;->b(Ljava/lang/String;)Lorg/bouncycastle/asn1/x9/X9ECParametersHolder;
    ...
    invoke-virtual {v13, v0, v1}, Lorg/bouncycastle/math/ec/ECCurve;->e(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;

    move-result-object v0

    invoke-virtual {v13, v3, v4}, Lorg/bouncycastle/math/ec/ECCurve;->e(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-static {v0}, Lorg/bouncycastle/asn1/nist/NISTNamedCurves;->b(Ljava/lang/String;)Lorg/bouncycastle/asn1/x9/X9ECParametersHolder;
    ...
    invoke-virtual {v0, v5, v6}, Lorg/bouncycastle/math/ec/ECCurve;->e(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;

    move-result-object v3

    invoke-virtual {v0, v7, v8}, Lorg/bouncycastle/math/ec/ECCurve;->e(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-virtual {v0, v9, v10}, Lorg/bouncycastle/math/ec/ECCurve;->e(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;

    move-result-object v3

    invoke-virtual {v0, v11, v12}, Lorg/bouncycastle/math/ec/ECCurve;->e(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/Digest;ILorg/bouncycastle/crypto/prng/EntropySource;[B[B)V
    ...
    sget-object v1, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->l:[Lorg/bouncycastle/crypto/prng/drbg/DualECPoints;
...
.method public constructor <init>([Lorg/bouncycastle/crypto/prng/drbg/DualECPoints;Lorg/bouncycastle/crypto/Digest;ILorg/bouncycastle/crypto/prng/EntropySource;[B[B)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->k:Lorg/bouncycastle/math/ec/FixedPointCombMultiplier;
    ...
    invoke-static {p5, v0}, Lorg/bouncycastle/crypto/prng/drbg/a;->isTooLarge([BI)Z
    ...
    invoke-static {p4, p6, p5}, Lorg/bouncycastle/util/Arrays;->i([B[B[B)[B
    ...
    invoke-static {p2}, Lorg/bouncycastle/crypto/prng/drbg/a;->getMaxSecurityStrength(Lorg/bouncycastle/crypto/Digest;)I
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->g:Lorg/bouncycastle/math/ec/ECPoint;
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->h:Lorg/bouncycastle/math/ec/ECPoint;
    ...
    :cond_2
    :goto_1
    iget-object p1, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->g:Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-static {p1, p4, p2}, Lorg/bouncycastle/crypto/prng/drbg/a;->hash_df(Lorg/bouncycastle/crypto/Digest;[BI)[B

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->i:[B

    array-length p1, p1

    iput p1, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->j:I
    ...
    invoke-static {p2, p3, p4, v1, p5}, Lai/medialab/medialabauth/n;->f(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private getEntropy()[B
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->d:I
...
.method private getScalarMultipleXCoord(Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->k:Lorg/bouncycastle/math/ec/FixedPointCombMultiplier;

    invoke-virtual {v0, p1, p2}, Lorg/bouncycastle/math/ec/AbstractECMultiplier;->a(Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
...
.method public generate([B[BZ)I
    ...
    invoke-static {p2, v2}, Lorg/bouncycastle/crypto/prng/drbg/a;->isTooLarge([BI)Z
    ...
    invoke-static {v2, p2, v3}, Lorg/bouncycastle/crypto/prng/drbg/a;->hash_df(Lorg/bouncycastle/crypto/Digest;[BI)[B

    move-result-object p2

    new-instance v2, Ljava/math/BigInteger;

    iget-object v3, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->i:[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->i:[B
    ...
    iget-object v6, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->g:Lorg/bouncycastle/math/ec/ECPoint;
    ...
    iget-object p3, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->g:Lorg/bouncycastle/math/ec/ECPoint;
    ...
    :cond_6
    iget p1, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->j:I

    iget-object p2, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->g:Lorg/bouncycastle/math/ec/ECPoint;
...
.method public getBlockSize()I
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->f:I
...
.method public reseed([B)V
    ...
    invoke-static {p1, v0}, Lorg/bouncycastle/crypto/prng/drbg/a;->isTooLarge([BI)Z
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/prng/drbg/DualECSP800DRBG;->i:[B
    ...
    invoke-static {v1, v0, p1}, Lorg/bouncycastle/util/Arrays;->i([B[B[B)[B
    ...
    invoke-static {v0, p1, v1}, Lorg/bouncycastle/crypto/prng/drbg/a;->hash_df(Lorg/bouncycastle/crypto/Digest;[BI)[B
