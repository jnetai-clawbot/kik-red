...
.field private b:Lorg/bouncycastle/crypto/digests/Blake2sDigest;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v1, v0}, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;-><init>(ILorg/bouncycastle/crypto/CryptoServicePurpose;)V
...
.method public constructor <init>(I[B[B[BLorg/bouncycastle/crypto/CryptoServicePurpose;)V
    ...
    iput p1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->a:I

    invoke-direct {p0}, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->computeNodeOffset()J

    move-result-wide v6

    iput-wide v6, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->h:J
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->b:Lorg/bouncycastle/crypto/digests/Blake2sDigest;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/digests/Blake2xsDigest;)V
    ...
    iget v0, p1, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->a:I
    ...
    iget-object v1, p1, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->b:Lorg/bouncycastle/crypto/digests/Blake2sDigest;

    invoke-direct {v0, v1}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;-><init>(Lorg/bouncycastle/crypto/digests/Blake2sDigest;)V

    iput-object v0, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->b:Lorg/bouncycastle/crypto/digests/Blake2sDigest;

    iget-object v0, p1, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->c:[B
    ...
    iget-object v0, p1, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->d:[B

    invoke-static {v0}, Lorg/bouncycastle/util/Arrays;->b([B)[B

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->d:[B

    iget v0, p1, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->e:I

    iput v0, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->e:I

    iget v0, p1, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->f:I

    iput v0, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->f:I

    iget-wide v0, p1, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->g:J

    iput-wide v0, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->g:J

    iget-wide v0, p1, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->h:J
...
.method public doOutput([BII)I
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->c:[B

    iget-object v1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->b:Lorg/bouncycastle/crypto/digests/Blake2sDigest;

    invoke-virtual {v1, p2, v0}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;->doFinal([BI)I

    :cond_0
    iget p2, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->a:I

    const v1, 0xffff

    if-eq p2, v1, :cond_2

    iget v1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->f:I
    ...
    :cond_2
    iget-wide v1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->g:J
    ...
    iget v1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->e:I
    ...
    iget-wide v4, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->h:J

    invoke-direct {v1, v3, v2, v4, v5}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;-><init>(IIJ)V

    iget-object v2, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->c:[B

    array-length v3, v2

    invoke-virtual {v1, v2, v0, v3}, Lorg/bouncycastle/crypto/digests/Blake2sDigest;->update([BII)V

    iget-object v2, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->d:[B
    ...
    iget-wide v1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->h:J

    const-wide/16 v3, 0x1

    add-long/2addr v1, v3

    iput-wide v1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->h:J

    iget-wide v1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->g:J

    add-long/2addr v1, v3

    iput-wide v1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->g:J

    :cond_3
    iget-object v1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->d:[B

    iget v2, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->e:I
    ...
    iput v2, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->e:I

    iget v1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->f:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lorg/bouncycastle/crypto/digests/Blake2xsDigest;->f:I
