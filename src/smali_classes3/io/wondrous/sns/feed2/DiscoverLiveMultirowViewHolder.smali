.class public final Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;",
...
.field private d:Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;

.field private e:Lio/wondrous/sns/feed2/c3;
...
.field private final k:Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder$discoverLiveFeedListener$1;
...
.method public constructor <init>(Landroid/view/View;Lio/wondrous/sns/u4;Lak/d;Lio/wondrous/sns/feed2/LiveFeedViewHolder$Listener;)V
    ...
    iput-object p2, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->a:Lio/wondrous/sns/u4;

    iput-object p3, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->b:Lak/d;

    iput-object p4, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->c:Lio/wondrous/sns/feed2/LiveFeedViewHolder$Listener;
    ...
    const-string/jumbo p3, "view.findViewById(R.id.discover_top_space)"

    invoke-static {p2, p3}, Lkotlin/jvm/internal/g;->h(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast p2, Landroid/widget/Space;

    iput-object p2, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->f:Landroid/widget/Space;
    ...
    const-string/jumbo p3, "view.findViewById(R.id.category_name)"

    invoke-static {p2, p3}, Lkotlin/jvm/internal/g;->h(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast p2, Landroid/widget/TextView;

    iput-object p2, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->g:Landroid/widget/TextView;
    ...
    const-string/jumbo p3, "view.findViewById(R.id.view_all_header)"

    invoke-static {p2, p3}, Lkotlin/jvm/internal/g;->h(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast p2, Landroid/widget/TextView;

    iput-object p2, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->h:Landroid/widget/TextView;
    ...
    const-string/jumbo p3, "view.findViewById(R.id.discover_items)"

    invoke-static {p2, p3}, Lkotlin/jvm/internal/g;->h(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast p2, Landroidx/recyclerview/widget/RecyclerView;

    iput-object p2, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->i:Landroidx/recyclerview/widget/RecyclerView;
    ...
    const-string/jumbo p3, "view.findViewById(R.id.view_all_click_target)"

    invoke-static {p1, p3}, Lkotlin/jvm/internal/g;->h(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object p1, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->j:Landroid/view/View;
    ...
    new-instance p1, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder$discoverLiveFeedListener$1;

    invoke-direct {p1, p0}, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder$discoverLiveFeedListener$1;-><init>(Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;)V

    iput-object p1, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->k:Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder$discoverLiveFeedListener$1;

    return-void
.end method

.method public static g(Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;Lio/wondrous/sns/data/events/model/SnsEventCorrelationInfo;)V
    .locals 4
    ...
    iget-object v0, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->k:Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder$discoverLiveFeedListener$1;

    new-instance v1, Lio/wondrous/sns/feed2/discover/DiscoverCategoryArgs;

    invoke-virtual {p1}, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;->b()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p1}, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;->g()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p1}, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;->e()Lio/wondrous/sns/data/model/discover/DiscoverCardType;
    ...
    iget-object p0, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->b:Lak/d;

    invoke-virtual {v0, v1, p0}, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder$discoverLiveFeedListener$1;->a(Lio/wondrous/sns/feed2/discover/DiscoverCategoryArgs;Lak/d;)V
...
.method public final d(Landroidx/recyclerview/widget/RecyclerView$RecycledViewPool;)V
    ...
    const-string/jumbo v0, "recycledViewPool"

    invoke-static {p1, v0}, Lkotlin/jvm/internal/g;->i(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v0, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->i:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final f(Lio/wondrous/sns/feed2/model/LiveFeedItem;ILio/wondrous/sns/feed2/LiveFeedViewHolderConfig;)V
    ...
    check-cast v1, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;

    iput-object v1, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->d:Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;

    iget-object v2, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->g:Landroid/widget/TextView;

    invoke-virtual {v1}, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;->f()Z
    ...
    invoke-virtual {v1}, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;->g()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v2, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->f:Landroid/widget/Space;
    ...
    iget-object v2, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->i:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_3
    iget-object v2, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->e:Lio/wondrous/sns/feed2/c3;

    if-eqz v2, :cond_4

    iget-object v3, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->i:Landroidx/recyclerview/widget/RecyclerView;

    new-instance v4, Lio/wondrous/sns/feed2/DiscoverMarqueeItemDecoration;

    invoke-static/range {p0 .. p0}, Lio/wondrous/sns/util/extensions/RecyclerViewHoldersKt;->b(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)Landroid/content/Context;
    ...
    sget v6, Luh/f;->sns_discover_category_feed_internal_margin:I
    ...
    invoke-direct {v4, v5, v6, v2, v13}, Lio/wondrous/sns/feed2/DiscoverMarqueeItemDecoration;-><init>(IIIZ)V
    ...
    invoke-virtual {v1}, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;->c()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;->a()Lio/wondrous/sns/data/model/discover/DiscoverCardType;

    move-result-object v4

    iget-object v5, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->a:Lio/wondrous/sns/u4;

    iget-object v6, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->b:Lak/d;

    iget-object v8, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->c:Lio/wondrous/sns/feed2/LiveFeedViewHolder$Listener;

    iget-object v10, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->k:Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder$discoverLiveFeedListener$1;

    new-instance v11, Lio/wondrous/sns/feed2/discover/DiscoverCategoryArgs;

    invoke-virtual {v1}, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;->b()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;->e()Lio/wondrous/sns/data/model/discover/DiscoverCardType;
    ...
    invoke-virtual {v1}, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;->h()Lio/wondrous/sns/data/model/discover/DiscoverViewAllVisibility;
    ...
    invoke-virtual {v2}, Lio/wondrous/sns/feed2/DiscoverItemAdapter;->f()V

    iget-object v3, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->j:Landroid/view/View;

    new-instance v4, Lio/wondrous/sns/feed2/n;

    invoke-direct {v4, v0, v1, v14}, Lio/wondrous/sns/feed2/n;-><init>(Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;Lio/wondrous/sns/data/events/model/SnsEventCorrelationInfo;)V
    ...
    iget-object v2, v0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->h:Landroid/widget/TextView;
...
.method public final getId()Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->d:Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lio/wondrous/sns/feed2/model/DiscoverFeedMultiRowItem;->b()Ljava/lang/String;
...
.method public final h(Lio/wondrous/sns/feed2/c3;)V
    .locals 2

    iput-object p1, p0, Lio/wondrous/sns/feed2/DiscoverLiveMultirowViewHolder;->e:Lio/wondrous/sns/feed2/c3;
