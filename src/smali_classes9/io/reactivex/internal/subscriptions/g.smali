...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lio/reactivex/internal/subscriptions/g;->$VALUES:[Lio/reactivex/internal/subscriptions/g;
...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    invoke-interface {p0}, Lxp/c;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    invoke-interface {v0, p2, p3}, Lxp/c;->request(J)V

    goto :goto_0

    :cond_0
    invoke-static {p2, p3}, Lio/reactivex/internal/subscriptions/g;->validate(J)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p1, p2, p3}, La0/b;->a(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    invoke-interface {p0, v0, v1}, Lxp/c;->request(J)V
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lxp/c;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lio/reactivex/internal/subscriptions/g;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lxp/c;)Z
    ...
    invoke-interface {p2, p0, p1}, Lxp/c;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Lxp/c;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Lxp/c;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lxp/c;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {}, Lio/reactivex/internal/subscriptions/g;->reportSubscriptionSet()V
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lxp/c;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, p2, p3}, Lxp/c;->request(J)V
...
.method public static validate(Lxp/c;Lxp/c;)Z
    .locals 1
