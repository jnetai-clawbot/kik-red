...
.method private c(Lorg/spongycastle/x509/X509CertStoreSelector;)Ljava/util/Collection;
    .locals 5
    ...
    invoke-virtual {v1, p1}, Lorg/spongycastle/x509/X509CertPairStoreSelector;->c(Lorg/spongycastle/x509/X509CertStoreSelector;)V
    ...
    invoke-virtual {v1, p1}, Lorg/spongycastle/x509/X509CertPairStoreSelector;->d(Lorg/spongycastle/x509/X509CertStoreSelector;)V

    new-instance p1, Ljava/util/HashSet;

    iget-object v2, p0, Lorg/spongycastle/jce/provider/X509StoreLDAPCerts;->a:Lorg/spongycastle/x509/util/LDAPStoreHelper;

    invoke-virtual {v2, v1}, Lorg/spongycastle/x509/util/LDAPStoreHelper;->s(Lorg/spongycastle/x509/X509CertPairStoreSelector;)Ljava/util/Collection;
...
.method public final a(Lorg/spongycastle/util/Selector;)Ljava/util/Collection;
    ...
    invoke-virtual {v1, p1}, Lorg/spongycastle/x509/util/LDAPStoreHelper;->q(Lorg/spongycastle/x509/X509CertStoreSelector;)Ljava/util/Collection;

    move-result-object v1

    invoke-interface {v0, v1}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    invoke-direct {p0, p1}, Lorg/spongycastle/jce/provider/X509StoreLDAPCerts;->c(Lorg/spongycastle/x509/X509CertStoreSelector;)Ljava/util/Collection;
    ...
    invoke-virtual {v1, p1}, Lorg/spongycastle/x509/util/LDAPStoreHelper;->v(Lorg/spongycastle/x509/X509CertStoreSelector;)Ljava/util/Collection;
