...
# instance fields
.field private a:Lorg/spongycastle/crypto/digests/GOST3411Digest;

.field private b:Lorg/spongycastle/crypto/signers/GOST3410Signer;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->a:Lorg/spongycastle/crypto/digests/GOST3411Digest;
    ...
    iput-object v0, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->b:Lorg/spongycastle/crypto/signers/GOST3410Signer;
...
.method protected final engineInitSign(Ljava/security/PrivateKey;)V
    ...
    :goto_0
    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->a:Lorg/spongycastle/crypto/digests/GOST3411Digest;

    invoke-virtual {v0}, Lorg/spongycastle/crypto/digests/GOST3411Digest;->reset()V

    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->c:Ljava/security/SecureRandom;

    const/4 v1, 0x1

    if-eqz v0, :cond_1

    iget-object v2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->b:Lorg/spongycastle/crypto/signers/GOST3410Signer;
    ...
    invoke-virtual {v2, v1, v3}, Lorg/spongycastle/crypto/signers/GOST3410Signer;->a(ZLorg/spongycastle/crypto/CipherParameters;)V

    goto :goto_1

    :cond_1
    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->b:Lorg/spongycastle/crypto/signers/GOST3410Signer;

    invoke-virtual {v0, v1, p1}, Lorg/spongycastle/crypto/signers/GOST3410Signer;->a(ZLorg/spongycastle/crypto/CipherParameters;)V
...
.method protected final engineInitSign(Ljava/security/PrivateKey;Ljava/security/SecureRandom;)V
    ...
    iput-object p2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->c:Ljava/security/SecureRandom;
...
.method protected final engineInitVerify(Ljava/security/PublicKey;)V
    ...
    invoke-static {p1}, Lorg/spongycastle/jce/provider/GOST3410Util;->b(Ljava/security/PublicKey;)Lorg/spongycastle/crypto/params/AsymmetricKeyParameter;
...
.method protected final engineSign()[B
    ...
    iget-object v2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->a:Lorg/spongycastle/crypto/digests/GOST3411Digest;

    const/4 v3, 0x0

    invoke-virtual {v2, v1, v3}, Lorg/spongycastle/crypto/digests/GOST3411Digest;->doFinal([BI)I
    ...
    iget-object v5, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->b:Lorg/spongycastle/crypto/signers/GOST3410Signer;

    invoke-virtual {v5, v1}, Lorg/spongycastle/crypto/signers/GOST3410Signer;->generateSignature([B)[Ljava/math/BigInteger;
...
.method protected final engineUpdate(B)V
    ...
    invoke-virtual {v0, p1}, Lorg/spongycastle/crypto/digests/GOST3411Digest;->update(B)V
...
.method protected final engineUpdate([BII)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lorg/spongycastle/crypto/digests/GOST3411Digest;->update([BII)V
...
.method protected final engineVerify([B)Z
    ...
    invoke-virtual {v0, v1, v2, p1}, Lorg/spongycastle/crypto/signers/GOST3410Signer;->verifySignature([BLjava/math/BigInteger;Ljava/math/BigInteger;)Z
