...
.method constructor <init>(Lorg/spongycastle/asn1/ASN1Sequence;)V
    ...
    invoke-static {p1}, Lorg/spongycastle/asn1/x509/Holder;->h(Ljava/lang/Object;)Lorg/spongycastle/asn1/x509/Holder;
...
.method private c(Lorg/spongycastle/asn1/x509/GeneralNames;)[Ljava/security/Principal;
    .locals 5

    invoke-virtual {p1}, Lorg/spongycastle/asn1/x509/GeneralNames;->e()[Lorg/spongycastle/asn1/x509/GeneralName;
    ...
    invoke-virtual {v3}, Lorg/spongycastle/asn1/x509/GeneralName;->h()I
    ...
    invoke-virtual {v4}, Lorg/spongycastle/asn1/ASN1Object;->a()[B
...
.method private e(Lorg/spongycastle/jce/X509Principal;Lorg/spongycastle/asn1/x509/GeneralNames;)Z
    .locals 5
    ...
    invoke-virtual {v2}, Lorg/spongycastle/asn1/x509/GeneralName;->h()I
...
.method public final a()[Ljava/security/Principal;
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/Holder;->e()Lorg/spongycastle/asn1/x509/GeneralNames;
    ...
    invoke-direct {p0, v0}, Lorg/spongycastle/x509/AttributeCertificateHolder;->c(Lorg/spongycastle/asn1/x509/GeneralNames;)[Ljava/security/Principal;
...
.method public final b()[Ljava/security/Principal;
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/IssuerSerial;->e()Lorg/spongycastle/asn1/x509/GeneralNames;
...
.method public final clone()Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lorg/spongycastle/asn1/x509/Holder;->g()Lorg/spongycastle/asn1/ASN1Primitive;
...
.method public final d()Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/IssuerSerial;->h()Lorg/spongycastle/asn1/ASN1Integer;
...
.method public final match(Ljava/security/cert/Certificate;)Z
    ...
    invoke-virtual {v2}, Lorg/spongycastle/asn1/x509/Holder;->c()Lorg/spongycastle/asn1/x509/IssuerSerial;
    ...
    invoke-virtual {p1}, Lorg/spongycastle/asn1/x509/Holder;->c()Lorg/spongycastle/asn1/x509/IssuerSerial;

    move-result-object p1

    invoke-virtual {p1}, Lorg/spongycastle/asn1/x509/IssuerSerial;->h()Lorg/spongycastle/asn1/ASN1Integer;
    ...
    invoke-static {p1}, Lorg/spongycastle/asn1/x509/TBSCertificateStructure;->e(Ljava/lang/Object;)Lorg/spongycastle/asn1/x509/TBSCertificateStructure;

    move-result-object p1

    new-instance v0, Lorg/spongycastle/jce/X509Principal;

    invoke-virtual {p1}, Lorg/spongycastle/asn1/x509/TBSCertificateStructure;->h()Lorg/spongycastle/asn1/x500/X500Name;
    ...
    invoke-direct {v0, p1}, Lorg/spongycastle/jce/X509Principal;-><init>(Lorg/spongycastle/asn1/x509/X509Name;)V
    :try_end_1
    ...
    invoke-virtual {p1}, Lorg/spongycastle/asn1/x509/IssuerSerial;->e()Lorg/spongycastle/asn1/x509/GeneralNames;

    move-result-object p1

    invoke-direct {p0, v0, p1}, Lorg/spongycastle/x509/AttributeCertificateHolder;->e(Lorg/spongycastle/jce/X509Principal;Lorg/spongycastle/asn1/x509/GeneralNames;)Z
    ...
    invoke-virtual {v2}, Lorg/spongycastle/asn1/x509/Holder;->e()Lorg/spongycastle/asn1/x509/GeneralNames;
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/TBSCertificateStructure;->k()Lorg/spongycastle/asn1/x500/X500Name;

    move-result-object v0

    invoke-static {v0}, Lorg/spongycastle/asn1/x509/X509Name;->h(Ljava/lang/Object;)Lorg/spongycastle/asn1/x509/X509Name;

    move-result-object v0

    invoke-direct {v2, v0}, Lorg/spongycastle/jce/X509Principal;-><init>(Lorg/spongycastle/asn1/x509/X509Name;)V
    :try_end_3
    ...
    invoke-direct {p0, v2, v0}, Lorg/spongycastle/x509/AttributeCertificateHolder;->e(Lorg/spongycastle/jce/X509Principal;Lorg/spongycastle/asn1/x509/GeneralNames;)Z
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/Holder;->i()Lorg/spongycastle/asn1/x509/ObjectDigestInfo;
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/ObjectDigestInfo;->c()Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;
    ...
    invoke-virtual {v4}, Lorg/spongycastle/asn1/x509/Holder;->i()Lorg/spongycastle/asn1/x509/ObjectDigestInfo;
    ...
    invoke-virtual {v4}, Lorg/spongycastle/asn1/x509/ObjectDigestInfo;->e()Lorg/spongycastle/asn1/DEREnumerated;

    move-result-object v4

    invoke-virtual {v4}, Lorg/spongycastle/asn1/DEREnumerated;->o()Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/x509/ObjectDigestInfo;->i()Lorg/spongycastle/asn1/DERBitString;
