...
.method protected static a(Ljava/util/LinkedHashSet;Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)V
    .locals 2
    ...
    :try_start_1
    invoke-static {p1, v0}, Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;->c(Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/security/cert/CertStore;)Ljava/util/Collection;
...
.method static b(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    .locals 2
    ...
    :try_start_1
    sget-object v1, Lorg/bouncycastle/jce/provider/b;->b:Ljava/lang/String;
    ...
    invoke-static {p0}, Lorg/bouncycastle/asn1/x509/AuthorityKeyIdentifier;->k(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/AuthorityKeyIdentifier;

    move-result-object p0

    invoke-virtual {p0}, Lorg/bouncycastle/asn1/x509/AuthorityKeyIdentifier;->m()[B
    ...
    :try_start_2
    invoke-static {v0, p0, p1}, Lorg/bouncycastle/jce/provider/b;->a(Ljava/util/LinkedHashSet;Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)V

    invoke-static {v0, p0, p2}, Lorg/bouncycastle/jce/provider/b;->a(Ljava/util/LinkedHashSet;Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)V
    :try_end_2
...
.method static c(Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;->a()Lorg/bouncycastle/jcajce/PKIXExtendedParameters;

    move-result-object p0

    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->u()Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;
    ...
    :try_start_0
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->p()Ljava/util/List;

    move-result-object v2

    invoke-static {v1, v0, v2}, Lorg/bouncycastle/jce/provider/b;->a(Ljava/util/LinkedHashSet;Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)V

    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->o()Ljava/util/List;

    move-result-object p0

    invoke-static {v1, v0, p0}, Lorg/bouncycastle/jce/provider/b;->a(Ljava/util/LinkedHashSet;Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)V
    :try_end_0
    ...
    :cond_0
    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/PKIXCertStoreSelector;->b()Ljava/security/cert/Certificate;
...
.method protected static d(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {v5}, Lorg/bouncycastle/asn1/x500/X500Name;->k(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    invoke-static {v7}, Lorg/bouncycastle/asn1/x500/X500Name;->k(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
...
.method static e([BLjava/util/Map;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([B",
...
.method static f(Lorg/bouncycastle/asn1/x509/CRLDistPoint;Ljava/util/Map;Ljava/util/Date;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2}, Lorg/bouncycastle/asn1/x509/DistributionPoint;->n()Lorg/bouncycastle/asn1/x509/DistributionPointName;

    move-result-object v2

    if-eqz v2, :cond_2

    invoke-virtual {v2}, Lorg/bouncycastle/asn1/x509/DistributionPointName;->o()I

    move-result v3

    if-nez v3, :cond_2

    invoke-virtual {v2}, Lorg/bouncycastle/asn1/x509/DistributionPointName;->n()Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-interface {p3, p1}, Lorg/bouncycastle/jcajce/util/JcaJceHelper;->f(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/DistributionPoint;->n()Lorg/bouncycastle/asn1/x509/DistributionPointName;
    ...
    invoke-static {p1, p2, v4}, Lorg/bouncycastle/jce/provider/d;->a(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Lorg/bouncycastle/jcajce/PKIXCRLStore;
...
.method protected static g(Ljava/security/PublicKey;)Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method protected static h(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/GeneralName;->n()I
    ...
    invoke-direct {p0, p2, p1}, Lorg/bouncycastle/jce/provider/AnnotatedException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    throw p0
.end method

.method protected static i(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/c;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :cond_1
    invoke-static {v1}, Lorg/bouncycastle/jce/provider/h;->e(Ljavax/security/auth/x500/X500Principal;)Lorg/bouncycastle/asn1/x500/X500Name;

    move-result-object p1

    :goto_0
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/h;->a(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x500/X500Name;
    ...
    :try_start_1
    sget-object p1, Lorg/bouncycastle/asn1/x509/Extension;->j:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;->y()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p1}, Lorg/bouncycastle/jce/provider/b;->l(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object p1

    invoke-static {p1}, Lorg/bouncycastle/asn1/ASN1Enumerated;->v(Ljava/lang/Object;)Lorg/bouncycastle/asn1/ASN1Enumerated;
    ...
    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/jce/provider/AnnotatedException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_7
    invoke-virtual {p2}, Lorg/bouncycastle/asn1/ASN1Enumerated;->y()I
    ...
    :cond_8
    iput p1, p3, Lorg/bouncycastle/jce/provider/c;->a:I

    invoke-virtual {v0}, Ljava/security/cert/X509CRLEntry;->getRevocationDate()Ljava/util/Date;

    move-result-object p0

    iput-object p0, p3, Lorg/bouncycastle/jce/provider/c;->b:Ljava/util/Date;
...
.method protected static j(Lorg/bouncycastle/jcajce/PKIXCertRevocationCheckerParameters;Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/util/Date;)Ljava/util/Set;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;,
    ...
    invoke-static {p1, v1, v0}, Lorg/bouncycastle/jce/provider/b;->h(Lorg/bouncycastle/asn1/x509/DistributionPoint;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    :try_end_0
    .catch Lorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->g()Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;

    invoke-virtual {p1}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->f()Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;
    ...
    invoke-virtual {p3}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->m()Ljava/util/List;

    move-result-object p3

    invoke-static {p1, p4, v0, p3}, Lorg/bouncycastle/jce/provider/g;->a(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-interface {p2}, Lorg/bouncycastle/x509/X509AttributeCertificate;->d()Lorg/bouncycastle/x509/AttributeCertificateIssuer;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/PKIXCertRevocationCheckerParameters;->a()Ljava/security/cert/CertPath;

    move-result-object p3

    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/PKIXCertRevocationCheckerParameters;->b()I

    move-result p0

    invoke-direct {p1, p2, p3, p0}, Lorg/bouncycastle/jce/provider/o;-><init>(Ljava/lang/String;Ljava/security/cert/CertPath;I)V
    ...
    sget-object v0, Lorg/bouncycastle/asn1/x500/style/RFC4519Style;->j:Lorg/bouncycastle/asn1/x500/style/RFC4519Style;

    invoke-static {p2}, Lorg/bouncycastle/jce/provider/h;->c(Ljava/security/cert/X509Certificate;)Lorg/bouncycastle/asn1/x500/X500Name;

    move-result-object p2

    invoke-virtual {v0, p2}, Lorg/bouncycastle/asn1/x500/style/RFC4519Style;->c(Lorg/bouncycastle/asn1/x500/X500Name;)Ljava/lang/String;
...
.method protected static k(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;Lorg/bouncycastle/jcajce/util/JcaJceHelper;)Ljava/util/Set;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_1
    sget-object v1, Lorg/bouncycastle/jce/provider/b;->c:Ljava/lang/String;

    invoke-static {p1, v1}, Lorg/bouncycastle/jce/provider/b;->l(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-virtual {v2, p1}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->h([B)V

    invoke-virtual {v2}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->i()V

    invoke-virtual {v2, v1}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->j(Ljava/math/BigInteger;)V

    invoke-virtual {v2}, Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector$Builder;->f()Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;

    move-result-object v0

    invoke-static {v0, p0, p2, p3}, Lorg/bouncycastle/jce/provider/g;->a(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {p3}, Lorg/bouncycastle/util/Properties;->c(Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Lorg/bouncycastle/asn1/x509/CRLDistPoint;->m(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/CRLDistPoint;

    move-result-object p1

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/x509/CRLDistPoint;->k()[Lorg/bouncycastle/asn1/x509/DistributionPoint;
    ...
    invoke-static {p3, p0, v4}, Lorg/bouncycastle/jce/provider/d;->a(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Lorg/bouncycastle/jcajce/PKIXCRLStore;
    ...
    invoke-static {v0, p0, v4, v3}, Lorg/bouncycastle/jce/provider/g;->a(Lorg/bouncycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    :cond_6
    sget-object p4, Lorg/bouncycastle/jce/provider/l;->f:Ljava/lang/String;
...
.method protected static l(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method protected static m(Ljava/util/List;ILorg/bouncycastle/jcajce/util/JcaJceHelper;)Ljava/security/PublicKey;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-interface {p2, p0}, Lorg/bouncycastle/jcajce/util/JcaJceHelper;->h(Ljava/lang/String;)Ljava/security/KeyFactory;
...
.method protected static final n(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-static {v1}, Lorg/bouncycastle/asn1/ASN1OutputStream;->a(Ljava/io/OutputStream;)Lorg/bouncycastle/asn1/ASN1OutputStream;
    ...
    invoke-virtual {v2, v3}, Lorg/bouncycastle/asn1/ASN1OutputStream;->o(Lorg/bouncycastle/asn1/ASN1Encodable;)V
...
.method protected static o(Ljava/util/Date;ILjava/security/cert/CertPath;I)Ljava/util/Date;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    invoke-virtual {p3}, Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;->y()Ljava/lang/String;
    ...
    invoke-static {p2}, Lorg/bouncycastle/asn1/ASN1GeneralizedTime;->x(Ljava/lang/Object;)Lorg/bouncycastle/asn1/ASN1GeneralizedTime;
...
.method protected static p(Lorg/bouncycastle/jcajce/PKIXExtendedParameters;Ljava/util/Date;)Ljava/util/Date;
    .locals 0

    invoke-virtual {p0}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->w()Ljava/util/Date;
...
.method static q(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lorg/bouncycastle/jce/provider/b;->d(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
...
.method protected static r(Ljava/security/cert/X509Certificate;)Z
    .locals 1
...
.method protected static s(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;
    .locals 2
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/jce/provider/b;->t([Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V

    return-object p0
.end method

.method private static t([Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
    .locals 1
    ...
    invoke-static {p0, v0}, Lorg/bouncycastle/jce/provider/b;->t([Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V
