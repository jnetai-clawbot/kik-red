...
.method public constructor <init>()V
    ...
    iput v0, p0, Lorg/bouncycastle/asn1/DERSequence;->c:I
...
.method public constructor <init>(Lorg/bouncycastle/asn1/ASN1Encodable;)V
    ...
    iput p1, p0, Lorg/bouncycastle/asn1/DERSequence;->c:I
...
.method public static E(Lorg/bouncycastle/asn1/ASN1Sequence;)Lorg/bouncycastle/asn1/DERSequence;
    .locals 0

    invoke-virtual {p0}, Lorg/bouncycastle/asn1/ASN1Sequence;->s()Lorg/bouncycastle/asn1/ASN1Primitive;
...
.method private F()I
    ...
    iget v0, p0, Lorg/bouncycastle/asn1/DERSequence;->c:I
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/ASN1Primitive;->s()Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v3

    const/4 v4, 0x1

    invoke-virtual {v3, v4}, Lorg/bouncycastle/asn1/ASN1Primitive;->o(Z)I
    ...
    :cond_0
    iput v2, p0, Lorg/bouncycastle/asn1/DERSequence;->c:I
...
.method final A()Lorg/bouncycastle/asn1/ASN1BitString;
    ...
    invoke-static {v1}, Lorg/bouncycastle/asn1/BERBitString;->A([Lorg/bouncycastle/asn1/ASN1BitString;)[B
...
.method final C()Lorg/bouncycastle/asn1/ASN1OctetString;
    ...
    invoke-static {v1}, Lorg/bouncycastle/asn1/BEROctetString;->x([Lorg/bouncycastle/asn1/ASN1OctetString;)[B
...
.method final m(Lorg/bouncycastle/asn1/ASN1OutputStream;Z)V
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/ASN1OutputStream;->b()Lorg/bouncycastle/asn1/e;
    ...
    iget v1, p0, Lorg/bouncycastle/asn1/DERSequence;->c:I
    ...
    iget-object v6, p0, Lorg/bouncycastle/asn1/ASN1Sequence;->a:[Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/asn1/ASN1Primitive;->s()Lorg/bouncycastle/asn1/ASN1Primitive;

    move-result-object v6

    aput-object v6, v1, v4

    invoke-virtual {v6, v3}, Lorg/bouncycastle/asn1/ASN1Primitive;->o(Z)I
    ...
    :cond_1
    iput v5, p0, Lorg/bouncycastle/asn1/DERSequence;->c:I

    invoke-virtual {p1, v5}, Lorg/bouncycastle/asn1/ASN1OutputStream;->i(I)V
    ...
    invoke-virtual {p1, p2, v3}, Lorg/bouncycastle/asn1/ASN1Primitive;->m(Lorg/bouncycastle/asn1/ASN1OutputStream;Z)V
    ...
    :cond_2
    :goto_2
    invoke-direct {p0}, Lorg/bouncycastle/asn1/DERSequence;->F()I

    move-result v1

    invoke-virtual {p1, v1}, Lorg/bouncycastle/asn1/ASN1OutputStream;->i(I)V

    :goto_3
    if-ge v2, v0, :cond_3

    iget-object p1, p0, Lorg/bouncycastle/asn1/ASN1Sequence;->a:[Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/asn1/ASN1Primitive;->s()Lorg/bouncycastle/asn1/ASN1Primitive;
