...
# static fields
.field private static final d:Lorg/bouncycastle/util/BigIntegers$Cache;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->d:Lorg/bouncycastle/util/BigIntegers$Cache;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->e:Ljava/math/BigInteger;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->f:Ljava/math/BigInteger;
...
.method public constructor <init>(ZLjava/math/BigInteger;Ljava/math/BigInteger;Z)V
    ...
    :cond_1
    :goto_0
    sget-object p1, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->d:Lorg/bouncycastle/util/BigIntegers$Cache;

    invoke-virtual {p1, p2}, Lorg/bouncycastle/util/BigIntegers$Cache;->b(Ljava/math/BigInteger;)Z
...
.method private validate(Ljava/math/BigInteger;Z)Ljava/math/BigInteger;
    ...
    :goto_0
    sget-object p2, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->d:Lorg/bouncycastle/util/BigIntegers$Cache;

    invoke-virtual {p2, p1}, Lorg/bouncycastle/util/BigIntegers$Cache;->a(Ljava/math/BigInteger;)V
    ...
    invoke-static {p2}, Lorg/bouncycastle/util/Properties;->c(Ljava/lang/String;)Z
    ...
    invoke-static {v0, p2}, Lorg/bouncycastle/util/Properties;->a(Ljava/lang/String;I)I
    ...
    sget-object p2, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->e:Ljava/math/BigInteger;

    invoke-virtual {p1, p2}, Ljava/math/BigInteger;->gcd(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object p2

    sget-object v0, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->f:Ljava/math/BigInteger;
    ...
    invoke-static {p1, v0, p2}, Lorg/bouncycastle/math/Primes;->b(Ljava/math/BigInteger;Ljava/security/SecureRandom;I)Lorg/bouncycastle/math/Primes$MROutput;

    move-result-object p2

    invoke-virtual {p2}, Lorg/bouncycastle/math/Primes$MROutput;->d()Z
