...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->f:Ljava/math/BigInteger;
...
.method public constructor <init>(ILorg/bouncycastle/crypto/DerivationFunction;Ljava/security/SecureRandom;)V
    ...
    iput p1, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->c:I

    iput-object p2, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->a:Lorg/bouncycastle/crypto/DerivationFunction;

    iput-object p3, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->b:Ljava/security/SecureRandom;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->d:Z

    iput-boolean p1, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->e:Z
...
.method public constructor <init>(ILorg/bouncycastle/crypto/DerivationFunction;Ljava/security/SecureRandom;ZZZ)V
    ...
    :cond_0
    iput-boolean p5, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->d:Z

    :goto_0
    iput-boolean p6, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->e:Z
...
.method static deriveKey(ZLorg/bouncycastle/crypto/DerivationFunction;I[B[B)[B
    ...
    invoke-static {p3, p4}, Lorg/bouncycastle/util/Arrays;->h([B[B)[B

    move-result-object p0

    invoke-static {p4, v0}, Ljava/util/Arrays;->fill([BB)V
...
.method public generateEncapsulated(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)Lorg/bouncycastle/crypto/SecretWithEncapsulation;
    ...
    sget-object v4, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->f:Ljava/math/BigInteger;

    iget-object v5, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->b:Ljava/security/SecureRandom;

    invoke-static {v4, v2, v5}, Lorg/bouncycastle/util/BigIntegers;->f(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;

    move-result-object v4

    iget-boolean v5, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->d:Z
    ...
    invoke-interface {v3, p1, v4}, Lorg/bouncycastle/math/ec/ECMultiplier;->a(Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-virtual {p1, v2}, Lorg/bouncycastle/math/ec/ECPoint;->t(Ljava/math/BigInteger;)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-virtual {v1, v6, v3, v5, p1}, Lorg/bouncycastle/math/ec/ECCurve;->v([Lorg/bouncycastle/math/ec/ECPoint;IILorg/bouncycastle/math/ec/ECFieldElement;)V

    aget-object p1, v6, v3

    aget-object v0, v6, v0

    invoke-virtual {p1, v3}, Lorg/bouncycastle/math/ec/ECPoint;->j(Z)[B
    ...
    new-instance v2, Lorg/bouncycastle/crypto/kems/a;

    iget-boolean v3, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->e:Z

    iget-object v4, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->a:Lorg/bouncycastle/crypto/DerivationFunction;

    iget v5, p0, Lorg/bouncycastle/crypto/kems/ECIESKEMGenerator;->c:I
    ...
    invoke-direct {v2, p1, v1}, Lorg/bouncycastle/crypto/kems/a;-><init>([B[B)V
