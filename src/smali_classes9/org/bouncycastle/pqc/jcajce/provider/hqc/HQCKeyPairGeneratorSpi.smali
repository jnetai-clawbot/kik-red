...
# instance fields
.field a:Lorg/bouncycastle/pqc/crypto/hqc/HQCKeyPairGenerator;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->d:Ljava/util/HashMap;
    ...
    sget-object v0, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->d:Ljava/util/HashMap;
    ...
    sget-object v4, Lorg/bouncycastle/pqc/jcajce/spec/HQCParameterSpec;->b:Lorg/bouncycastle/pqc/jcajce/spec/HQCParameterSpec;

    invoke-virtual {v4}, Lorg/bouncycastle/pqc/jcajce/spec/HQCParameterSpec;->a()Ljava/lang/String;
    ...
    sget-object v1, Lorg/bouncycastle/pqc/jcajce/spec/HQCParameterSpec;->c:Lorg/bouncycastle/pqc/jcajce/spec/HQCParameterSpec;

    invoke-virtual {v1}, Lorg/bouncycastle/pqc/jcajce/spec/HQCParameterSpec;->a()Ljava/lang/String;
    ...
    sget-object v1, Lorg/bouncycastle/pqc/jcajce/spec/HQCParameterSpec;->d:Lorg/bouncycastle/pqc/jcajce/spec/HQCParameterSpec;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->a:Lorg/bouncycastle/pqc/crypto/hqc/HQCKeyPairGenerator;

    invoke-static {}, Lorg/bouncycastle/crypto/CryptoServicesRegistrar;->getSecureRandom()Ljava/security/SecureRandom;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->b:Ljava/security/SecureRandom;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->c:Z
...
.method public final generateKeyPair()Ljava/security/KeyPair;
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->c:Z

    if-nez v0, :cond_0

    new-instance v0, Lorg/bouncycastle/pqc/crypto/hqc/HQCKeyGenerationParameters;

    iget-object v1, p0, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->b:Ljava/security/SecureRandom;

    sget-object v2, Lorg/bouncycastle/pqc/crypto/hqc/HQCParameters;->k:Lorg/bouncycastle/pqc/crypto/hqc/HQCParameters;
    ...
    iget-object v1, p0, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->a:Lorg/bouncycastle/pqc/crypto/hqc/HQCKeyPairGenerator;
    ...
    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->a:Lorg/bouncycastle/pqc/crypto/hqc/HQCKeyPairGenerator;
...
.method public final initialize(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    instance-of v0, p1, Lorg/bouncycastle/pqc/jcajce/spec/HQCParameterSpec;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/pqc/jcajce/spec/HQCParameterSpec;->a()Ljava/lang/String;
    ...
    sget-object v1, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->d:Ljava/util/HashMap;
    ...
    iget-object p2, p0, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->a:Lorg/bouncycastle/pqc/crypto/hqc/HQCKeyPairGenerator;
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/pqc/jcajce/provider/hqc/HQCKeyPairGeneratorSpi;->c:Z
