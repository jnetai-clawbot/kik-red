...
.field protected final b:Lcom/android/volley/toolbox/ByteArrayPool;
...
.method public constructor <init>(Lcom/android/volley/toolbox/HttpStack;)V
    ...
    iput-object p1, p0, Lxl/c;->a:Lcom/android/volley/toolbox/HttpStack;

    iput-object v0, p0, Lxl/c;->b:Lcom/android/volley/toolbox/ByteArrayPool;
...
.method private static c([Lorg/apache/http/Header;)Ljava/util/Map;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
...
.method private d(Lorg/apache/http/HttpEntity;)[B
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    iget-object v1, p0, Lxl/c;->b:Lcom/android/volley/toolbox/ByteArrayPool;
    ...
    invoke-direct {v0, v1, v3}, Lcom/android/volley/toolbox/PoolingByteArrayOutputStream;-><init>(Lcom/android/volley/toolbox/ByteArrayPool;I)V
    ...
    iget-object v3, p0, Lxl/c;->b:Lcom/android/volley/toolbox/ByteArrayPool;
    ...
    invoke-virtual {v0, v1, v4, v3}, Lcom/android/volley/toolbox/PoolingByteArrayOutputStream;->write([BII)V
    ...
    :catch_0
    sget-object p1, Lxl/c;->d:Lyp/b;

    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    :goto_1
    iget-object p1, p0, Lxl/c;->b:Lcom/android/volley/toolbox/ByteArrayPool;
...
.method private e(JLcom/android/volley/Request;[BLorg/apache/http/StatusLine;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
...
.method public final performRequest(Lcom/android/volley/Request;)Lcom/android/volley/NetworkResponse;
    ...
    invoke-direct {v7, v0, v2}, Lxl/c;->a(Ljava/util/Map;Lcom/android/volley/Cache$Entry;)V

    iget-object v2, v7, Lxl/c;->a:Lcom/android/volley/toolbox/HttpStack;
    ...
    invoke-static {v2}, Lxl/c;->c([Lorg/apache/http/Header;)Ljava/util/Map;
    ...
    invoke-direct {v0, v1, v2, v15, v3}, Lcom/android/volley/NetworkResponse;-><init>(I[BLjava/util/Map;Z)V
    ...
    invoke-interface {v2, v1}, Ldb/n0;->h(Ljava/lang/String;)V
    ...
    invoke-direct {v7, v1}, Lxl/c;->d(Lorg/apache/http/HttpEntity;)[B
    ...
    :try_start_6
    invoke-direct/range {v1 .. v6}, Lxl/c;->e(JLcom/android/volley/Request;[BLorg/apache/http/StatusLine;)V
    ...
    :try_start_7
    invoke-direct {v1, v0, v2, v15, v11}, Lcom/android/volley/NetworkResponse;-><init>(I[BLjava/util/Map;Z)V
    ...
    invoke-interface {v2, v6, v3, v5}, Lyp/b;->i(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-interface {v3}, Ldb/n0;->g()Ljava/lang/String;
    ...
    invoke-direct {v2, v0, v4, v1, v11}, Lcom/android/volley/NetworkResponse;-><init>(I[BLjava/util/Map;Z)V
    ...
    invoke-static {v1, v8, v0}, Lxl/c;->b(Ljava/lang/String;Lcom/android/volley/Request;Lcom/android/volley/VolleyError;)V
