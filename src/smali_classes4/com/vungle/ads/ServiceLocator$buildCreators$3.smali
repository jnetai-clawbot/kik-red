...
.method public create()Lcom/vungle/ads/internal/network/VungleApiClient;
    ...
    iget-object v4, p0, Lcom/vungle/ads/ServiceLocator$buildCreators$3;->this$0:Lcom/vungle/ads/ServiceLocator;

    const-class v5, Lcom/vungle/ads/internal/util/PathProvider;

    invoke-virtual {v4, v5}, Lcom/vungle/ads/ServiceLocator;->getOrBuild$vungle_ads_release(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/vungle/ads/internal/util/PathProvider;

    invoke-direct {v0, v1, v2, v3, v4}, Lcom/vungle/ads/internal/network/VungleApiClient;-><init>(Landroid/content/Context;Lcom/vungle/ads/internal/platform/Platform;Lcom/vungle/ads/internal/persistence/FilePreferences;Lcom/vungle/ads/internal/util/PathProvider;)V
