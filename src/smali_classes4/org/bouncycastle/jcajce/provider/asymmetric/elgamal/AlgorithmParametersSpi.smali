...
.method protected final engineGetEncoded()[B
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/elgamal/AlgorithmParametersSpi;->a:Lorg/bouncycastle/jce/spec/ElGamalParameterSpec;
...
.method protected final engineInit([B)V
    ...
    invoke-static {p1}, Lorg/bouncycastle/asn1/oiw/ElGamalParameter;->m(Ljava/lang/Object;)Lorg/bouncycastle/asn1/oiw/ElGamalParameter;

    move-result-object p1

    new-instance v1, Lorg/bouncycastle/jce/spec/ElGamalParameterSpec;

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/oiw/ElGamalParameter;->n()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/oiw/ElGamalParameter;->k()Ljava/math/BigInteger;
