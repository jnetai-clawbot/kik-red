...
.field private final d:Lorg/bouncycastle/jcajce/util/BCJcaJceHelper;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->d:Lorg/bouncycastle/jcajce/util/BCJcaJceHelper;
...
.method static synthetic a(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/security/Key;Ljava/io/DataOutputStream;)V
    .locals 0
    ...
    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->f(Ljava/security/Key;Ljava/io/DataOutputStream;)V

    return-void
.end method

.method static synthetic b(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/io/DataInputStream;)Ljava/security/Key;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->d(Ljava/io/DataInputStream;)Ljava/security/Key;
...
.method private c(Ljava/io/DataInputStream;)Ljava/security/cert/Certificate;
    ...
    :try_start_0
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->d:Lorg/bouncycastle/jcajce/util/BCJcaJceHelper;

    invoke-virtual {p1, v0}, Lorg/bouncycastle/jcajce/util/ProviderJcaJceHelper;->f(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method private d(Ljava/io/DataInputStream;)Ljava/security/Key;
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->d:Lorg/bouncycastle/jcajce/util/BCJcaJceHelper;

    invoke-virtual {v0, v2}, Lorg/bouncycastle/jcajce/util/ProviderJcaJceHelper;->g(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    :cond_6
    invoke-static {v3}, Lorg/bouncycastle/asn1/x509/SubjectPublicKeyInfo;->m(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/SubjectPublicKeyInfo;

    move-result-object p1

    invoke-static {p1}, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->y(Lorg/bouncycastle/asn1/x509/SubjectPublicKeyInfo;)Ljava/security/PublicKey;
    ...
    :cond_7
    invoke-static {v3}, Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;->m(Ljava/lang/Object;)Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;
...
.method public final engineGetCertificate(Ljava/lang/String;)Ljava/security/cert/Certificate;
    ...
    check-cast p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;

    if-eqz p1, :cond_1

    iget v0, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->a:I

    const/4 v1, 0x1

    if-ne v0, v1, :cond_0

    iget-object p1, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->c:Ljava/lang/Object;
    ...
    :cond_0
    iget-object p1, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->d:[Ljava/security/cert/Certificate;
...
.method public final engineGetCertificateAlias(Ljava/security/cert/Certificate;)Ljava/lang/String;
    ...
    check-cast v1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;

    iget-object v2, v1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->c:Ljava/lang/Object;
    ...
    iget-object p1, v1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->b:Ljava/lang/String;

    return-object p1

    :cond_1
    iget-object v2, v1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->d:[Ljava/security/cert/Certificate;
...
.method public final engineGetCreationDate(Ljava/lang/String;)Ljava/util/Date;
    ...
    iget-object p1, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->e:Ljava/util/Date;
...
.method public final engineGetKey(Ljava/lang/String;[C)Ljava/security/Key;
    ...
    :cond_1
    iget-object v2, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->c:Ljava/lang/Object;
    ...
    iget-object v3, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->f:Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;
    ...
    invoke-virtual/range {v3 .. v8}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->h(Ljava/lang/String;I[C[BI)Ljavax/crypto/Cipher;

    move-result-object v0

    new-instance v3, Lorg/bouncycastle/jcajce/io/CipherInputStream;

    invoke-direct {v3, v2, v0}, Lorg/bouncycastle/jcajce/io/CipherInputStream;-><init>(Ljava/io/InputStream;Ljavax/crypto/Cipher;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_2

    :try_start_1
    iget-object v0, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->f:Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;

    new-instance v2, Ljava/io/DataInputStream;

    invoke-direct {v2, v3}, Ljava/io/DataInputStream;-><init>(Ljava/io/InputStream;)V

    invoke-static {v0, v2}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->b(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/io/DataInputStream;)Ljava/security/Key;
    ...
    :try_start_3
    iget-object v2, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->f:Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;

    new-instance v3, Ljava/io/DataInputStream;

    invoke-direct {v3, v4}, Ljava/io/DataInputStream;-><init>(Ljava/io/InputStream;)V

    invoke-static {v2, v3}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->b(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/io/DataInputStream;)Ljava/security/Key;
    ...
    invoke-direct {v3, v9, p2}, Lorg/bouncycastle/jcajce/io/CipherOutputStream;-><init>(Ljava/io/OutputStream;Ljavax/crypto/Cipher;)V
    ...
    invoke-static {v3, v2, p2}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->a(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/security/Key;Ljava/io/DataOutputStream;)V
    ...
    iput-object p2, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->c:Ljava/lang/Object;
    :try_end_4
...
.method public final engineIsCertificateEntry(Ljava/lang/String;)Z
    ...
    iget p1, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->a:I
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->g(Ljava/io/InputStream;)V
    ...
    :cond_5
    invoke-virtual {p0, v0}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->g(Ljava/io/InputStream;)V
...
.method public final engineSetCertificateEntry(Ljava/lang/String;Ljava/security/cert/Certificate;)V
    ...
    check-cast v0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;

    if-eqz v0, :cond_1

    iget v0, v0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->a:I
    ...
    new-instance v1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;

    invoke-direct {v1, p0, p1, p2}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;-><init>(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/lang/String;Ljava/security/cert/Certificate;)V
...
.method public final engineSetKeyEntry(Ljava/lang/String;Ljava/security/Key;[C[Ljava/security/cert/Certificate;)V
    ...
    new-instance v7, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;
    ...
    invoke-direct/range {v0 .. v6}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;-><init>(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/lang/String;Ljava/util/Date;ILjava/lang/Object;[Ljava/security/cert/Certificate;)V
    ...
    invoke-direct/range {v1 .. v6}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;-><init>(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/lang/String;Ljava/security/Key;[C[Ljava/security/cert/Certificate;)V
    ...
    new-instance p2, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$a;

    invoke-virtual {p1}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object p3

    invoke-direct {p2, p3, p1}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$a;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public final engineSetKeyEntry(Ljava/lang/String;[B[Ljava/security/cert/Certificate;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;-><init>(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/lang/String;[B[Ljava/security/cert/Certificate;)V
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    invoke-virtual {p0, p2}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->i(Ljava/io/OutputStream;)V
...
.method protected final g(Ljava/io/InputStream;)V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->c(Ljava/io/DataInputStream;)Ljava/security/cert/Certificate;
    ...
    new-instance v10, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;
    ...
    invoke-direct/range {v1 .. v7}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;-><init>(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/lang/String;Ljava/util/Date;ILjava/lang/Object;[Ljava/security/cert/Certificate;)V
    ...
    :cond_3
    invoke-direct {p0, v0}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->d(Ljava/io/DataInputStream;)Ljava/security/Key;

    move-result-object v11

    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->a:Ljava/util/Hashtable;

    new-instance v2, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;
    ...
    invoke-direct/range {v6 .. v12}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;-><init>(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/lang/String;Ljava/util/Date;ILjava/lang/Object;[Ljava/security/cert/Certificate;)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->a:Ljava/util/Hashtable;

    new-instance v3, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;

    invoke-direct {v3, p0, p1, v9, v1}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;-><init>(Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;Ljava/lang/String;Ljava/util/Date;Ljava/lang/Object;)V
...
.method protected final h(Ljava/lang/String;I[C[BI)Ljavax/crypto/Cipher;
    ...
    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->d:Lorg/bouncycastle/jcajce/util/BCJcaJceHelper;

    invoke-virtual {p3, p1}, Lorg/bouncycastle/jcajce/util/ProviderJcaJceHelper;->g(Ljava/lang/String;)Ljavax/crypto/SecretKeyFactory;
    ...
    iget-object p4, p0, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->d:Lorg/bouncycastle/jcajce/util/BCJcaJceHelper;

    invoke-virtual {p4, p1}, Lorg/bouncycastle/jcajce/util/ProviderJcaJceHelper;->b(Ljava/lang/String;)Ljavax/crypto/Cipher;
...
.method protected final i(Ljava/io/OutputStream;)V
    ...
    iget v3, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->a:I

    invoke-virtual {v1, v3}, Ljava/io/DataOutputStream;->write(I)V

    iget-object v3, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->b:Ljava/lang/String;

    invoke-virtual {v1, v3}, Ljava/io/DataOutputStream;->writeUTF(Ljava/lang/String;)V

    iget-object v3, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->e:Ljava/util/Date;
    ...
    iget-object v3, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->d:[Ljava/security/cert/Certificate;
    ...
    invoke-direct {p0, v4, v1}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->e(Ljava/security/cert/Certificate;Ljava/io/DataOutputStream;)V
    ...
    :cond_1
    :goto_2
    iget v2, p1, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$b;->a:I
    ...
    invoke-direct {p0, p1, v1}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->f(Ljava/security/Key;Ljava/io/DataOutputStream;)V
    ...
    invoke-direct {p0, p1, v1}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->e(Ljava/security/cert/Certificate;Ljava/io/DataOutputStream;)V
