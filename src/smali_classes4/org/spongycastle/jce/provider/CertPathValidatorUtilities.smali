...
.method protected static a(Ljava/lang/String;Lorg/spongycastle/x509/ExtendedPKIXParameters;)V
    ...
    invoke-virtual {p1}, Lorg/spongycastle/x509/ExtendedPKIXParameters;->n()Z
    ...
    invoke-direct {v0, p0, v2}, Lorg/spongycastle/jce/X509LDAPCertStoreParameters$Builder;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v0}, Lorg/spongycastle/jce/X509LDAPCertStoreParameters$Builder;->K()Lorg/spongycastle/jce/X509LDAPCertStoreParameters;
    ...
    invoke-static {v0, p0}, Lorg/spongycastle/x509/X509Store;->a(Ljava/lang/String;Lorg/spongycastle/x509/X509StoreParameters;)Lorg/spongycastle/x509/X509Store;
...
.method protected static c(Lorg/spongycastle/asn1/x509/CRLDistPoint;Lorg/spongycastle/x509/ExtendedPKIXParameters;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-virtual {v2}, Lorg/spongycastle/asn1/x509/DistributionPoint;->h()Lorg/spongycastle/asn1/x509/DistributionPointName;

    move-result-object v2

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Lorg/spongycastle/asn1/x509/DistributionPointName;->i()I

    move-result v3

    if-nez v3, :cond_1

    invoke-virtual {v2}, Lorg/spongycastle/asn1/x509/DistributionPointName;->h()Lorg/spongycastle/asn1/ASN1Encodable;
    ...
    invoke-virtual {v4}, Lorg/spongycastle/asn1/x509/GeneralName;->h()I
    ...
    invoke-static {v4}, Lorg/spongycastle/asn1/DERIA5String;->m(Ljava/lang/Object;)Lorg/spongycastle/asn1/DERIA5String;
...
.method protected static d(Lorg/spongycastle/x509/X509CertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/AnnotatedException;
    ...
    :try_start_0
    invoke-virtual {v1, p0}, Lorg/spongycastle/x509/X509Store;->b(Lorg/spongycastle/util/Selector;)Ljava/util/Collection;
...
.method protected static e(Ljava/security/cert/X509Certificate;Lorg/spongycastle/x509/ExtendedPKIXBuilderParameters;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {v0, v2}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->d(Lorg/spongycastle/x509/X509CertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {p1}, Lorg/spongycastle/x509/ExtendedPKIXParameters;->b()Ljava/util/List;

    move-result-object p1

    invoke-static {v0, p1}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->d(Lorg/spongycastle/x509/X509CertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
...
.method protected static f(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {p0}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->l(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;
    ...
    :cond_3
    invoke-virtual {p0, v5, p2}, Ljava/security/cert/Certificate;->verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    :try_end_2
...
.method protected static g(Ljava/security/PublicKey;)Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {p0}, Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;->h(Ljava/lang/Object;)Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;

    move-result-object p0

    invoke-virtual {p0}, Lorg/spongycastle/asn1/x509/SubjectPublicKeyInfo;->e()Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;
...
.method protected static h(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/AnnotatedException;
    ...
    invoke-virtual {v1}, Lorg/spongycastle/asn1/x509/GeneralName;->h()I
...
.method protected static i(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/spongycastle/jce/provider/b;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/AnnotatedException;
    ...
    :try_start_0
    invoke-static {p1}, Lorg/spongycastle/jce/provider/X509CRLObject;->e(Ljava/security/cert/X509CRL;)Z
    ...
    :cond_2
    invoke-static {p2}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->l(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;
    ...
    :cond_5
    check-cast p2, Lorg/spongycastle/x509/X509AttributeCertificate;

    invoke-interface {p2}, Lorg/spongycastle/x509/X509AttributeCertificate;->getSerialNumber()Ljava/math/BigInteger;
    ...
    :try_start_1
    sget-object p1, Lorg/spongycastle/asn1/x509/X509Extension;->e:Lorg/spongycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {p1}, Lorg/spongycastle/asn1/DERObjectIdentifier;->o()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p1}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/spongycastle/asn1/ASN1Primitive;

    move-result-object p1

    invoke-static {p1}, Lorg/spongycastle/asn1/DEREnumerated;->n(Ljava/lang/Object;)Lorg/spongycastle/asn1/ASN1Enumerated;
...
.method protected static j(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/util/Date;Lorg/spongycastle/x509/ExtendedPKIXParameters;)Ljava/util/Set;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/AnnotatedException;
    ...
    :goto_0
    invoke-static {p0, v1, v0}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->h(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    :try_end_0
    ...
    invoke-virtual {v0, p0}, Lorg/spongycastle/x509/X509CRLStoreSelector;->c(Lorg/spongycastle/x509/X509AttributeCertificate;)V

    :cond_2
    :goto_1
    invoke-virtual {v0}, Lorg/spongycastle/x509/X509CRLStoreSelector;->d()V

    sget-object p0, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a:Lorg/spongycastle/jce/provider/PKIXCRLUtil;

    invoke-virtual {p0, v0, p3, p2}, Lorg/spongycastle/jce/provider/PKIXCRLUtil;->b(Lorg/spongycastle/x509/X509CRLStoreSelector;Lorg/spongycastle/x509/ExtendedPKIXParameters;Ljava/util/Date;)Ljava/util/Set;
    ...
    invoke-direct {p0, p1, p2}, Lorg/spongycastle/jce/provider/AnnotatedException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method protected static k(Ljava/util/Date;Lorg/spongycastle/x509/ExtendedPKIXParameters;Ljava/security/cert/X509CRL;)Ljava/util/Set;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/AnnotatedException;
    ...
    :try_start_1
    sget-object v1, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->c:Ljava/lang/String;

    invoke-static {p2, v1}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    invoke-virtual {v1}, Lorg/spongycastle/asn1/DERInteger;->o()Ljava/math/BigInteger;
    ...
    :goto_0
    :try_start_2
    sget-object v3, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->b:Ljava/lang/String;
    ...
    invoke-virtual {v0, p2}, Lorg/spongycastle/x509/X509CRLStoreSelector;->e([B)V

    invoke-virtual {v0}, Lorg/spongycastle/x509/X509CRLStoreSelector;->g()V

    invoke-virtual {v0, v1}, Lorg/spongycastle/x509/X509CRLStoreSelector;->h(Ljava/math/BigInteger;)V

    sget-object p2, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a:Lorg/spongycastle/jce/provider/PKIXCRLUtil;

    invoke-virtual {p2, v0, p1, p0}, Lorg/spongycastle/jce/provider/PKIXCRLUtil;->b(Lorg/spongycastle/x509/X509CRLStoreSelector;Lorg/spongycastle/x509/ExtendedPKIXParameters;Ljava/util/Date;)Ljava/util/Set;
...
.method protected static l(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;
    .locals 1
...
.method protected static m(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/spongycastle/asn1/ASN1Primitive;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/AnnotatedException;
    ...
    invoke-direct {v0, p1, p0}, Lorg/spongycastle/jce/provider/AnnotatedException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    throw v0
.end method

.method protected static n(Ljava/util/List;I)Ljava/security/PublicKey;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method protected static final o(Lorg/spongycastle/asn1/ASN1Sequence;)Ljava/util/Set;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-virtual {v2, v3}, Lorg/spongycastle/asn1/ASN1OutputStream;->i(Lorg/spongycastle/asn1/ASN1Encodable;)V
...
.method protected static p(Lorg/spongycastle/x509/ExtendedPKIXParameters;Ljava/security/cert/CertPath;I)Ljava/util/Date;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/spongycastle/jce/provider/AnnotatedException;
    ...
    invoke-virtual {p0}, Lorg/spongycastle/x509/ExtendedPKIXParameters;->m()I
    ...
    invoke-static {p0}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->q(Ljava/security/cert/PKIXParameters;)Ljava/util/Date;
    ...
    sget-object v2, Lorg/spongycastle/asn1/isismtt/ISISMTTObjectIdentifiers;->a:Lorg/spongycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-static {v1}, Lorg/spongycastle/asn1/DERGeneralizedTime;->o(Ljava/lang/Object;)Lorg/spongycastle/asn1/ASN1GeneralizedTime;
    ...
    :try_start_1
    invoke-virtual {p0}, Lorg/spongycastle/asn1/DERGeneralizedTime;->n()Ljava/util/Date;
...
.method protected static q(Ljava/security/cert/PKIXParameters;)Ljava/util/Date;
    .locals 0
...
.method protected static s(Lorg/spongycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/spongycastle/jce/provider/PKIXPolicyNode;)Lorg/spongycastle/jce/provider/PKIXPolicyNode;
    .locals 2
    ...
    :cond_2
    iget-object v0, v0, Lorg/spongycastle/jce/provider/PKIXPolicyNode;->a:Ljava/util/List;

    invoke-interface {v0, p2}, Ljava/util/List;->remove(Ljava/lang/Object;)Z

    invoke-static {p1, p2}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->t([Ljava/util/List;Lorg/spongycastle/jce/provider/PKIXPolicyNode;)V

    return-object p0
.end method

.method private static t([Ljava/util/List;Lorg/spongycastle/jce/provider/PKIXPolicyNode;)V
    .locals 1
    ...
    invoke-virtual {p1}, Lorg/spongycastle/jce/provider/PKIXPolicyNode;->c()Z
    ...
    invoke-static {p0, v0}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->t([Ljava/util/List;Lorg/spongycastle/jce/provider/PKIXPolicyNode;)V
