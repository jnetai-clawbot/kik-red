...
.method protected final engineInit([B)V
    ...
    invoke-direct {v1, p1}, Lorg/spongycastle/asn1/x509/DSAParameter;-><init>(Lorg/spongycastle/asn1/ASN1Sequence;)V

    new-instance p1, Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v1}, Lorg/spongycastle/asn1/x509/DSAParameter;->h()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {v1}, Lorg/spongycastle/asn1/x509/DSAParameter;->i()Ljava/math/BigInteger;
