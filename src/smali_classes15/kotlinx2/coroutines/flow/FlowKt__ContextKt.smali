.class final synthetic Lkotlinx2/coroutines/flow/FlowKt__ContextKt;
...
.method public static final synthetic buffer(Lkotlinx2/coroutines/flow/Flow;I)Lkotlinx2/coroutines/flow/Flow;
    ...
    invoke-static {p0, p1, v0, v1, v0}, Lkotlinx2/coroutines/flow/FlowKt;->buffer$default(Lkotlinx2/coroutines/flow/Flow;ILkotlinx2/coroutines/channels/BufferOverflow;ILjava/lang/Object;)Lkotlinx2/coroutines/flow/Flow;
...
.method public static final buffer(Lkotlinx2/coroutines/flow/Flow;ILkotlinx2/coroutines/channels/BufferOverflow;)Lkotlinx2/coroutines/flow/Flow;
    ...
    :cond_4
    instance-of v2, p0, Lkotlinx2/coroutines/flow/internal/FusibleFlow;

    if-eqz v2, :cond_5

    move-object v2, p0

    check-cast v2, Lkotlinx2/coroutines/flow/internal/FusibleFlow;
    ...
    invoke-static/range {v2 .. v7}, Lkotlinx2/coroutines/flow/internal/FusibleFlow$DefaultImpls;->fuse$default(Lkotlinx2/coroutines/flow/internal/FusibleFlow;Lkotlin2/coroutines/CoroutineContext;ILkotlinx2/coroutines/channels/BufferOverflow;ILjava/lang/Object;)Lkotlinx2/coroutines/flow/Flow;
    ...
    :cond_5
    new-instance v9, Lkotlinx2/coroutines/flow/internal/ChannelFlowOperatorImpl;
    ...
    invoke-direct/range {v2 .. v8}, Lkotlinx2/coroutines/flow/internal/ChannelFlowOperatorImpl;-><init>(Lkotlinx2/coroutines/flow/Flow;Lkotlin2/coroutines/CoroutineContext;ILkotlinx2/coroutines/channels/BufferOverflow;ILkotlin2/jvm/internal/DefaultConstructorMarker;)V
...
.method public static synthetic buffer$default(Lkotlinx2/coroutines/flow/Flow;IILjava/lang/Object;)Lkotlinx2/coroutines/flow/Flow;
    ...
    :cond_0
    invoke-static {p0, p1}, Lkotlinx2/coroutines/flow/FlowKt;->buffer(Lkotlinx2/coroutines/flow/Flow;I)Lkotlinx2/coroutines/flow/Flow;
...
.method public static synthetic buffer$default(Lkotlinx2/coroutines/flow/Flow;ILkotlinx2/coroutines/channels/BufferOverflow;ILjava/lang/Object;)Lkotlinx2/coroutines/flow/Flow;
    ...
    :cond_1
    invoke-static {p0, p1, p2}, Lkotlinx2/coroutines/flow/FlowKt;->buffer(Lkotlinx2/coroutines/flow/Flow;ILkotlinx2/coroutines/channels/BufferOverflow;)Lkotlinx2/coroutines/flow/Flow;
...
.method public static final cancellable(Lkotlinx2/coroutines/flow/Flow;)Lkotlinx2/coroutines/flow/Flow;
    ...
    instance-of v0, p0, Lkotlinx2/coroutines/flow/CancellableFlow;
    ...
    :cond_0
    new-instance v0, Lkotlinx2/coroutines/flow/CancellableFlowImpl;

    invoke-direct {v0, p0}, Lkotlinx2/coroutines/flow/CancellableFlowImpl;-><init>(Lkotlinx2/coroutines/flow/Flow;)V
...
.method private static final checkFlowContext$FlowKt__ContextKt(Lkotlin2/coroutines/CoroutineContext;)V
    .locals 3
...
.method public static final conflate(Lkotlinx2/coroutines/flow/Flow;)Lkotlinx2/coroutines/flow/Flow;
    ...
    invoke-static {p0, v2, v0, v1, v0}, Lkotlinx2/coroutines/flow/FlowKt;->buffer$default(Lkotlinx2/coroutines/flow/Flow;ILkotlinx2/coroutines/channels/BufferOverflow;ILjava/lang/Object;)Lkotlinx2/coroutines/flow/Flow;
...
.method public static final flowOn(Lkotlinx2/coroutines/flow/Flow;Lkotlin2/coroutines/CoroutineContext;)Lkotlinx2/coroutines/flow/Flow;
    ...
    invoke-static {p1}, Lkotlinx2/coroutines/flow/FlowKt__ContextKt;->checkFlowContext$FlowKt__ContextKt(Lkotlin2/coroutines/CoroutineContext;)V
    ...
    :cond_0
    instance-of v0, p0, Lkotlinx2/coroutines/flow/internal/FusibleFlow;

    if-eqz v0, :cond_1

    move-object v1, p0

    check-cast v1, Lkotlinx2/coroutines/flow/internal/FusibleFlow;
    ...
    invoke-static/range {v1 .. v6}, Lkotlinx2/coroutines/flow/internal/FusibleFlow$DefaultImpls;->fuse$default(Lkotlinx2/coroutines/flow/internal/FusibleFlow;Lkotlin2/coroutines/CoroutineContext;ILkotlinx2/coroutines/channels/BufferOverflow;ILjava/lang/Object;)Lkotlinx2/coroutines/flow/Flow;
