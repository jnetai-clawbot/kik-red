...
.method public static encodePublicKey(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)[B
    ...
    new-instance v0, Lorg/bouncycastle/crypto/util/c;

    invoke-direct {v0}, Lorg/bouncycastle/crypto/util/c;-><init>()V

    const-string/jumbo v1, "ssh-rsa"

    invoke-virtual {v0, v1}, Lorg/bouncycastle/crypto/util/c;->writeString(Ljava/lang/String;)V

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->getExponent()Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {v0, v1}, Lorg/bouncycastle/crypto/util/c;->writeBigNum(Ljava/math/BigInteger;)V

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/params/RSAKeyParameters;->getModulus()Ljava/math/BigInteger;

    move-result-object p0

    invoke-virtual {v0, p0}, Lorg/bouncycastle/crypto/util/c;->writeBigNum(Ljava/math/BigInteger;)V

    invoke-virtual {v0}, Lorg/bouncycastle/crypto/util/c;->getBytes()[B
    ...
    invoke-virtual {v0, v2}, Lorg/bouncycastle/crypto/util/c;->writeString(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p0}, Lorg/bouncycastle/crypto/util/c;->writeBlock([B)V
    ...
    invoke-virtual {v1, v2}, Lorg/bouncycastle/crypto/util/c;->writeBigNum(Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v1, v0}, Lorg/bouncycastle/crypto/util/c;->writeBigNum(Ljava/math/BigInteger;)V

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/params/DSAPublicKeyParameters;->getY()Ljava/math/BigInteger;

    move-result-object p0

    invoke-virtual {v1, p0}, Lorg/bouncycastle/crypto/util/c;->writeBigNum(Ljava/math/BigInteger;)V
...
.method public static parsePublicKey(Lorg/bouncycastle/crypto/util/b;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    .locals 6

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/util/b;->readString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/util/b;->readBigNumPositive()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/util/b;->readBlock()[B

    move-result-object v1

    new-instance v4, Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;

    invoke-virtual {v0, v1}, Lorg/bouncycastle/math/ec/ECCurve;->h([B)Lorg/bouncycastle/math/ec/ECPoint;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/util/b;->hasRemaining()Z
...
.method public static parsePublicKey([B)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-direct {v0, p0}, Lorg/bouncycastle/crypto/util/b;-><init>([B)V

    invoke-static {v0}, Lorg/bouncycastle/crypto/util/OpenSSHPublicKeyUtil;->parsePublicKey(Lorg/bouncycastle/crypto/util/b;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
