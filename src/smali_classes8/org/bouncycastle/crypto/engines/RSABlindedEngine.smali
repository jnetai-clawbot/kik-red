...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->a:Lorg/bouncycastle/crypto/engines/b;
...
.method public getInputBlockSize()I
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->a:Lorg/bouncycastle/crypto/engines/b;
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    :cond_1
    iput-object v0, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->c:Ljava/security/SecureRandom;
...
.method public processBlock([BII)[B
    ...
    invoke-static {v0, v1, v2}, Lorg/bouncycastle/util/BigIntegers;->f(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->a:Lorg/bouncycastle/crypto/engines/b;

    invoke-virtual {v2, v1}, Lorg/bouncycastle/crypto/engines/b;->processBlock(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v1

    invoke-static {p2, v0}, Lorg/bouncycastle/util/BigIntegers;->k(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    :cond_1
    iget-object p2, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->a:Lorg/bouncycastle/crypto/engines/b;

    invoke-virtual {p2, p1}, Lorg/bouncycastle/crypto/engines/b;->processBlock(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v0

    :goto_0
    iget-object p1, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->a:Lorg/bouncycastle/crypto/engines/b;

    invoke-virtual {p1, v0}, Lorg/bouncycastle/crypto/engines/b;->convertOutput(Ljava/math/BigInteger;)[B
