...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jce/provider/d;->a:Ljava/util/Map;

    return-void
.end method

.method static declared-synchronized a(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Lorg/bouncycastle/jcajce/PKIXCRLStore;
    .locals 5
    ...
    const-class v0, Lorg/bouncycastle/jce/provider/d;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lorg/bouncycastle/jce/provider/d;->a:Ljava/util/Map;
    ...
    invoke-static {p0, p2}, Lorg/bouncycastle/jce/provider/d;->b(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;
    ...
    :goto_1
    new-instance p1, Lorg/bouncycastle/jce/provider/d$a;
    ...
    invoke-direct {p1, v1}, Lorg/bouncycastle/jce/provider/d$a;-><init>(Lorg/bouncycastle/util/Store;)V

    sget-object p0, Lorg/bouncycastle/jce/provider/d;->a:Ljava/util/Map;
