...
.field private c:Lorg/bouncycastle/jce/provider/AnnotatedException;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi_8;->b:Z
...
.method constructor <init>(Z)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi_8;->a:Lorg/bouncycastle/jcajce/util/BCJcaJceHelper;
...
# virtual methods
.method protected final a(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    .locals 5
    ...
    :cond_1
    invoke-virtual {p2}, Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;->d()I
    ...
    iget-boolean v3, p0, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi_8;->b:Z
    ...
    invoke-virtual {v4}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters;->t()Ljava/lang/String;

    move-result-object v4

    invoke-static {p1, v3, v4}, Lorg/bouncycastle/jce/provider/b;->q(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Z
    ...
    :try_start_5
    sget-object v2, Lorg/bouncycastle/asn1/x509/Extension;->g:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-static {v2, v3}, Lorg/bouncycastle/jce/provider/b;->e([BLjava/util/Map;)Ljava/util/List;
    ...
    invoke-static {p1, v3, v0}, Lorg/bouncycastle/jce/provider/b;->b(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v2, p2, p3}, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi_8;->a(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-direct {p2, v0, v1}, Lorg/bouncycastle/jce/provider/AnnotatedException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->a()Ljava/util/List;
    ...
    invoke-virtual {v0, v2}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->n(Lorg/bouncycastle/jcajce/PKIXCertStore;)Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/jcajce/PKIXExtendedParameters$Builder;->o()Lorg/bouncycastle/jcajce/PKIXExtendedParameters;
    ...
    invoke-static {p1}, Lorg/bouncycastle/jce/provider/b;->c(Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v2, p1, v0}, Lorg/bouncycastle/jce/provider/PKIXCertPathBuilderSpi_8;->a(Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jcajce/PKIXExtendedBuilderParameters;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
