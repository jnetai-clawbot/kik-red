...
.method public static getNumberAsDouble(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Double;
    ...
    const-string/jumbo p1, "value \'%s\' for key \'%s\' is not a double"
    ...
    const-string/jumbo p0, "value \'%s\' for key \'%s\' in \'%s\' is not a number"
...
.method private static normalizedDuration(JI)J
    ...
    :cond_5
    invoke-static {v13, v14, v0}, Lio/grpc/internal/JsonUtil;->durationIsValid(JI)Z
    ...
    invoke-static {v1, v2, v3, v4}, Lio/grpc/internal/JsonUtil;->saturatedAdd(JJ)J
...
.method private static parseDuration(Ljava/lang/String;)J
    ...
    :goto_0
    invoke-static {p0, v3, v2}, Lai/medialab/medialabauth/l;->g(Ljava/lang/String;II)Ljava/lang/String;
