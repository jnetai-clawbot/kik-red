.class final Lio/wondrous/sns/di/n0;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lio/wondrous/sns/levels/progress/streamer/a;
...
.field private d:Lio/wondrous/sns/levels/progress/streamer/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljavax/inject/Provider<",
            "Lio/wondrous/sns/levels/progress/streamer/LevelStreamerProgressSource;",
            ">;"
        }
    .end annotation
.end field
...
.method constructor <init>(Lio/wondrous/sns/di/y1;Lio/wondrous/sns/di/v1;)V
    ...
    iput-object p1, p0, Lio/wondrous/sns/di/n0;->a:Lio/wondrous/sns/di/y1;

    iput-object p2, p0, Lio/wondrous/sns/di/n0;->b:Lio/wondrous/sns/di/v1;
    ...
    iput-object v0, p0, Lio/wondrous/sns/di/n0;->c:Lio/wondrous/sns/levels/progress/common/a;

    invoke-static {p1}, Lio/wondrous/sns/di/y1;->r1(Lio/wondrous/sns/di/y1;)Ljavax/inject/Provider;

    move-result-object p1

    new-instance p2, Lio/wondrous/sns/levels/progress/streamer/g;

    invoke-direct {p2, p1}, Lio/wondrous/sns/levels/progress/streamer/g;-><init>(Ljavax/inject/Provider;)V

    iput-object p2, p0, Lio/wondrous/sns/di/n0;->d:Lio/wondrous/sns/levels/progress/streamer/g;

    iget-object p1, p0, Lio/wondrous/sns/di/n0;->c:Lio/wondrous/sns/levels/progress/common/a;
    ...
    iput-object v0, p0, Lio/wondrous/sns/di/n0;->e:Lio/wondrous/sns/levels/progress/common/p;
...
# virtual methods
.method public final a(Lio/wondrous/sns/levels/progress/streamer/LevelStreamerProgressFragment;)V
    .locals 4

    new-instance v0, Lio/wondrous/sns/theme/SnsFeatureTheme;

    sget v1, Luh/c;->snsLevelProgressStreamerTheme:I

    sget v2, Luh/o;->Sns_LevelProgress_Streamer:I
    ...
    iget-object v0, p0, Lio/wondrous/sns/di/n0;->a:Lio/wondrous/sns/di/y1;
    ...
    iget-object v0, p0, Lio/wondrous/sns/di/n0;->b:Lio/wondrous/sns/di/v1;

    invoke-static {v0}, Lio/wondrous/sns/di/v1;->j0(Lio/wondrous/sns/di/v1;)Landroidx/fragment/app/Fragment;

    move-result-object v0

    iget-object v1, p0, Lio/wondrous/sns/di/n0;->e:Lio/wondrous/sns/levels/progress/common/p;
    ...
    new-instance v0, Lio/wondrous/sns/levels/info/LevelStreamerInfoNavigator;

    iget-object v2, p0, Lio/wondrous/sns/di/n0;->b:Lio/wondrous/sns/di/v1;

    invoke-static {v2}, Lio/wondrous/sns/di/v1;->j0(Lio/wondrous/sns/di/v1;)Landroidx/fragment/app/Fragment;

    move-result-object v2

    iget-object v3, p0, Lio/wondrous/sns/di/n0;->a:Lio/wondrous/sns/di/y1;
    ...
    invoke-direct {v0, v2}, Lio/wondrous/sns/levels/info/LevelStreamerInfoNavigator;-><init>(Lgk/d;)V
    ...
    sget v2, Luh/n;->sns_levels_sp_format:I
