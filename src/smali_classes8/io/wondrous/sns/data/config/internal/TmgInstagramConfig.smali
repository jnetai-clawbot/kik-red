.class public final Lio/wondrous/sns/data/config/internal/TmgInstagramConfig;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lio/wondrous/sns/data/config/InstagramConfig;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lio/wondrous/sns/data/config/internal/TmgInstagramConfig;",
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lio/wondrous/sns/data/config/internal/TmgInstagramConfig$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lio/wondrous/sns/data/config/internal/TmgInstagramConfig$Companion;-><init>(Lkotlin/jvm/internal/c;)V
    ...
    const-string v2, "instagram.connect.enabled"
    ...
    const-string v3, "instagram.connect.numPhotos"
    ...
    const-string v3, "instagram.connect.interstitial.enabled"
    ...
    const-string v3, "instagram.connect.interstitial.intervalSec"

    invoke-virtual {v2, v3, v4}, Lio/wondrous/sns/data/experiment/IntegerExperiment$Companion;->a(Ljava/lang/String;I)Lio/wondrous/sns/data/experiment/IntegerExperiment;

    const-string v2, "instagram.connect.profileModule.connectPrompt.enabled"
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v1, v0}, Lio/wondrous/sns/data/config/internal/TmgInstagramConfig;-><init>(Lio/wondrous/sns/data/config/ConfigContainer;ILkotlin/jvm/internal/c;)V
...
.method public constructor <init>(Lio/wondrous/sns/data/config/ConfigContainer;)V
    ...
    iput-object p1, p0, Lio/wondrous/sns/data/config/internal/TmgInstagramConfig;->a:Lio/wondrous/sns/data/config/ConfigContainer;
...
.method public synthetic constructor <init>(Lio/wondrous/sns/data/config/ConfigContainer;ILkotlin/jvm/internal/c;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Lio/wondrous/sns/data/config/internal/TmgInstagramConfig;-><init>(Lio/wondrous/sns/data/config/ConfigContainer;)V
