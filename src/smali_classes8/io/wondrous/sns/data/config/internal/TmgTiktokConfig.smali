.class public final Lio/wondrous/sns/data/config/internal/TmgTiktokConfig;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lio/wondrous/sns/data/config/TiktokConfig;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lio/wondrous/sns/data/config/internal/TmgTiktokConfig;",
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lio/wondrous/sns/data/config/internal/TmgTiktokConfig$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lio/wondrous/sns/data/config/internal/TmgTiktokConfig$Companion;-><init>(Lkotlin/jvm/internal/c;)V
    ...
    const-string/jumbo v3, "tiktok.connect.enabled"
    ...
    const-string/jumbo v4, "tiktok.connect.clientKey"
    ...
    const-string/jumbo v3, "tiktok.connect.numVideos"

    const/16 v4, 0xa

    invoke-virtual {v1, v3, v4}, Lio/wondrous/sns/data/experiment/IntegerExperiment$Companion;->a(Ljava/lang/String;I)Lio/wondrous/sns/data/experiment/IntegerExperiment;

    const-string/jumbo v3, "tiktok.connect.interstitial.enabled"
    ...
    const-string/jumbo v3, "tiktok.connect.interstitial.intervalSec"

    invoke-virtual {v1, v3, v4}, Lio/wondrous/sns/data/experiment/IntegerExperiment$Companion;->a(Ljava/lang/String;I)Lio/wondrous/sns/data/experiment/IntegerExperiment;

    const-string/jumbo v1, "tiktok.connect.profileModule.connectPrompt.enabled"
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v1, v0}, Lio/wondrous/sns/data/config/internal/TmgTiktokConfig;-><init>(Lio/wondrous/sns/data/config/ConfigContainer;ILkotlin/jvm/internal/c;)V
...
.method public constructor <init>(Lio/wondrous/sns/data/config/ConfigContainer;)V
    ...
    iput-object p1, p0, Lio/wondrous/sns/data/config/internal/TmgTiktokConfig;->a:Lio/wondrous/sns/data/config/ConfigContainer;
...
.method public synthetic constructor <init>(Lio/wondrous/sns/data/config/ConfigContainer;ILkotlin/jvm/internal/c;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Lio/wondrous/sns/data/config/internal/TmgTiktokConfig;-><init>(Lio/wondrous/sns/data/config/ConfigContainer;)V
