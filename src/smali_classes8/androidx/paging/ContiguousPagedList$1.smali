...
.method public onPageResult(ILandroidx/paging/PageResult;)V
    ...
    iget v3, v2, Landroidx/paging/PagedList;->mLastLoad:I

    iget-object v2, v2, Landroidx/paging/PagedList;->mStorage:Landroidx/paging/PagedStorage;
    ...
    iget-boolean v4, v3, Landroidx/paging/ContiguousPagedList;->mShouldTrim:Z

    if-eqz v4, :cond_4

    iget-object v4, v3, Landroidx/paging/PagedList;->mStorage:Landroidx/paging/PagedStorage;

    iget-object v5, v3, Landroidx/paging/PagedList;->mConfig:Landroidx/paging/PagedList$Config;

    iget v5, v5, Landroidx/paging/PagedList$Config;->maxSize:I

    iget v3, v3, Landroidx/paging/PagedList;->mRequiredRemainder:I

    invoke-interface {v0}, Ljava/util/List;->size()I

    move-result v6

    invoke-virtual {v4, v5, v3, v6}, Landroidx/paging/PagedStorage;->shouldPreTrimNewPage(III)Z
    ...
    iput v1, v0, Landroidx/paging/ContiguousPagedList;->mAppendItemsRequested:I

    iput v1, v0, Landroidx/paging/ContiguousPagedList;->mAppendWorkerState:I
    ...
    invoke-virtual {v4, v0, v3}, Landroidx/paging/PagedStorage;->appendPage(Ljava/util/List;Landroidx/paging/PagedStorage$Callback;)V
    ...
    iput v1, v0, Landroidx/paging/ContiguousPagedList;->mPrependItemsRequested:I

    iput v1, v0, Landroidx/paging/ContiguousPagedList;->mPrependWorkerState:I
    ...
    invoke-virtual {v4, v0, v3}, Landroidx/paging/PagedStorage;->prependPage(Ljava/util/List;Landroidx/paging/PagedStorage$Callback;)V

    :goto_2
    iget-object v0, p0, Landroidx/paging/ContiguousPagedList$1;->this$0:Landroidx/paging/ContiguousPagedList;

    iget-boolean v3, v0, Landroidx/paging/ContiguousPagedList;->mShouldTrim:Z

    if-eqz v3, :cond_9

    if-eqz v2, :cond_8

    iget v2, v0, Landroidx/paging/ContiguousPagedList;->mPrependWorkerState:I

    if-eq v2, v8, :cond_9

    iget-object v2, v0, Landroidx/paging/PagedList;->mStorage:Landroidx/paging/PagedStorage;

    iget-boolean v3, v0, Landroidx/paging/ContiguousPagedList;->mReplacePagesWithNulls:Z
    ...
    iget v5, v0, Landroidx/paging/PagedList;->mRequiredRemainder:I

    invoke-virtual {v2, v3, v4, v5, v0}, Landroidx/paging/PagedStorage;->trimFromFront(ZIILandroidx/paging/PagedStorage$Callback;)Z
    ...
    :cond_8
    iget v2, v0, Landroidx/paging/ContiguousPagedList;->mAppendWorkerState:I
    ...
    invoke-virtual {v2, v3, v4, v5, v0}, Landroidx/paging/PagedStorage;->trimFromEnd(ZIILandroidx/paging/PagedStorage$Callback;)Z
