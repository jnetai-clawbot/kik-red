...
.method public constructor <init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-virtual {p0, p2}, Lorg/spongycastle/math/ec/ECCurve$Fp;->c(Ljava/math/BigInteger;)Lorg/spongycastle/math/ec/ECFieldElement;

    move-result-object p1

    iput-object p1, p0, Lorg/spongycastle/math/ec/ECCurve;->a:Lorg/spongycastle/math/ec/ECFieldElement;

    invoke-virtual {p0, p3}, Lorg/spongycastle/math/ec/ECCurve$Fp;->c(Ljava/math/BigInteger;)Lorg/spongycastle/math/ec/ECFieldElement;
    ...
    invoke-direct {p1, p0, p3, p3, p2}, Lorg/spongycastle/math/ec/ECPoint$Fp;-><init>(Lorg/spongycastle/math/ec/ECCurve;Lorg/spongycastle/math/ec/ECFieldElement;Lorg/spongycastle/math/ec/ECFieldElement;Z)V
...
.method public final a(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lorg/spongycastle/math/ec/ECPoint;
    ...
    invoke-virtual {p0, p1}, Lorg/spongycastle/math/ec/ECCurve$Fp;->c(Ljava/math/BigInteger;)Lorg/spongycastle/math/ec/ECFieldElement;
    ...
    invoke-direct {v0, p0, p1, p2, v1}, Lorg/spongycastle/math/ec/ECPoint$Fp;-><init>(Lorg/spongycastle/math/ec/ECCurve;Lorg/spongycastle/math/ec/ECFieldElement;Lorg/spongycastle/math/ec/ECFieldElement;Z)V
...
.method public final b([B)Lorg/spongycastle/math/ec/ECPoint;
    ...
    invoke-direct {v1, v5, v6}, Lorg/spongycastle/math/ec/ECFieldElement$Fp;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-direct {p1, p0, v1, v4, v0}, Lorg/spongycastle/math/ec/ECPoint$Fp;-><init>(Lorg/spongycastle/math/ec/ECCurve;Lorg/spongycastle/math/ec/ECFieldElement;Lorg/spongycastle/math/ec/ECFieldElement;Z)V
    ...
    iget-object v3, p0, Lorg/spongycastle/math/ec/ECCurve$Fp;->c:Ljava/math/BigInteger;

    new-instance v5, Ljava/math/BigInteger;

    invoke-direct {v5, v2, v4}, Ljava/math/BigInteger;-><init>(I[B)V

    invoke-direct {p1, v3, v5}, Lorg/spongycastle/math/ec/ECFieldElement$Fp;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-virtual {p1}, Lorg/spongycastle/math/ec/ECFieldElement$Fp;->h()Lorg/spongycastle/math/ec/ECFieldElement;

    move-result-object v3

    iget-object v4, p0, Lorg/spongycastle/math/ec/ECCurve;->a:Lorg/spongycastle/math/ec/ECFieldElement;
    ...
    invoke-virtual {p1, v3}, Lorg/spongycastle/math/ec/ECFieldElement$Fp;->e(Lorg/spongycastle/math/ec/ECFieldElement;)Lorg/spongycastle/math/ec/ECFieldElement;
