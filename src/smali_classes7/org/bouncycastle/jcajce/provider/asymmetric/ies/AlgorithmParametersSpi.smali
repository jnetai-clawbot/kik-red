...
.method protected final engineGetEncoded()[B
    ...
    iget-object v5, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/ies/AlgorithmParametersSpi;->a:Lorg/bouncycastle/jce/spec/IESParameterSpec;

    invoke-virtual {v5}, Lorg/bouncycastle/jce/spec/IESParameterSpec;->c()[B
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/jce/spec/IESParameterSpec;->e()[B
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/jce/spec/IESParameterSpec;->f()Z

    move-result v1

    if-eqz v1, :cond_3

    sget-object v1, Lorg/bouncycastle/asn1/ASN1Boolean;->d:Lorg/bouncycastle/asn1/ASN1Boolean;

    goto :goto_0

    :cond_3
    sget-object v1, Lorg/bouncycastle/asn1/ASN1Boolean;->c:Lorg/bouncycastle/asn1/ASN1Boolean;
...
.method protected final engineInit([B)V
    ...
    invoke-static {v6}, Lorg/bouncycastle/asn1/ASN1TaggedObject;->B(Ljava/lang/Object;)Lorg/bouncycastle/asn1/ASN1TaggedObject;

    move-result-object v6

    invoke-virtual {v6}, Lorg/bouncycastle/asn1/ASN1TaggedObject;->E()I

    move-result v7

    if-nez v7, :cond_1

    invoke-static {v6, v1}, Lorg/bouncycastle/asn1/ASN1OctetString;->v(Lorg/bouncycastle/asn1/ASN1TaggedObject;Z)Lorg/bouncycastle/asn1/ASN1OctetString;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/asn1/ASN1Integer;->x()Ljava/math/BigInteger;

    move-result-object v6

    invoke-virtual {v2, v10}, Lorg/bouncycastle/asn1/ASN1Sequence;->y(I)Lorg/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-static {v6}, Lorg/bouncycastle/asn1/ASN1Boolean;->v(Ljava/lang/Object;)Lorg/bouncycastle/asn1/ASN1Boolean;

    move-result-object v6

    invoke-virtual {v6}, Lorg/bouncycastle/asn1/ASN1Boolean;->x()Z
