.class final Lorg/bouncycastle/crypto/util/PublicKeyFactory$e;
...
.method synthetic constructor <init>(Lorg/bouncycastle/crypto/util/PublicKeyFactory$a;)V
    ...
    invoke-direct {p0}, Lorg/bouncycastle/crypto/util/PublicKeyFactory$e;-><init>()V
...
.method getPublicKeyParameters(Lorg/bouncycastle/asn1/x509/SubjectPublicKeyInfo;Ljava/lang/Object;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p2}, Lorg/bouncycastle/asn1/ua/DSTU4145Params;->o(Ljava/lang/Object;)Lorg/bouncycastle/asn1/ua/DSTU4145Params;
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/crypto/util/PublicKeyFactory$e;->reverseBytes([B)V

    :cond_0
    invoke-virtual {p2}, Lorg/bouncycastle/asn1/ua/DSTU4145Params;->q()Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual {p2}, Lorg/bouncycastle/asn1/ua/DSTU4145Params;->p()Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;

    move-result-object p2

    invoke-static {p2}, Lorg/bouncycastle/asn1/ua/DSTU4145NamedCurves;->a(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;)Lorg/bouncycastle/crypto/params/ECDomainParameters;
    ...
    :cond_1
    invoke-virtual {p2}, Lorg/bouncycastle/asn1/ua/DSTU4145Params;->n()Lorg/bouncycastle/asn1/ua/DSTU4145ECBinary;

    move-result-object p2

    invoke-virtual {p2}, Lorg/bouncycastle/asn1/ua/DSTU4145ECBinary;->m()[B
    ...
    invoke-direct {p0, v2}, Lorg/bouncycastle/crypto/util/PublicKeyFactory$e;->reverseBytes([B)V
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/asn1/ua/DSTU4145ECBinary;->n()Lorg/bouncycastle/asn1/ua/DSTU4145BinaryField;
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/asn1/ua/DSTU4145ECBinary;->k()Ljava/math/BigInteger;
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/asn1/ua/DSTU4145ECBinary;->o()[B
    ...
    :cond_3
    invoke-static {v3, v2}, Lorg/bouncycastle/asn1/ua/DSTU4145PointEncoder;->a(Lorg/bouncycastle/math/ec/ECCurve;[B)Lorg/bouncycastle/math/ec/ECPoint;

    move-result-object v0

    new-instance v1, Lorg/bouncycastle/crypto/params/ECDomainParameters;

    invoke-virtual {p2}, Lorg/bouncycastle/asn1/ua/DSTU4145ECBinary;->q()Ljava/math/BigInteger;
    ...
    invoke-static {v0, p1}, Lorg/bouncycastle/asn1/ua/DSTU4145PointEncoder;->a(Lorg/bouncycastle/math/ec/ECCurve;[B)Lorg/bouncycastle/math/ec/ECPoint;
