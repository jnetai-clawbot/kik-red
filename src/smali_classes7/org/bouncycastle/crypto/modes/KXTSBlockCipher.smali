...
.method public constructor <init>(Lorg/bouncycastle/crypto/BlockCipher;)V
    ...
    iput p1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->h:I

    invoke-static {p1}, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->getReductionPolynomial(I)J

    move-result-wide v0

    iput-wide v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->i:J

    ushr-int/lit8 v0, p1, 0x3

    new-array v0, v0, [J

    iput-object v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->j:[J

    ushr-int/lit8 p1, p1, 0x3

    new-array p1, p1, [J

    iput-object p1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->k:[J

    const/4 p1, -0x1

    iput p1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->l:I
...
.method private processBlock([BI[BI)V
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->l:I
    ...
    iput v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->l:I

    iget-wide v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->i:J

    iget-object v2, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->k:[J

    invoke-static {v0, v1, v2}, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->GF_double(J[J)V

    iget v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->h:I

    new-array v0, v0, [B

    iget-object v1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->k:[J

    const/4 v2, 0x0

    invoke-static {v1, v0, v2}, Lorg/bouncycastle/util/Pack;->v([J[BI)V

    iget v1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->h:I
    ...
    :goto_0
    iget v4, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->h:I
    ...
    :goto_1
    iget p1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->h:I
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->h:I
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->j:[J

    invoke-static {v1, v3, p1}, Lorg/bouncycastle/util/Pack;->p([BI[J)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->j:[J

    iget-object p2, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->k:[J

    array-length v0, p1

    invoke-static {p1, v3, p2, v3, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iput v3, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->l:I
...
.method public reset()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/modes/KXTSBlockCipher;->j:[J
