...
.field private b:Lorg/bouncycastle/pqc/legacy/crypto/qtesla/QTESLASigner;
...
.method protected constructor <init>(Ljava/lang/String;Lorg/bouncycastle/crypto/Digest;Lorg/bouncycastle/pqc/legacy/crypto/qtesla/QTESLASigner;)V
    ...
    iput-object p3, p0, Lorg/bouncycastle/pqc/jcajce/provider/qtesla/SignatureSpi;->b:Lorg/bouncycastle/pqc/legacy/crypto/qtesla/QTESLASigner;
...
.method protected final engineInitSign(Ljava/security/PrivateKey;)V
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/pqc/jcajce/provider/qtesla/BCqTESLAPrivateKey;->a()Lorg/bouncycastle/crypto/CipherParameters;
    ...
    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/pqc/jcajce/provider/qtesla/SignatureSpi;->b:Lorg/bouncycastle/pqc/legacy/crypto/qtesla/QTESLASigner;

    const/4 v1, 0x1

    invoke-virtual {v0, v1, p1}, Lorg/bouncycastle/pqc/legacy/crypto/qtesla/QTESLASigner;->b(ZLorg/bouncycastle/crypto/CipherParameters;)V
...
.method protected final engineInitVerify(Ljava/security/PublicKey;)V
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/pqc/jcajce/provider/qtesla/BCqTESLAPublicKey;->a()Lorg/bouncycastle/crypto/CipherParameters;
...
.method protected final engineSign()[B
    ...
    invoke-static {v0}, Lorg/bouncycastle/pqc/jcajce/provider/qtesla/a;->a(Lorg/bouncycastle/crypto/Digest;)[B

    move-result-object v0

    iget-object v1, p0, Lorg/bouncycastle/pqc/jcajce/provider/qtesla/SignatureSpi;->b:Lorg/bouncycastle/pqc/legacy/crypto/qtesla/QTESLASigner;

    invoke-virtual {v1, v0}, Lorg/bouncycastle/pqc/legacy/crypto/qtesla/QTESLASigner;->a([B)[B
...
.method protected final engineVerify([B)Z
    ...
    invoke-virtual {v1, v0, p1}, Lorg/bouncycastle/pqc/legacy/crypto/qtesla/QTESLASigner;->c([B[B)Z
