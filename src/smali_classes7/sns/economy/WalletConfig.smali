.class public final Lsns/economy/WalletConfig;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lsns/economy/WalletConfig$Companion;
    }
.end annotation
...
.field private static final d:Lio/wondrous/sns/data/experiment/FloatExperiment;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lsns/economy/WalletConfig$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lsns/economy/WalletConfig$Companion;-><init>(Lkotlin/jvm/internal/c;)V
    ...
    const-string v2, "economy.doLocalBalanceUpdates"
    ...
    sput-object v2, Lsns/economy/WalletConfig;->b:Lio/wondrous/sns/data/experiment/BooleanExperiment;

    const-string v2, "economy.trustLocalBalanceUpdates"

    invoke-virtual {v0, v2, v1}, Lio/wondrous/sns/data/experiment/BooleanExperiment$Companion;->a(Ljava/lang/String;Lio/wondrous/sns/data/experiment/variant/BooleanVariant;)Lio/wondrous/sns/data/experiment/BooleanExperiment;

    move-result-object v0

    sput-object v0, Lsns/economy/WalletConfig;->c:Lio/wondrous/sns/data/experiment/BooleanExperiment;
    ...
    const-string v1, "economy.updateCurrencyDebounceTimeSec"
    ...
    sput-object v0, Lsns/economy/WalletConfig;->d:Lio/wondrous/sns/data/experiment/FloatExperiment;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v1, v0}, Lsns/economy/WalletConfig;-><init>(Lio/wondrous/sns/data/config/ConfigContainer;ILkotlin/jvm/internal/c;)V
...
.method public constructor <init>(Lio/wondrous/sns/data/config/ConfigContainer;)V
    ...
    iput-object p1, p0, Lsns/economy/WalletConfig;->a:Lio/wondrous/sns/data/config/ConfigContainer;
...
.method public synthetic constructor <init>(Lio/wondrous/sns/data/config/ConfigContainer;ILkotlin/jvm/internal/c;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Lsns/economy/WalletConfig;-><init>(Lio/wondrous/sns/data/config/ConfigContainer;)V
...
.method public final a()J
    ...
    sget-object v0, Lsns/economy/WalletConfig;->d:Lio/wondrous/sns/data/experiment/FloatExperiment;

    iget-object v1, p0, Lsns/economy/WalletConfig;->a:Lio/wondrous/sns/data/config/ConfigContainer;
...
.method public final b()Z
    ...
    sget-object v0, Lsns/economy/WalletConfig;->b:Lio/wondrous/sns/data/experiment/BooleanExperiment;
...
.method public final c()Z
    ...
    sget-object v0, Lsns/economy/WalletConfig;->c:Lio/wondrous/sns/data/experiment/BooleanExperiment;
