...
.field final synthetic e:Lcoil/size/Scale;
...
# direct methods
.method constructor <init>(Lcoil/request/ImageRequest;Lcoil/RealImageLoader;Lcoil/size/Size;Lcoil/size/Scale;Lcoil/EventListener;Landroid/graphics/Bitmap;Lkotlin/coroutines/Continuation;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p4, p0, Lcoil/RealImageLoader$executeMain$result$1;->e:Lcoil/size/Scale;

    iput-object p5, p0, Lcoil/RealImageLoader$executeMain$result$1;->f:Lcoil/EventListener;

    iput-object p6, p0, Lcoil/RealImageLoader$executeMain$result$1;->g:Landroid/graphics/Bitmap;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v4, p0, Lcoil/RealImageLoader$executeMain$result$1;->e:Lcoil/size/Scale;

    iget-object v5, p0, Lcoil/RealImageLoader$executeMain$result$1;->f:Lcoil/EventListener;

    iget-object v6, p0, Lcoil/RealImageLoader$executeMain$result$1;->g:Landroid/graphics/Bitmap;

    move-object v0, p1

    move-object v7, p2

    invoke-direct/range {v0 .. v7}, Lcoil/RealImageLoader$executeMain$result$1;-><init>(Lcoil/request/ImageRequest;Lcoil/RealImageLoader;Lcoil/size/Size;Lcoil/size/Scale;Lcoil/EventListener;Landroid/graphics/Bitmap;Lkotlin/coroutines/Continuation;)V
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v9, p0, Lcoil/RealImageLoader$executeMain$result$1;->e:Lcoil/size/Scale;

    iget-object v10, p0, Lcoil/RealImageLoader$executeMain$result$1;->f:Lcoil/EventListener;

    iget-object v1, p0, Lcoil/RealImageLoader$executeMain$result$1;->g:Landroid/graphics/Bitmap;
    ...
    invoke-direct/range {v3 .. v11}, Lcoil/intercept/RealInterceptorChain;-><init>(Lcoil/request/ImageRequest;Ljava/util/List;ILcoil/request/ImageRequest;Lcoil/size/Size;Lcoil/size/Scale;Lcoil/EventListener;Z)V

    iget-object v1, p0, Lcoil/RealImageLoader$executeMain$result$1;->b:Lcoil/request/ImageRequest;

    iput v2, p0, Lcoil/RealImageLoader$executeMain$result$1;->a:I

    invoke-virtual {p1, v1, p0}, Lcoil/intercept/RealInterceptorChain;->e(Lcoil/request/ImageRequest;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
