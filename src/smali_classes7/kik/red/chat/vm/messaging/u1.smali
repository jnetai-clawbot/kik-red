.class public final Lkik/red/chat/vm/messaging/u1;
.super Lkik/red/chat/vm/messaging/a0;
.source "SourceFile"

# interfaces
.implements Lkik/red/chat/vm/messaging/h1;
...
.method public constructor <init>(Lkik/core/datatypes/x;Ljava/lang/String;Lrx/o;Lrx/o;Lrx/o;Lrx/o;Lrx/o;)V
    ...
    iput-object p1, p0, Lkik/red/chat/vm/messaging/u1;->V:Lpm/m;

    return-void
.end method

.method public static synthetic Mb(Lkik/red/chat/vm/messaging/u1;)Lkik/core/datatypes/o;
    .locals 2

    iget-object v0, p0, Lkik/red/chat/vm/messaging/a0;->w:Lrm/x;

    invoke-direct {p0}, Lkik/red/chat/vm/messaging/u1;->Nb()Ljava/lang/String;

    move-result-object p0

    const/4 v1, 0x1

    invoke-interface {v0, p0, v1}, Lrm/x;->f(Ljava/lang/String;Z)Lkik/core/datatypes/o;
...
.method private Nb()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {v0}, Lkik/core/datatypes/x;->k()Ljava/lang/String;
...
.method public final H9(Ljava/lang/String;)V
    ...
    invoke-super {p0, p1}, Lkik/red/chat/vm/messaging/a0;->H9(Ljava/lang/String;)V

    if-eqz p1, :cond_0

    iget-object v0, p0, Lkik/red/chat/vm/messaging/u1;->V:Lpm/m;
    ...
    invoke-virtual {v0, p1, v1}, Lta/a$l;->h(Ljava/lang/String;Ljava/lang/Object;)Lta/a$l;
...
.method protected final kb()Lrx/o;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {p0}, Lkik/red/chat/vm/messaging/a0;->ob()Lrx/o;
    ...
    :cond_0
    invoke-super {p0}, Lkik/red/chat/vm/messaging/a0;->kb()Lrx/o;
...
.method public final z()Lkik/red/chat/vm/messaging/g1$a;
    ...
    sget-object v0, Lkik/red/chat/vm/messaging/g1$a;->Status:Lkik/red/chat/vm/messaging/g1$a;
