...
# direct methods
.method public static a(Li6/t0;Ljava/io/InputStream;Ljava/io/OutputStream;J)J
    .locals 13
    ...
    invoke-static/range {v1 .. v8}, Li6/s0;->b([BLi6/t0;Ljava/io/OutputStream;JIJ)V
    ...
    invoke-static/range {v1 .. v6}, Li6/s0;->c([BLjava/io/DataInputStream;Ljava/io/OutputStream;IJ)V
...
.method private static b([BLi6/t0;Ljava/io/OutputStream;JIJ)V
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct/range {v4 .. v9}, Li6/u0;-><init>(Li6/t0;JJ)V
    ...
    :try_start_1
    invoke-virtual {v10}, Li6/u0;->a()J

    move-result-wide v4

    invoke-virtual {v10, v2, v3, v4, v5}, Li6/u0;->b(JJ)Ljava/io/InputStream;
