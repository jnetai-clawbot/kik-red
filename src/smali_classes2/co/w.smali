...
# static fields
.field private static final e:Lco/w;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lco/w$a;

    invoke-direct {v0}, Lco/w$a;-><init>()V

    sput-object v0, Lco/w;->f:Lkotlin/reflect/jvm/internal/impl/protobuf/p;

    new-instance v0, Lco/w;

    invoke-direct {v0}, Lco/w;-><init>()V

    sput-object v0, Lco/w;->e:Lco/w;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lco/w;->b:Ljava/util/List;
...
.method private constructor <init>()V
    ...
    iput-byte v0, p0, Lco/w;->c:B

    iput v0, p0, Lco/w;->d:I

    sget-object v0, Lkotlin/reflect/jvm/internal/impl/protobuf/c;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;

    iput-object v0, p0, Lco/w;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
...
.method constructor <init>(Lkotlin/reflect/jvm/internal/impl/protobuf/d;Lkotlin/reflect/jvm/internal/impl/protobuf/e;)V
    ...
    iput-object v0, p0, Lco/w;->b:Ljava/util/List;
    ...
    iput-object v5, p0, Lco/w;->b:Ljava/util/List;

    or-int/lit8 v4, v4, 0x1

    :cond_2
    iget-object v5, p0, Lco/w;->b:Ljava/util/List;

    sget-object v6, Lco/v;->l:Lkotlin/reflect/jvm/internal/impl/protobuf/p;
    ...
    iget-object p2, p0, Lco/w;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lco/w;->b:Ljava/util/List;
    ...
    iput-object p2, p0, Lco/w;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
    ...
    iget-object p1, p0, Lco/w;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lco/w;->b:Ljava/util/List;
    ...
    iput-object p1, p0, Lco/w;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
...
.method static synthetic d(Lco/w;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lco/w;->b:Ljava/util/List;

    return-object p0
.end method

.method static synthetic e(Lco/w;Ljava/util/List;)Ljava/util/List;
    .locals 0
...
.method static synthetic f(Lco/w;)Lkotlin/reflect/jvm/internal/impl/protobuf/c;
    .locals 0

    iget-object p0, p0, Lco/w;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;

    return-object p0
.end method

.method public static h()Lco/w;
    .locals 1

    sget-object v0, Lco/w;->e:Lco/w;

    return-object v0
.end method

.method public static s(Lco/w;)Lco/w$b;
    .locals 1

    invoke-static {}, Lco/w$b;->j()Lco/w$b;

    move-result-object v0

    invoke-virtual {v0, p0}, Lco/w$b;->l(Lco/w;)Lco/w$b;
...
.method public final a(Lkotlin/reflect/jvm/internal/impl/protobuf/CodedOutputStream;)V
    ...
    invoke-virtual {p0}, Lco/w;->getSerializedSize()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lco/w;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, Lco/w;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
...
.method public final getSerializedSize()I
    ...
    :goto_0
    iget-object v2, p0, Lco/w;->b:Ljava/util/List;
...
.method public final j()I
    ...
    iget-object v0, p0, Lco/w;->b:Ljava/util/List;
...
.method public final toBuilder()Lkotlin/reflect/jvm/internal/impl/protobuf/n$a;
    ...
    invoke-static {p0}, Lco/w;->s(Lco/w;)Lco/w$b;
