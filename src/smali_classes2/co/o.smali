...
# static fields
.field private static final e:Lco/o;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lco/o$a;

    invoke-direct {v0}, Lco/o$a;-><init>()V

    sput-object v0, Lco/o;->f:Lkotlin/reflect/jvm/internal/impl/protobuf/p;

    new-instance v0, Lco/o;

    invoke-direct {v0}, Lco/o;-><init>()V

    sput-object v0, Lco/o;->e:Lco/o;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, Lco/o;->b:Ljava/util/List;
...
.method private constructor <init>()V
    ...
    iput-byte v0, p0, Lco/o;->c:B

    iput v0, p0, Lco/o;->d:I

    sget-object v0, Lkotlin/reflect/jvm/internal/impl/protobuf/c;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;

    iput-object v0, p0, Lco/o;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
...
.method constructor <init>(Lkotlin/reflect/jvm/internal/impl/protobuf/d;Lkotlin/reflect/jvm/internal/impl/protobuf/e;)V
    ...
    iput-object v0, p0, Lco/o;->b:Ljava/util/List;
    ...
    iput-object v5, p0, Lco/o;->b:Ljava/util/List;

    or-int/lit8 v4, v4, 0x1

    :cond_2
    iget-object v5, p0, Lco/o;->b:Ljava/util/List;

    sget-object v6, Lco/o$c;->i:Lkotlin/reflect/jvm/internal/impl/protobuf/p;
    ...
    iget-object p2, p0, Lco/o;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lco/o;->b:Ljava/util/List;
    ...
    iput-object p2, p0, Lco/o;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
    ...
    iget-object p1, p0, Lco/o;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lco/o;->b:Ljava/util/List;
    ...
    iput-object p1, p0, Lco/o;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
...
.method static synthetic d(Lco/o;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lco/o;->b:Ljava/util/List;

    return-object p0
.end method

.method static synthetic e(Lco/o;Ljava/util/List;)Ljava/util/List;
    .locals 0
...
.method static synthetic f(Lco/o;)Lkotlin/reflect/jvm/internal/impl/protobuf/c;
    .locals 0

    iget-object p0, p0, Lco/o;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;

    return-object p0
.end method

.method public static h()Lco/o;
    .locals 1

    sget-object v0, Lco/o;->e:Lco/o;
...
.method public final a(Lkotlin/reflect/jvm/internal/impl/protobuf/CodedOutputStream;)V
    ...
    invoke-virtual {p0}, Lco/o;->getSerializedSize()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lco/o;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, Lco/o;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
...
.method public final getSerializedSize()I
    ...
    :goto_0
    iget-object v2, p0, Lco/o;->b:Ljava/util/List;
...
.method public final isInitialized()Z
    ...
    :goto_0
    iget-object v3, p0, Lco/o;->b:Ljava/util/List;
    ...
    check-cast v3, Lco/o$c;

    invoke-virtual {v3}, Lco/o$c;->isInitialized()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lco/o;->c:B
    ...
    :cond_3
    iput-byte v1, p0, Lco/o;->c:B

    return v1
.end method

.method public final j(I)Lco/o$c;
    .locals 1

    iget-object v0, p0, Lco/o;->b:Ljava/util/List;
...
.method public final toBuilder()Lkotlin/reflect/jvm/internal/impl/protobuf/n$a;
    ...
    invoke-virtual {v0, p0}, Lco/o$b;->l(Lco/o;)Lco/o$b;
