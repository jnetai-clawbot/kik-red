...
# static fields
.field private static final m:Lco/s;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lco/s$a;-><init>()V

    sput-object v0, Lco/s;->n:Lkotlin/reflect/jvm/internal/impl/protobuf/p;

    new-instance v0, Lco/s;

    invoke-direct {v0}, Lco/s;-><init>()V

    sput-object v0, Lco/s;->m:Lco/s;

    invoke-direct {v0}, Lco/s;->W()V
...
.method private constructor <init>()V
    ...
    iput v0, p0, Lco/s;->j:I

    iput-byte v0, p0, Lco/s;->k:B

    iput v0, p0, Lco/s;->l:I

    sget-object v0, Lkotlin/reflect/jvm/internal/impl/protobuf/c;->a:Lkotlin/reflect/jvm/internal/impl/protobuf/c;

    iput-object v0, p0, Lco/s;->b:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
...
.method constructor <init>(Lkotlin/reflect/jvm/internal/impl/protobuf/d;Lkotlin/reflect/jvm/internal/impl/protobuf/e;)V
    ...
    iput-object v8, p0, Lco/s;->i:Ljava/util/List;
    ...
    iget-object v8, p0, Lco/s;->i:Ljava/util/List;
    ...
    iput-object v7, p0, Lco/s;->i:Ljava/util/List;

    or-int/lit8 v4, v4, 0x20

    :cond_5
    iget-object v7, p0, Lco/s;->i:Ljava/util/List;
    ...
    iput-object v7, p0, Lco/s;->h:Ljava/util/List;

    or-int/lit8 v4, v4, 0x10

    :cond_7
    iget-object v7, p0, Lco/s;->h:Ljava/util/List;
    ...
    invoke-static {v9}, Lco/s$c;->valueOf(I)Lco/s$c;
    ...
    :cond_9
    iget v7, p0, Lco/s;->c:I

    or-int/2addr v7, v8

    iput v7, p0, Lco/s;->c:I

    iput-object v10, p0, Lco/s;->g:Lco/s$c;
    ...
    iget-object p2, p0, Lco/s;->h:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lco/s;->h:Ljava/util/List;
    ...
    iget-object p2, p0, Lco/s;->i:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lco/s;->i:Ljava/util/List;
    ...
    iput-object p2, p0, Lco/s;->b:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
    ...
    iget-object p1, p0, Lco/s;->h:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lco/s;->h:Ljava/util/List;
    ...
    iget-object p1, p0, Lco/s;->i:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lco/s;->i:Ljava/util/List;
    ...
    iput-object p1, p0, Lco/s;->b:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
...
.method constructor <init>(Lkotlin/reflect/jvm/internal/impl/protobuf/g$c;Lco/a;)V
    ...
    iput p2, p0, Lco/s;->j:I

    iput-byte p2, p0, Lco/s;->k:B

    iput p2, p0, Lco/s;->l:I
...
.method static synthetic A(Lco/s;I)I
    .locals 0

    iput p1, p0, Lco/s;->d:I

    return p1
.end method

.method static synthetic B(Lco/s;I)I
    .locals 0

    iput p1, p0, Lco/s;->e:I

    return p1
.end method

.method static synthetic C(Lco/s;Z)Z
    .locals 0

    iput-boolean p1, p0, Lco/s;->f:Z

    return p1
.end method

.method static synthetic D(Lco/s;Lco/s$c;)Lco/s$c;
    .locals 0

    iput-object p1, p0, Lco/s;->g:Lco/s$c;

    return-object p1
.end method

.method static synthetic E(Lco/s;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lco/s;->h:Ljava/util/List;

    return-object p0
.end method

.method static synthetic F(Lco/s;Ljava/util/List;)Ljava/util/List;
    .locals 0
...
.method static synthetic G(Lco/s;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lco/s;->i:Ljava/util/List;

    return-object p0
.end method

.method static synthetic H(Lco/s;Ljava/util/List;)Ljava/util/List;
    .locals 0
...
.method static synthetic I(Lco/s;I)I
    .locals 0

    iput p1, p0, Lco/s;->c:I

    return p1
.end method

.method static synthetic J(Lco/s;)Lkotlin/reflect/jvm/internal/impl/protobuf/c;
    .locals 0

    iget-object p0, p0, Lco/s;->b:Lkotlin/reflect/jvm/internal/impl/protobuf/c;

    return-object p0
.end method

.method public static K()Lco/s;
    .locals 1

    sget-object v0, Lco/s;->m:Lco/s;
...
.method private W()V
    ...
    iput v0, p0, Lco/s;->d:I

    iput v0, p0, Lco/s;->e:I

    iput-boolean v0, p0, Lco/s;->f:Z

    sget-object v0, Lco/s$c;->INV:Lco/s$c;

    iput-object v0, p0, Lco/s;->g:Lco/s$c;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lco/s;->h:Ljava/util/List;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lco/s;->i:Ljava/util/List;
...
.method public final O()Ljava/util/List;
    ...
    iget-object v0, p0, Lco/s;->i:Ljava/util/List;
...
.method public final P()Ljava/util/List;
    ...
    iget-object v0, p0, Lco/s;->h:Ljava/util/List;

    return-object v0
.end method

.method public final Q()Lco/s$c;
    .locals 1

    iget-object v0, p0, Lco/s;->g:Lco/s$c;
...
.method public final a(Lkotlin/reflect/jvm/internal/impl/protobuf/CodedOutputStream;)V
    ...
    invoke-virtual {p0}, Lco/s;->getSerializedSize()I
    ...
    iget-object v1, p0, Lco/s;->g:Lco/s$c;

    invoke-virtual {v1}, Lco/s$c;->getNumber()I
    ...
    :goto_0
    iget-object v2, p0, Lco/s;->h:Ljava/util/List;
    ...
    iget-object v4, p0, Lco/s;->h:Ljava/util/List;
    ...
    :cond_4
    iget-object v1, p0, Lco/s;->i:Ljava/util/List;
    ...
    iget-object v0, p0, Lco/s;->b:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
...
.method public final getSerializedSize()I
    ...
    :goto_1
    iget-object v3, p0, Lco/s;->h:Ljava/util/List;
    ...
    :goto_2
    iget-object v3, p0, Lco/s;->i:Ljava/util/List;
    ...
    iget-object v2, p0, Lco/s;->i:Ljava/util/List;
    ...
    iget-object v1, p0, Lco/s;->b:Lkotlin/reflect/jvm/internal/impl/protobuf/c;
...
.method public final newBuilderForType()Lkotlin/reflect/jvm/internal/impl/protobuf/n$a;
    ...
    invoke-static {}, Lco/s$b;->l()Lco/s$b;
...
.method public final toBuilder()Lkotlin/reflect/jvm/internal/impl/protobuf/n$a;
    ...
    invoke-virtual {v0, p0}, Lco/s$b;->n(Lco/s;)Lco/s$b;
