...
.method private final A(JJJJ)V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/flow/SharedFlowImpl;->u()J
    ...
    iget-object v9, v0, Lkotlinx/coroutines/flow/SharedFlowImpl;->h:[Ljava/lang/Object;

    invoke-static {v9}, Lkotlin/jvm/internal/g;->f(Ljava/lang/Object;)V

    const/4 v10, 0x0

    sget-object v11, Lkotlinx/coroutines/flow/SharedFlowKt;->a:Lkotlinx/coroutines/internal/Symbol;
...
.method public static final m(Lkotlinx/coroutines/flow/SharedFlowImpl;Lkotlinx/coroutines/flow/SharedFlowImpl$Emitter;)V
    .locals 5
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/flow/SharedFlowImpl;->o()V
...
.method private final n(Lkotlinx/coroutines/flow/SharedFlowSlot;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-direct {p0, p1}, Lkotlinx/coroutines/flow/SharedFlowImpl;->y(Lkotlinx/coroutines/flow/SharedFlowSlot;)J
...
.method static p(Lkotlinx/coroutines/flow/SharedFlowImpl;Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 8
    ...
    invoke-virtual {v2, v0}, Lkotlinx/coroutines/flow/SubscribedFlowCollector;->b(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_4
    :try_start_4
    invoke-direct {v5, p1}, Lkotlinx/coroutines/flow/SharedFlowImpl;->z(Lkotlinx/coroutines/flow/SharedFlowSlot;)Ljava/lang/Object;
    ...
    iput-object v5, v0, Lkotlinx/coroutines/flow/SharedFlowImpl$collect$1;->a:Lkotlinx/coroutines/flow/SharedFlowImpl;

    iput-object v2, v0, Lkotlinx/coroutines/flow/SharedFlowImpl$collect$1;->b:Lkotlinx/coroutines/flow/FlowCollector;

    iput-object p1, v0, Lkotlinx/coroutines/flow/SharedFlowImpl$collect$1;->c:Lkotlinx/coroutines/flow/SharedFlowSlot;

    iput-object p0, v0, Lkotlinx/coroutines/flow/SharedFlowImpl$collect$1;->d:Lkotlinx/coroutines/Job;

    iput v4, v0, Lkotlinx/coroutines/flow/SharedFlowImpl$collect$1;->g:I

    invoke-direct {v5, p1, v0}, Lkotlinx/coroutines/flow/SharedFlowImpl;->n(Lkotlinx/coroutines/flow/SharedFlowSlot;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_5
    invoke-virtual {p0, p2}, Lkotlinx/coroutines/flow/internal/AbstractSharedFlow;->j(Lkotlinx/coroutines/flow/internal/AbstractSharedFlowSlot;)V
...
.method private final q()V
    ...
    invoke-static {p0}, Lkotlinx/coroutines/flow/internal/AbstractSharedFlow;->d(Lkotlinx/coroutines/flow/internal/AbstractSharedFlow;)I
...
.method private final s([Lkotlin/coroutines/Continuation;)[Lkotlin/coroutines/Continuation;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    :cond_0
    invoke-direct {p0, v4}, Lkotlinx/coroutines/flow/SharedFlowImpl;->y(Lkotlinx/coroutines/flow/SharedFlowSlot;)J
...
.method private final x(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/flow/internal/AbstractSharedFlow;->k()I
    ...
    :cond_0
    invoke-direct {p0, p1}, Lkotlinx/coroutines/flow/SharedFlowImpl;->r(Ljava/lang/Object;)V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/flow/SharedFlowImpl;->q()V
    ...
    invoke-direct/range {v0 .. v8}, Lkotlinx/coroutines/flow/SharedFlowImpl;->A(JJJJ)V

    :cond_7
    return v9
.end method

.method private final y(Lkotlinx/coroutines/flow/SharedFlowSlot;)J
    .locals 6
...
.method private final z(Lkotlinx/coroutines/flow/SharedFlowSlot;)Ljava/lang/Object;
    .locals 8
    ...
    invoke-virtual {p0, v3, v4}, Lkotlinx/coroutines/flow/SharedFlowImpl;->B(J)[Lkotlin/coroutines/Continuation;
...
# virtual methods
.method public final B(J)[Lkotlin/coroutines/Continuation;
    .locals 21
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J)[",
    ...
    :cond_0
    invoke-direct/range {p0 .. p0}, Lkotlinx/coroutines/flow/SharedFlowImpl;->u()J
    ...
    :cond_1
    invoke-static/range {p0 .. p0}, Lkotlinx/coroutines/flow/internal/AbstractSharedFlow;->d(Lkotlinx/coroutines/flow/internal/AbstractSharedFlow;)I
    ...
    :cond_4
    invoke-direct/range {p0 .. p0}, Lkotlinx/coroutines/flow/SharedFlowImpl;->t()J

    move-result-wide v7

    invoke-virtual/range {p0 .. p0}, Lkotlinx/coroutines/flow/internal/AbstractSharedFlow;->k()I
    ...
    sget-object v16, Lkotlinx/coroutines/flow/SharedFlowKt;->a:Lkotlinx/coroutines/internal/Symbol;
    ...
    iget-object v13, v2, Lkotlinx/coroutines/flow/SharedFlowImpl$Emitter;->d:Lkotlin/coroutines/Continuation;
    ...
    iget-object v2, v2, Lkotlinx/coroutines/flow/SharedFlowImpl$Emitter;->c:Ljava/lang/Object;
    ...
    invoke-direct/range {p0 .. p0}, Lkotlinx/coroutines/flow/SharedFlowImpl;->o()V
    ...
    invoke-direct {v9, v11}, Lkotlinx/coroutines/flow/SharedFlowImpl;->s([Lkotlin/coroutines/Continuation;)[Lkotlin/coroutines/Continuation;
...
.method public final c(Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v0}, Lkotlinx/coroutines/flow/SharedFlowImpl;->s([Lkotlin/coroutines/Continuation;)[Lkotlin/coroutines/Continuation;
...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {v6}, Lkotlinx/coroutines/CancellableContinuationImpl;->q()V
    ...
    invoke-direct {p0, p2}, Lkotlinx/coroutines/flow/SharedFlowImpl;->s([Lkotlin/coroutines/Continuation;)[Lkotlin/coroutines/Continuation;
    ...
    invoke-direct {p0, v8}, Lkotlinx/coroutines/flow/SharedFlowImpl;->r(Ljava/lang/Object;)V
    ...
    invoke-static {v6, p2}, Lkotlinx/coroutines/CancellableContinuationKt;->a(Lkotlinx/coroutines/CancellableContinuation;Lkotlinx/coroutines/DisposableHandle;)V
    ...
    :cond_5
    invoke-virtual {v6}, Lkotlinx/coroutines/CancellableContinuationImpl;->p()Ljava/lang/Object;
