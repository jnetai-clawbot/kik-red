...
# direct methods
.method constructor <init>(Lio/reactivex/a0;Lio/reactivex/functions/o;Lio/reactivex/y;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/z3$b;->a:Lio/reactivex/a0;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/z3$b;->b:Lio/reactivex/functions/o;

    new-instance p1, Lio/reactivex/internal/disposables/h;

    invoke-direct {p1}, Lio/reactivex/internal/disposables/h;-><init>()V

    iput-object p1, p0, Lio/reactivex/internal/operators/observable/z3$b;->c:Lio/reactivex/internal/disposables/h;

    iput-object p3, p0, Lio/reactivex/internal/operators/observable/z3$b;->f:Lio/reactivex/y;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object p1, p0, Lio/reactivex/internal/operators/observable/z3$b;->d:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Lio/reactivex/internal/operators/observable/z3$b;->e:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final a(JLjava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/z3$b;->d:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/z3$b;->a:Lio/reactivex/a0;
...
.method public final b(J)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/z3$b;->e:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-static {p1}, Lio/reactivex/internal/disposables/d;->dispose(Ljava/util/concurrent/atomic/AtomicReference;)Z

    iget-object p1, p0, Lio/reactivex/internal/operators/observable/z3$b;->f:Lio/reactivex/y;

    const/4 p2, 0x0

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/z3$b;->f:Lio/reactivex/y;

    new-instance p2, Lio/reactivex/internal/operators/observable/a4$a;

    iget-object v0, p0, Lio/reactivex/internal/operators/observable/z3$b;->a:Lio/reactivex/a0;
...
.method public final dispose()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/z3$b;->e:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-static {v0}, Lio/reactivex/internal/disposables/d;->dispose(Ljava/util/concurrent/atomic/AtomicReference;)Z

    invoke-static {p0}, Lio/reactivex/internal/disposables/d;->dispose(Ljava/util/concurrent/atomic/AtomicReference;)Z

    iget-object v0, p0, Lio/reactivex/internal/operators/observable/z3$b;->c:Lio/reactivex/internal/disposables/h;
...
.method public final onError(Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/z3$b;->c:Lio/reactivex/internal/disposables/h;
...
.method public final onNext(Ljava/lang/Object;)V
    ...
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/z3$b;->d:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/z3$b;->b:Lio/reactivex/functions/o;
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/z3$b;->c:Lio/reactivex/internal/disposables/h;
