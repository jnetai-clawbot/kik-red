...
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lcom/google/android/exoplayer2/Format;Ljava/util/List;ZLjava/util/Map;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1, p2, p10}, Ls4/c;-><init>(Ljava/lang/String;Ljava/util/List;Z)V
    ...
    :cond_1
    invoke-static {p4, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/c;->b(Ljava/util/List;Ljava/util/List;)V

    invoke-static {p5, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/c;->b(Ljava/util/List;Ljava/util/List;)V

    invoke-static {p6, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/c;->b(Ljava/util/List;Ljava/util/List;)V

    invoke-static {p7, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/c;->b(Ljava/util/List;Ljava/util/List;)V
    ...
    iput-object p8, p0, Lcom/google/android/exoplayer2/source/hls/playlist/c;->j:Lcom/google/android/exoplayer2/Format;
...
.method public final a(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-static {v0, v3, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/c;->c(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    invoke-static {v0, v5, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/c;->c(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    invoke-static {v0, v6, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/c;->c(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    iget-object v8, p0, Lcom/google/android/exoplayer2/source/hls/playlist/c;->j:Lcom/google/android/exoplayer2/Format;

    iget-object v9, p0, Lcom/google/android/exoplayer2/source/hls/playlist/c;->k:Ljava/util/List;

    iget-boolean v10, p0, Ls4/c;->c:Z
