...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->d:Lorg/spongycastle/jce/provider/PEMUtil;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->a:Lorg/spongycastle/asn1/ASN1Set;

    const/4 v1, 0x0

    iput v1, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->b:I

    iput-object v0, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->c:Ljava/io/InputStream;

    return-void
.end method

.method private c()Lorg/spongycastle/x509/X509AttributeCertificate;
    .locals 3
    ...
    iget-object v0, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->a:Lorg/spongycastle/asn1/ASN1Set;

    if-eqz v0, :cond_1

    :cond_0
    iget v0, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->b:I

    iget-object v1, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->a:Lorg/spongycastle/asn1/ASN1Set;
    ...
    iget v1, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->b:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->b:I
    ...
    invoke-virtual {v0}, Lorg/spongycastle/asn1/ASN1Object;->a()[B
...
.method private d(Ljava/io/InputStream;)Lorg/spongycastle/x509/X509AttributeCertificate;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iput-object p1, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->a:Lorg/spongycastle/asn1/ASN1Set;

    invoke-direct {p0}, Lorg/spongycastle/jce/provider/X509AttrCertParser;->c()Lorg/spongycastle/x509/X509AttributeCertificate;
...
.method public final a(Ljava/io/InputStream;)V
    ...
    iput-object p1, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->c:Ljava/io/InputStream;
    ...
    iput v0, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->b:I
    ...
    iget-object v0, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->c:Ljava/io/InputStream;
...
.method public final b()Ljava/lang/Object;
    ...
    iget v2, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->b:I
    ...
    :cond_0
    iput-object v1, p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->a:Lorg/spongycastle/asn1/ASN1Set;
    ...
    sget-object v2, Lorg/spongycastle/jce/provider/X509AttrCertParser;->d:Lorg/spongycastle/jce/provider/PEMUtil;
    ...
    invoke-direct {p0, v0}, Lorg/spongycastle/jce/provider/X509AttrCertParser;->d(Ljava/io/InputStream;)Lorg/spongycastle/x509/X509AttributeCertificate;
