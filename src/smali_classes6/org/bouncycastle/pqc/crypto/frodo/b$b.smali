.class final Lorg/bouncycastle/pqc/crypto/frodo/b$b;
...
.method final a([B)[S
    ...
    :goto_0
    iget v5, p0, Lorg/bouncycastle/pqc/crypto/frodo/b;->a:I

    if-ge v4, v5, :cond_1

    invoke-static {v4}, Lorg/bouncycastle/util/Pack;->x(S)[B

    move-result-object v5

    invoke-static {v5, p1}, Lorg/bouncycastle/util/Arrays;->h([B[B)[B
    ...
    :goto_1
    iget v6, p0, Lorg/bouncycastle/pqc/crypto/frodo/b;->a:I
    ...
    invoke-static {v2, v7}, Lorg/bouncycastle/util/Pack;->q([BI)S

    move-result v7

    iget v8, p0, Lorg/bouncycastle/pqc/crypto/frodo/b;->b:I
