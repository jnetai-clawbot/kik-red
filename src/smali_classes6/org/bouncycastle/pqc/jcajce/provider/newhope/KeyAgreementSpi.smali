...
# instance fields
.field private j:Lorg/bouncycastle/pqc/crypto/newhope/NHAgreement;
...
.method protected final engineDoPhase(Ljava/security/Key;Z)Ljava/security/Key;
    ...
    invoke-virtual {p2, p1}, Lorg/bouncycastle/pqc/crypto/newhope/NHExchangePairGenerator;->a(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)Lorg/bouncycastle/pqc/crypto/ExchangePair;
    ...
    :cond_0
    iget-object p2, p0, Lorg/bouncycastle/pqc/jcajce/provider/newhope/KeyAgreementSpi;->j:Lorg/bouncycastle/pqc/crypto/newhope/NHAgreement;
...
.method protected final engineGenerateSecret()[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/pqc/jcajce/provider/newhope/KeyAgreementSpi;->l:[B
...
.method protected final engineInit(Ljava/security/Key;Ljava/security/SecureRandom;)V
    ...
    iput-object p2, p0, Lorg/bouncycastle/pqc/jcajce/provider/newhope/KeyAgreementSpi;->j:Lorg/bouncycastle/pqc/crypto/newhope/NHAgreement;

    check-cast p1, Lorg/bouncycastle/pqc/jcajce/provider/newhope/BCNHPrivateKey;

    invoke-virtual {p1}, Lorg/bouncycastle/pqc/jcajce/provider/newhope/BCNHPrivateKey;->a()Lorg/bouncycastle/crypto/CipherParameters;

    move-result-object p1

    invoke-virtual {p2, p1}, Lorg/bouncycastle/pqc/crypto/newhope/NHAgreement;->b(Lorg/bouncycastle/crypto/CipherParameters;)V
