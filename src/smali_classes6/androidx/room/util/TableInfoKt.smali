...
.method private static final readColumns(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-virtual {v9, v10, v3}, Lkotlin/collections/builders/MapBuilder;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_2
    invoke-static {v9}, Lkotlin/collections/MapsKt;->c(Ljava/util/Map;)Ljava/util/Map;
...
.method private static final readForeignKeyFieldMappings(Landroid/database/Cursor;)Ljava/util/List;
    ...
    :cond_0
    invoke-static {v4}, Lkotlin/collections/CollectionsKt;->w(Ljava/util/List;)Ljava/util/List;
...
.method private static final readForeignKeys(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v6, v7}, Lkotlin/collections/builders/SetBuilder;->add(Ljava/lang/Object;)Z
