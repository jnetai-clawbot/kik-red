...
.method private synthetic lambda$run$0(Landroidx/work/impl/utils/futures/SettableFuture;)V
    ...
    invoke-virtual {v0}, Landroidx/work/ListenableWorker;->getForegroundInfoAsync()Lcom/google/common/util/concurrent/k;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroidx/work/impl/utils/futures/SettableFuture;->setFuture(Lcom/google/common/util/concurrent/k;)Z
...
.method public run()V
    ...
    invoke-direct {v2, p0, v0, v3}, Le/c;-><init>(Ljava/lang/Object;Ljava/lang/Object;I)V
