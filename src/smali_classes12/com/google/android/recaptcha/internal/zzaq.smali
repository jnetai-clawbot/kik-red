...
.method private static final zzb([B)V
    ...
    invoke-static {p0}, Lcom/google/android/recaptcha/internal/zzlr;->zzk([B)Lcom/google/android/recaptcha/internal/zzlr;

    move-result-object p0

    invoke-virtual {p0}, Lcom/google/android/recaptcha/internal/zzlr;->zzG()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/google/android/recaptcha/internal/zzlo;->zzj()Lcom/google/android/recaptcha/internal/zzln;

    move-result-object v2

    invoke-virtual {v2}, Lcom/google/android/recaptcha/internal/zzln;->name()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/google/android/recaptcha/internal/zzlo;->zzS()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Lcom/google/android/recaptcha/internal/zzlo;->zzH()Ljava/lang/String;

    invoke-virtual {v0}, Lcom/google/android/recaptcha/internal/zzlo;->zzI()Ljava/lang/String;

    invoke-virtual {v0}, Lcom/google/android/recaptcha/internal/zzlo;->zzj()Lcom/google/android/recaptcha/internal/zzln;

    move-result-object v1

    invoke-virtual {v1}, Lcom/google/android/recaptcha/internal/zzln;->name()Ljava/lang/String;

    invoke-virtual {v0}, Lcom/google/android/recaptcha/internal/zzlo;->zzg()Lcom/google/android/recaptcha/internal/zzla;

    move-result-object v1

    invoke-virtual {v1}, Lcom/google/android/recaptcha/internal/zzla;->zzk()Ljava/lang/String;

    invoke-virtual {v0}, Lcom/google/android/recaptcha/internal/zzlo;->zzg()Lcom/google/android/recaptcha/internal/zzla;

    move-result-object v1

    invoke-virtual {v1}, Lcom/google/android/recaptcha/internal/zzla;->zzf()I

    invoke-virtual {v0}, Lcom/google/android/recaptcha/internal/zzlo;->zzT()I
