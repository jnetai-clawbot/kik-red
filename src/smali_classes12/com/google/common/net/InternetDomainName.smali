...
# static fields
.field private static final DASH_MATCHER:Lcom/google/common/base2/CharMatcher;

.field private static final DIGIT_MATCHER:Lcom/google/common/base2/CharMatcher;

.field private static final DOTS_MATCHER:Lcom/google/common/base2/CharMatcher;

.field private static final DOT_JOINER:Lcom/google/common/base2/Joiner;

.field private static final DOT_SPLITTER:Lcom/google/common/base2/Splitter;

.field private static final LETTER_MATCHER:Lcom/google/common/base2/CharMatcher;
...
.field private static final PART_CHAR_MATCHER:Lcom/google/common/base2/CharMatcher;
...
.field private final parts:Lcom/google/common/collect2/ImmutableList;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/common/net/InternetDomainName;->DOTS_MATCHER:Lcom/google/common/base2/CharMatcher;
    ...
    sput-object v1, Lcom/google/common/net/InternetDomainName;->DOT_SPLITTER:Lcom/google/common/base2/Splitter;

    invoke-static {v0}, Lcom/google/common/base2/Joiner;->on(C)Lcom/google/common/base2/Joiner;

    move-result-object v0

    sput-object v0, Lcom/google/common/net/InternetDomainName;->DOT_JOINER:Lcom/google/common/base2/Joiner;
    ...
    sput-object v0, Lcom/google/common/net/InternetDomainName;->DASH_MATCHER:Lcom/google/common/base2/CharMatcher;

    const/16 v1, 0x30

    const/16 v2, 0x39

    invoke-static {v1, v2}, Lcom/google/common/base2/CharMatcher;->inRange(CC)Lcom/google/common/base2/CharMatcher;

    move-result-object v1

    sput-object v1, Lcom/google/common/net/InternetDomainName;->DIGIT_MATCHER:Lcom/google/common/base2/CharMatcher;
    ...
    invoke-static {v3, v4}, Lcom/google/common/base2/CharMatcher;->inRange(CC)Lcom/google/common/base2/CharMatcher;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/google/common/base2/CharMatcher;->or(Lcom/google/common/base2/CharMatcher;)Lcom/google/common/base2/CharMatcher;

    move-result-object v2

    sput-object v2, Lcom/google/common/net/InternetDomainName;->LETTER_MATCHER:Lcom/google/common/base2/CharMatcher;

    nop

    invoke-virtual {v1, v2}, Lcom/google/common/base2/CharMatcher;->or(Lcom/google/common/base2/CharMatcher;)Lcom/google/common/base2/CharMatcher;

    move-result-object v1

    invoke-virtual {v1, v0}, Lcom/google/common/base2/CharMatcher;->or(Lcom/google/common/base2/CharMatcher;)Lcom/google/common/base2/CharMatcher;

    move-result-object v0

    sput-object v0, Lcom/google/common/net/InternetDomainName;->PART_CHAR_MATCHER:Lcom/google/common/base2/CharMatcher;
...
.method constructor <init>(Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/google/common/net/InternetDomainName;->DOTS_MATCHER:Lcom/google/common/base2/CharMatcher;

    const/16 v1, 0x2e

    invoke-virtual {v0, p1, v1}, Lcom/google/common/base2/CharMatcher;->replaceFrom(Ljava/lang/CharSequence;C)Ljava/lang/String;
    ...
    invoke-static {v0, v3, p1}, Lcom/google/common/base2/Preconditions;->checkArgument(ZLjava/lang/String;Ljava/lang/Object;)V

    iput-object p1, p0, Lcom/google/common/net/InternetDomainName;->name:Ljava/lang/String;

    sget-object v0, Lcom/google/common/net/InternetDomainName;->DOT_SPLITTER:Lcom/google/common/base2/Splitter;

    invoke-virtual {v0, p1}, Lcom/google/common/base2/Splitter;->split(Ljava/lang/CharSequence;)Ljava/lang/Iterable;
    ...
    iput-object v0, p0, Lcom/google/common/net/InternetDomainName;->parts:Lcom/google/common/collect2/ImmutableList;
...
.method private ancestor(I)Lcom/google/common/net/InternetDomainName;
    ...
    sget-object v0, Lcom/google/common/net/InternetDomainName;->DOT_JOINER:Lcom/google/common/base2/Joiner;

    iget-object v1, p0, Lcom/google/common/net/InternetDomainName;->parts:Lcom/google/common/collect2/ImmutableList;

    invoke-virtual {v1}, Lcom/google/common/collect2/ImmutableList;->size()I

    move-result v2

    invoke-virtual {v1, p1, v2}, Lcom/google/common/collect2/ImmutableList;->subList(II)Lcom/google/common/collect2/ImmutableList;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/google/common/base2/Joiner;->join(Ljava/lang/Iterable;)Ljava/lang/String;
...
.method private findSuffixOfType(Lcom/google/common/base2/Optional;)I
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    iget-object v0, p0, Lcom/google/common/net/InternetDomainName;->parts:Lcom/google/common/collect2/ImmutableList;
    ...
    sget-object v2, Lcom/google/common/net/InternetDomainName;->DOT_JOINER:Lcom/google/common/base2/Joiner;

    iget-object v3, p0, Lcom/google/common/net/InternetDomainName;->parts:Lcom/google/common/collect2/ImmutableList;

    invoke-virtual {v3, v1, v0}, Lcom/google/common/collect2/ImmutableList;->subList(II)Lcom/google/common/collect2/ImmutableList;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/google/common/base2/Joiner;->join(Ljava/lang/Iterable;)Ljava/lang/String;

    move-result-object v2

    if-lez v1, :cond_0

    sget-object v3, Lcom/google/thirdparty/publicsuffix/PublicSuffixPatterns;->UNDER:Lcom/google/common/collect2/ImmutableMap;

    invoke-virtual {v3, v2}, Lcom/google/common/collect2/ImmutableMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/google/thirdparty/publicsuffix/PublicSuffixType;

    invoke-static {v3}, Lcom/google/common/base2/Optional;->fromNullable(Ljava/lang/Object;)Lcom/google/common/base2/Optional;

    move-result-object v3

    invoke-static {p1, v3}, Lcom/google/common/net/InternetDomainName;->matchesType(Lcom/google/common/base2/Optional;Lcom/google/common/base2/Optional;)Z
    ...
    :cond_0
    sget-object v3, Lcom/google/thirdparty/publicsuffix/PublicSuffixPatterns;->EXACT:Lcom/google/common/collect2/ImmutableMap;
    ...
    :cond_1
    sget-object v3, Lcom/google/thirdparty/publicsuffix/PublicSuffixPatterns;->EXCLUDED:Lcom/google/common/collect2/ImmutableMap;

    invoke-virtual {v3, v2}, Lcom/google/common/collect2/ImmutableMap;->containsKey(Ljava/lang/Object;)Z
...
.method private static matchesType(Lcom/google/common/base2/Optional;Lcom/google/common/base2/Optional;)Z
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p0}, Lcom/google/common/base2/Optional;->isPresent()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, Lcom/google/common/base2/Optional;->equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/google/common/base2/Optional;->isPresent()Z
...
.method private publicSuffixIndex()I
    ...
    invoke-direct {p0, v1}, Lcom/google/common/net/InternetDomainName;->findSuffixOfType(Lcom/google/common/base2/Optional;)I
...
.method private static validatePart(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v0, p0}, Lcom/google/common/base2/CharMatcher;->retainFrom(Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v0

    sget-object v3, Lcom/google/common/net/InternetDomainName;->PART_CHAR_MATCHER:Lcom/google/common/base2/CharMatcher;

    invoke-virtual {v3, v0}, Lcom/google/common/base2/CharMatcher;->matchesAllOf(Ljava/lang/CharSequence;)Z
    ...
    :cond_1
    sget-object v3, Lcom/google/common/net/InternetDomainName;->DASH_MATCHER:Lcom/google/common/base2/CharMatcher;

    invoke-virtual {p0, v2}, Ljava/lang/String;->charAt(I)C

    move-result v4

    invoke-virtual {v3, v4}, Lcom/google/common/base2/CharMatcher;->matches(C)Z
    ...
    sget-object v3, Lcom/google/common/net/InternetDomainName;->DIGIT_MATCHER:Lcom/google/common/base2/CharMatcher;
...
.method public parent()Lcom/google/common/net/InternetDomainName;
    ...
    invoke-static {v0, v2, v1}, Lcom/google/common/base2/Preconditions;->checkState(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method public parts()Lcom/google/common/collect2/ImmutableList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
