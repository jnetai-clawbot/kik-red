.class final Lio/grpc2/okhttp/OkHttpServer$ListenSocket;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lio/grpc2/okhttp/OkHttpServer;
.end annotation
...
# instance fields
.field private final id:Lio/grpc2/InternalLogId;
...
.method public constructor <init>(Ljava/net/ServerSocket;)V
    ...
    iput-object p1, p0, Lio/grpc2/okhttp/OkHttpServer$ListenSocket;->socket:Ljava/net/ServerSocket;
    ...
    iput-object v0, p0, Lio/grpc2/okhttp/OkHttpServer$ListenSocket;->id:Lio/grpc2/InternalLogId;
...
.method public getLogId()Lio/grpc2/InternalLogId;
    ...
    iget-object v0, p0, Lio/grpc2/okhttp/OkHttpServer$ListenSocket;->id:Lio/grpc2/InternalLogId;
...
.method public getStats()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    new-instance v6, Lio/grpc2/InternalChannelz$SocketStats;

    iget-object v0, p0, Lio/grpc2/okhttp/OkHttpServer$ListenSocket;->socket:Ljava/net/ServerSocket;

    invoke-virtual {v0}, Ljava/net/ServerSocket;->getLocalSocketAddress()Ljava/net/SocketAddress;

    move-result-object v2

    new-instance v0, Lio/grpc2/InternalChannelz$SocketOptions$Builder;

    invoke-direct {v0}, Lio/grpc2/InternalChannelz$SocketOptions$Builder;-><init>()V

    invoke-virtual {v0}, Lio/grpc2/InternalChannelz$SocketOptions$Builder;->build()Lio/grpc2/InternalChannelz$SocketOptions;
    ...
    invoke-direct/range {v0 .. v5}, Lio/grpc2/InternalChannelz$SocketStats;-><init>(Lio/grpc2/InternalChannelz$TransportStats;Ljava/net/SocketAddress;Ljava/net/SocketAddress;Lio/grpc2/InternalChannelz$SocketOptions;Lio/grpc2/InternalChannelz$Security;)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/grpc2/okhttp/OkHttpServer$ListenSocket;->id:Lio/grpc2/InternalLogId;
    ...
    iget-object v1, p0, Lio/grpc2/okhttp/OkHttpServer$ListenSocket;->socket:Ljava/net/ServerSocket;
