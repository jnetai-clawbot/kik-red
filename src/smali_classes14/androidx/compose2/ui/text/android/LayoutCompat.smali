.class public final Landroidx/compose2/ui/text/android/LayoutCompat;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/compose2/ui/text/android/LayoutCompat$BreakStrategy;,
        Landroidx/compose2/ui/text/android/LayoutCompat$HyphenationFrequency;,
        Landroidx/compose2/ui/text/android/LayoutCompat$JustificationMode;,
        Landroidx/compose2/ui/text/android/LayoutCompat$LineBreakStyle;,
        Landroidx/compose2/ui/text/android/LayoutCompat$LineBreakWordStyle;,
        Landroidx/compose2/ui/text/android/LayoutCompat$TextDirection;,
        Landroidx/compose2/ui/text/android/LayoutCompat$TextGranularity;,
        Landroidx/compose2/ui/text/android/LayoutCompat$TextLayoutAlignment;
    }
.end annotation
...
.field public static final INSTANCE:Landroidx/compose2/ui/text/android/LayoutCompat;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Landroidx/compose2/ui/text/android/LayoutCompat;

    invoke-direct {v0}, Landroidx/compose2/ui/text/android/LayoutCompat;-><init>()V

    sput-object v0, Landroidx/compose2/ui/text/android/LayoutCompat;->INSTANCE:Landroidx/compose2/ui/text/android/LayoutCompat;

    sget-object v0, Landroid/text/Layout$Alignment;->ALIGN_NORMAL:Landroid/text/Layout$Alignment;

    sput-object v0, Landroidx/compose2/ui/text/android/LayoutCompat;->DEFAULT_LAYOUT_ALIGNMENT:Landroid/text/Layout$Alignment;

    sget-object v0, Landroid/text/TextDirectionHeuristics;->FIRSTSTRONG_LTR:Landroid/text/TextDirectionHeuristic;

    sput-object v0, Landroidx/compose2/ui/text/android/LayoutCompat;->DEFAULT_TEXT_DIRECTION_HEURISTIC:Landroid/text/TextDirectionHeuristic;

    const/16 v0, 0x8

    sput v0, Landroidx/compose2/ui/text/android/LayoutCompat;->$stable:I
...
.method public final getDEFAULT_LAYOUT_ALIGNMENT$ui_text_release()Landroid/text/Layout$Alignment;
    ...
    sget-object v0, Landroidx/compose2/ui/text/android/LayoutCompat;->DEFAULT_LAYOUT_ALIGNMENT:Landroid/text/Layout$Alignment;
...
.method public final getDEFAULT_TEXT_DIRECTION_HEURISTIC$ui_text_release()Landroid/text/TextDirectionHeuristic;
    ...
    sget-object v0, Landroidx/compose2/ui/text/android/LayoutCompat;->DEFAULT_TEXT_DIRECTION_HEURISTIC:Landroid/text/TextDirectionHeuristic;
