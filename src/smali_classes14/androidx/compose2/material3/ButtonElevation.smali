.class public final Landroidx/compose2/material3/ButtonElevation;
...
.method private constructor <init>(FFFFF)V
    ...
    iput p1, p0, Landroidx/compose2/material3/ButtonElevation;->defaultElevation:F

    iput p2, p0, Landroidx/compose2/material3/ButtonElevation;->pressedElevation:F

    iput p3, p0, Landroidx/compose2/material3/ButtonElevation;->focusedElevation:F

    iput p4, p0, Landroidx/compose2/material3/ButtonElevation;->hoveredElevation:F

    iput p5, p0, Landroidx/compose2/material3/ButtonElevation;->disabledElevation:F
...
.method public synthetic constructor <init>(FFFFFLkotlin2/jvm/internal/DefaultConstructorMarker;)V
    ...
    invoke-direct/range {p0 .. p5}, Landroidx/compose2/material3/ButtonElevation;-><init>(FFFFF)V

    return-void
.end method

.method public static final synthetic access$getFocusedElevation$p(Landroidx/compose2/material3/ButtonElevation;)F
    .locals 1

    iget v0, p0, Landroidx/compose2/material3/ButtonElevation;->focusedElevation:F

    return v0
.end method

.method public static final synthetic access$getHoveredElevation$p(Landroidx/compose2/material3/ButtonElevation;)F
    .locals 1

    iget v0, p0, Landroidx/compose2/material3/ButtonElevation;->hoveredElevation:F

    return v0
.end method

.method public static final synthetic access$getPressedElevation$p(Landroidx/compose2/material3/ButtonElevation;)F
    .locals 1

    iget v0, p0, Landroidx/compose2/material3/ButtonElevation;->pressedElevation:F
...
.method private final animateElevation(ZLandroidx/compose2/foundation/interaction/InteractionSource;Landroidx/compose2/runtime/Composer;I)Landroidx/compose2/runtime/State;
    ...
    new-instance v15, Landroidx/compose2/material3/ButtonElevation$animateElevation$1$1;

    const/4 v3, 0x0

    invoke-direct {v15, v9, v12, v3}, Landroidx/compose2/material3/ButtonElevation$animateElevation$1$1;-><init>(Landroidx/compose2/foundation/interaction/InteractionSource;Landroidx/compose2/runtime/snapshots/SnapshotStateList;Lkotlin2/coroutines/Continuation;)V
    ...
    iget v0, v7, Landroidx/compose2/material3/ButtonElevation;->disabledElevation:F
    ...
    iget v0, v7, Landroidx/compose2/material3/ButtonElevation;->pressedElevation:F
    ...
    iget v0, v7, Landroidx/compose2/material3/ButtonElevation;->hoveredElevation:F
    ...
    iget v0, v7, Landroidx/compose2/material3/ButtonElevation;->focusedElevation:F

    goto :goto_4

    :cond_a
    iget v0, v7, Landroidx/compose2/material3/ButtonElevation;->defaultElevation:F
    ...
    new-instance v20, Landroidx/compose2/material3/ButtonElevation$animateElevation$2$1;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    instance-of v2, p1, Landroidx/compose2/material3/ButtonElevation;
    ...
    :cond_1
    iget v2, p0, Landroidx/compose2/material3/ButtonElevation;->defaultElevation:F

    move-object v3, p1

    check-cast v3, Landroidx/compose2/material3/ButtonElevation;

    iget v3, v3, Landroidx/compose2/material3/ButtonElevation;->defaultElevation:F
    ...
    :cond_2
    iget v2, p0, Landroidx/compose2/material3/ButtonElevation;->pressedElevation:F

    move-object v3, p1

    check-cast v3, Landroidx/compose2/material3/ButtonElevation;

    iget v3, v3, Landroidx/compose2/material3/ButtonElevation;->pressedElevation:F
    ...
    :cond_3
    iget v2, p0, Landroidx/compose2/material3/ButtonElevation;->focusedElevation:F

    move-object v3, p1

    check-cast v3, Landroidx/compose2/material3/ButtonElevation;

    iget v3, v3, Landroidx/compose2/material3/ButtonElevation;->focusedElevation:F
    ...
    :cond_4
    iget v2, p0, Landroidx/compose2/material3/ButtonElevation;->hoveredElevation:F

    move-object v3, p1

    check-cast v3, Landroidx/compose2/material3/ButtonElevation;

    iget v3, v3, Landroidx/compose2/material3/ButtonElevation;->hoveredElevation:F
    ...
    :cond_5
    iget v2, p0, Landroidx/compose2/material3/ButtonElevation;->disabledElevation:F

    move-object v3, p1

    check-cast v3, Landroidx/compose2/material3/ButtonElevation;

    iget v3, v3, Landroidx/compose2/material3/ButtonElevation;->disabledElevation:F
...
.method public hashCode()I
    ...
    iget v0, p0, Landroidx/compose2/material3/ButtonElevation;->defaultElevation:F
...
.method public final shadowElevation$material3_release(ZLandroidx/compose2/foundation/interaction/InteractionSource;Landroidx/compose2/runtime/Composer;I)Landroidx/compose2/runtime/State;
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/compose2/material3/ButtonElevation;->animateElevation(ZLandroidx/compose2/foundation/interaction/InteractionSource;Landroidx/compose2/runtime/Composer;I)Landroidx/compose2/runtime/State;
