.class public final Landroidx/compose2/animation/core/KeyframesSpec;
...
# instance fields
.field private final config:Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig<",
            "TT;>;"
...
.method public constructor <init>(Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Landroidx/compose2/animation/core/KeyframesSpec;->config:Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;
...
# virtual methods
.method public final getConfig()Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Landroidx/compose2/animation/core/KeyframesSpec;->config:Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;
...
.method public bridge synthetic vectorize(Landroidx/compose2/animation/core/TwoWayConverter;)Landroidx/compose2/animation/core/VectorizedAnimationSpec;
    ...
    invoke-virtual {p0, p1}, Landroidx/compose2/animation/core/KeyframesSpec;->vectorize(Landroidx/compose2/animation/core/TwoWayConverter;)Landroidx/compose2/animation/core/VectorizedKeyframesSpec;
...
.method public vectorize(Landroidx/compose2/animation/core/TwoWayConverter;)Landroidx/compose2/animation/core/VectorizedKeyframesSpec;
    .locals 27
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<V:",
            ...
            "TT;TV;>;)",
            "Landroidx/compose2/animation/core/VectorizedKeyframesSpec<",
            "TV;>;"
        }
    .end annotation
    ...
    iget-object v2, v0, Landroidx/compose2/animation/core/KeyframesSpec;->config:Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;

    invoke-virtual {v2}, Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;->getKeyframes$animation_core_release()Landroidx/collection2/MutableIntObjectMap;
    ...
    iget-object v3, v0, Landroidx/compose2/animation/core/KeyframesSpec;->config:Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;

    invoke-virtual {v3}, Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;->getKeyframes$animation_core_release()Landroidx/collection2/MutableIntObjectMap;
    ...
    new-instance v3, Landroidx/compose2/animation/core/VectorizedKeyframeSpecElementInfo;
    ...
    invoke-virtual/range {v21 .. v21}, Landroidx/compose2/animation/core/KeyframesSpec$KeyframeEntity;->getArcMode--9T-Mq4$animation_core_release()I
    ...
    invoke-direct {v3, v4, v5, v6, v7}, Landroidx/compose2/animation/core/VectorizedKeyframeSpecElementInfo;-><init>(Landroidx/compose2/animation/core/AnimationVector;Landroidx/compose2/animation/core/Easing;ILkotlin2/jvm/internal/DefaultConstructorMarker;)V
    ...
    iget-object v4, v0, Landroidx/compose2/animation/core/KeyframesSpec;->config:Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;

    invoke-virtual {v4}, Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;->getDurationMillis()I
    ...
    invoke-virtual {v3}, Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;->getDurationMillis()I
    ...
    new-instance v3, Landroidx/compose2/animation/core/VectorizedKeyframesSpec;
    ...
    invoke-virtual {v4}, Landroidx/compose2/animation/core/KeyframesSpec$KeyframesSpecConfig;->getDelayMillis()I
    ...
    sget-object v4, Landroidx/compose2/animation/core/ArcMode;->Companion:Landroidx/compose2/animation/core/ArcMode$Companion;

    invoke-virtual {v4}, Landroidx/compose2/animation/core/ArcMode$Companion;->getArcLinear--9T-Mq4()I
    ...
    invoke-direct/range {v4 .. v11}, Landroidx/compose2/animation/core/VectorizedKeyframesSpec;-><init>(Landroidx/collection2/IntList;Landroidx/collection2/IntObjectMap;IILandroidx/compose2/animation/core/Easing;ILkotlin2/jvm/internal/DefaultConstructorMarker;)V
