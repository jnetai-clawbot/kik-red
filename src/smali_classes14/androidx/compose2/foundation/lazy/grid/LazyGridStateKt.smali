.class public final Landroidx/compose2/foundation/lazy/grid/LazyGridStateKt;
.super Ljava/lang/Object;
.source "LazyGridState.kt"


# static fields
.field private static final EmptyLazyGridLayoutInfo:Landroidx/compose2/foundation/lazy/grid/LazyGridMeasureResult;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Landroidx/compose2/foundation/lazy/grid/LazyGridStateKt$EmptyLazyGridLayoutInfo$1;

    invoke-direct {v0}, Landroidx/compose2/foundation/lazy/grid/LazyGridStateKt$EmptyLazyGridLayoutInfo$1;-><init>()V

    invoke-static {}, Lkotlin2/collections/CollectionsKt;->emptyList()Ljava/util/List;

    move-result-object v12

    sget-object v17, Landroidx/compose2/foundation/gestures/Orientation;->Vertical:Landroidx/compose2/foundation/gestures/Orientation;
    ...
    new-instance v20, Landroidx/compose2/foundation/lazy/grid/LazyGridMeasureResult;
    ...
    sget-object v0, Landroidx/compose2/foundation/lazy/grid/LazyGridStateKt$EmptyLazyGridLayoutInfo$2;->INSTANCE:Landroidx/compose2/foundation/lazy/grid/LazyGridStateKt$EmptyLazyGridLayoutInfo$2;
    ...
    invoke-direct/range {v1 .. v19}, Landroidx/compose2/foundation/lazy/grid/LazyGridMeasureResult;-><init>(Landroidx/compose2/foundation/lazy/grid/LazyGridMeasuredLine;IZFLandroidx/compose2/ui/layout/MeasureResult;ZLkotlinx2/coroutines/CoroutineScope;Landroidx/compose2/ui/unit/Density;ILkotlin2/jvm/functions/Function1;Ljava/util/List;IIIZLandroidx/compose2/foundation/gestures/Orientation;II)V

    sput-object v20, Landroidx/compose2/foundation/lazy/grid/LazyGridStateKt;->EmptyLazyGridLayoutInfo:Landroidx/compose2/foundation/lazy/grid/LazyGridMeasureResult;

    return-void
.end method

.method public static final synthetic access$getEmptyLazyGridLayoutInfo$p()Landroidx/compose2/foundation/lazy/grid/LazyGridMeasureResult;
    .locals 1

    sget-object v0, Landroidx/compose2/foundation/lazy/grid/LazyGridStateKt;->EmptyLazyGridLayoutInfo:Landroidx/compose2/foundation/lazy/grid/LazyGridMeasureResult;

    return-object v0
.end method

.method public static final rememberLazyGridState(IILandroidx/compose2/foundation/lazy/grid/LazyGridPrefetchStrategy;Landroidx/compose2/runtime/Composer;II)Landroidx/compose2/foundation/lazy/grid/LazyGridState;
    .locals 16
    ...
    invoke-static {v4, v5, v15}, Landroidx/compose2/foundation/lazy/grid/LazyGridPrefetchStrategyKt;->LazyGridPrefetchStrategy$default(IILjava/lang/Object;)Landroidx/compose2/foundation/lazy/grid/LazyGridPrefetchStrategy;
    ...
    check-cast v2, Landroidx/compose2/foundation/lazy/grid/LazyGridPrefetchStrategy;
    ...
    sget-object v2, Landroidx/compose2/foundation/lazy/grid/LazyGridState;->Companion:Landroidx/compose2/foundation/lazy/grid/LazyGridState$Companion;

    invoke-virtual {v2, v11}, Landroidx/compose2/foundation/lazy/grid/LazyGridState$Companion;->saver$foundation_release(Landroidx/compose2/foundation/lazy/grid/LazyGridPrefetchStrategy;)Landroidx/compose2/runtime/saveable/Saver;
    ...
    new-instance v13, Landroidx/compose2/foundation/lazy/grid/LazyGridStateKt$rememberLazyGridState$3$1;

    invoke-direct {v13, v9, v10, v11}, Landroidx/compose2/foundation/lazy/grid/LazyGridStateKt$rememberLazyGridState$3$1;-><init>(IILandroidx/compose2/foundation/lazy/grid/LazyGridPrefetchStrategy;)V
    ...
    check-cast v0, Landroidx/compose2/foundation/lazy/grid/LazyGridState;
...
.method public static final rememberLazyGridState(IILandroidx/compose2/runtime/Composer;II)Landroidx/compose2/foundation/lazy/grid/LazyGridState;
    .locals 8
    ...
    sget-object v1, Landroidx/compose2/foundation/lazy/grid/LazyGridState;->Companion:Landroidx/compose2/foundation/lazy/grid/LazyGridState$Companion;

    invoke-virtual {v1}, Landroidx/compose2/foundation/lazy/grid/LazyGridState$Companion;->getSaver()Landroidx/compose2/runtime/saveable/Saver;
    ...
    new-instance v7, Landroidx/compose2/foundation/lazy/grid/LazyGridStateKt$rememberLazyGridState$1$1;

    invoke-direct {v7, p0, p1}, Landroidx/compose2/foundation/lazy/grid/LazyGridStateKt$rememberLazyGridState$1$1;-><init>(II)V
    ...
    check-cast p4, Landroidx/compose2/foundation/lazy/grid/LazyGridState;
