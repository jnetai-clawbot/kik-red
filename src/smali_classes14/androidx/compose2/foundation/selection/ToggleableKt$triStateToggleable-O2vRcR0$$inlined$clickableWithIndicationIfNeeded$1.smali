.class public final Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;
...
.field final synthetic $state$inlined:Landroidx/compose2/ui/state/ToggleableState;


# direct methods
.method public constructor <init>(Landroidx/compose2/foundation/Indication;Landroidx/compose2/ui/state/ToggleableState;ZLandroidx/compose2/ui/semantics/Role;Lkotlin2/jvm/functions/Function0;)V
    .locals 0

    iput-object p1, p0, Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;->$indication:Landroidx/compose2/foundation/Indication;

    iput-object p2, p0, Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;->$state$inlined:Landroidx/compose2/ui/state/ToggleableState;

    iput-boolean p3, p0, Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;->$enabled$inlined:Z

    iput-object p4, p0, Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;->$role$inlined:Landroidx/compose2/ui/semantics/Role;

    iput-object p5, p0, Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;->$onClick$inlined:Lkotlin2/jvm/functions/Function0;
...
.method public final invoke(Landroidx/compose2/ui/Modifier;Landroidx/compose2/runtime/Composer;I)Landroidx/compose2/ui/Modifier;
    ...
    iget-object v6, v0, Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;->$indication:Landroidx/compose2/foundation/Indication;
    ...
    new-instance v7, Landroidx/compose2/foundation/selection/TriStateToggleableElement;

    iget-object v10, v0, Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;->$state$inlined:Landroidx/compose2/ui/state/ToggleableState;

    iget-boolean v13, v0, Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;->$enabled$inlined:Z

    iget-object v14, v0, Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;->$role$inlined:Landroidx/compose2/ui/semantics/Role;

    iget-object v15, v0, Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;->$onClick$inlined:Lkotlin2/jvm/functions/Function0;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroidx/compose2/foundation/selection/ToggleableKt$triStateToggleable-O2vRcR0$$inlined$clickableWithIndicationIfNeeded$1;->invoke(Landroidx/compose2/ui/Modifier;Landroidx/compose2/runtime/Composer;I)Landroidx/compose2/ui/Modifier;
