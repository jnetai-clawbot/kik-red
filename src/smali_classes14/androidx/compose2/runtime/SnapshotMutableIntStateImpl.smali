.class public Landroidx/compose2/runtime/SnapshotMutableIntStateImpl;
.super Landroidx/compose2/runtime/snapshots/StateObjectImpl;
.source "SnapshotIntState.kt"

# interfaces
.implements Landroidx/compose2/runtime/MutableIntState;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;
    }
.end annotation
...
# instance fields
.field private next:Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;
...
.method public constructor <init>(I)V
    ...
    invoke-direct {v0, p1}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;-><init>(I)V
    ...
    new-instance v3, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;

    invoke-direct {v3, p1}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;-><init>(I)V
    ...
    invoke-virtual {v4, v6}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;->setSnapshotId$runtime_release(I)V

    check-cast v3, Landroidx/compose2/runtime/snapshots/StateRecord;

    invoke-virtual {v1, v3}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;->setNext$runtime_release(Landroidx/compose2/runtime/snapshots/StateRecord;)V

    :cond_0
    iput-object v0, p0, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl;->next:Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;
...
.method public component1()Ljava/lang/Integer;
    ...
    invoke-virtual {p0}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl;->getIntValue()I
...
.method public bridge synthetic component1()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl;->component1()Ljava/lang/Integer;
...
.method public component2()Lkotlin2/jvm/functions/Function1;
    ...
    new-instance v0, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$component2$1;

    invoke-direct {v0, p0}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$component2$1;-><init>(Landroidx/compose2/runtime/SnapshotMutableIntStateImpl;)V
...
.method public final getDebuggerDisplayValue()I
    ...
    iget-object v0, p0, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl;->next:Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;
    ...
    check-cast v2, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;

    const/4 v3, 0x0

    invoke-virtual {v2}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;->getValue()I
...
.method public getIntValue()I
    ...
    invoke-virtual {v0}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;->getValue()I
...
.method public bridge synthetic getValue()Ljava/lang/Object;
    ...
    invoke-static {p0}, Landroidx/compose2/runtime/MutableIntState$-CC;->$default$getValue(Landroidx/compose2/runtime/MutableIntState;)Ljava/lang/Object;
...
.method public mergeRecords(Landroidx/compose2/runtime/snapshots/StateRecord;Landroidx/compose2/runtime/snapshots/StateRecord;Landroidx/compose2/runtime/snapshots/StateRecord;)Landroidx/compose2/runtime/snapshots/StateRecord;
    ...
    check-cast v1, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;
    ...
    invoke-virtual {v1}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;->getValue()I
...
.method public setIntValue(I)V
    ...
    iget-object v4, p0, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl;->next:Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;
    ...
    check-cast v11, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;

    const/4 v12, 0x0

    invoke-virtual {v11, p1}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl$IntStateStateRecord;->setValue(I)V
...
.method public bridge synthetic setValue(Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, Landroidx/compose2/runtime/MutableIntState$-CC;->$default$setValue(Landroidx/compose2/runtime/MutableIntState;Ljava/lang/Object;)V
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Landroidx/compose2/runtime/SnapshotMutableIntStateImpl;->hashCode()I
